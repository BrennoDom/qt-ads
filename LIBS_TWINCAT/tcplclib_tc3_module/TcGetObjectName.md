...
![43944024](/tcplclib_tc3_module/1033/Images/png/1905500043__Web.png)
...
**objName**: the name to be set

**nameLen**: the maximum length of the name to be written
...
Gives information about success of the name query.
