...
3. [CX51x0](ms-xhelp:///?Id=beckhoff-15f0-4872-a70a-030db8bf36db)
4. FB\_S\_UPS\_CX51x0

# FB\_S\_UPS\_CX51x0

![7180698](/tcplclib_tc2_sups/1033/Images/png/2242861195__Web.png)

The function block FB\_S\_UPS\_CX51x0 can be used on CX51x0 devices with 1-second UPS, in order to control the 1-second UPS from the PLC. In the event of a power failure, this enables the persistent data to be saved and/or a quick shutdown to be executed, depending on the selected mode. The default input values of the FB\_S\_UPS\_CX51x0 should be retained.
...
![64626289](/tcplclib_tc2_sups/1033/Images/gif/30519819__en-US__Web.gif)
...
| --- | --- | --- | --- |
| TwinCAT v3.1 B4016 | CX51x0 | 1-second UPS | Tc2\_SUPS |
