...
5. FB\_SoEReadMotorTemperature\_ByDriveRef

# FB\_SoEReadMotorTemperature\_ByDriveRef

FB\_SoEReadMotorTemperature\_ByDriveRef stDriveRef  ST\_DriveRefbExecute  BOOLtTimeout  TIMEBOOL  bBusyBOOL  bErrorUINT  iAdsErrIdUINT  iSercosErrIdDWORD  dwAttributeREAL  fMotorTemperature

With the function block FB\_SoEReadMotorTemperature\_ByDriveRef the temperature of the motor (S-0-0383) can be read. If the motor does not contain a temperature sensor, this is 0.0, i.e. 0.0 °C.
