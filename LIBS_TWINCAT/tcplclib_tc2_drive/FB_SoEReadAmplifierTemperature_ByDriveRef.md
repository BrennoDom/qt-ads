...
5. FB\_SoEReadAmplifierTemperature\_ByDriveRef

# FB\_SoEReadAmplifierTemperature\_ByDriveRef

FB\_SoEReadAmplifierTemperature\_ByDriveRef stDriveRef  ST\_DriveRefbExecute  BOOLtTimeout  TIMEBOOL  bBusyBOOL  bErrorUINT  iAdsErrIdUINT  iSercosErrIdDWORD  dwAttributeREAL  fAmplifierTemperature

With the FB\_SoEReadAmplifierTemperature\_ByDriveRef function block the temperature of the drive (S-0-0384) can be read.
