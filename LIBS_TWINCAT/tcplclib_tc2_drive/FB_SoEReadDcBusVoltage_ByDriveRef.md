...
5. FB\_SoEReadDcBusVoltage\_ByDriveRef

# FB\_SoEReadDcBusVoltage\_ByDriveRef

FB\_SoEReadDcBusVoltage\_ByDriveRef stDriveRef  ST\_DriveRefbExecute  BOOLtTimeout  TIMEBOOL  bBusyBOOL  bErrorUINT  iAdsErrIdUINT  iSercosErrIdDWORD  dwAttributeREAL  fDcBusVoltage

With the FB\_SoEReadDcBusVoltage\_ByDriveRef function block the DC-Bus voltage of the drive (S-0-0380) can be read.
