...
FiFoStart iChannelId  UDINTbExecute  BOOLtTimeout  TIMEBOOL  bBusyBOOL  bErrUDINT  iErrId

The function block FiFoStart initiates processing of the FIFO channel, so that all the axes in the FIFO channel are driven in accordance with the position data previously provided to the FIFO.
