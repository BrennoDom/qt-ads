...
FiFoStop iChannelId  UDINTbExecute  BOOLtTimeout  TIMEBOOL  bBusyBOOL  bErrUDINT  iErrId

The function blockFiFoStop halts a FIFO channel. Processing of the position data from the FIFO stops, and all the axes in the FIFO channel are halted.
