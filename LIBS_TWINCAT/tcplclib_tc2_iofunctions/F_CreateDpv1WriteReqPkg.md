...
4. F\_CreateDpv1WriteReqPkg

# F\_CreateDpv1WriteReqPkg

![40372317](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314190859__Web.png)

The “F\_CreateDpv1WriteReqPkg” function creates a DPV1 telegram for an [FB\_Dpv1Write](ms-xhelp:///?Id=beckhoff-e930-429d-a47a-b9c453f530fd) of one or more parameters of a drive or the controller unit of a Sinamics Profidrive (Profidrive Specification 3.1). Since Profidrives use the Motorola format and IPCs the Intel format, the function automatically swaps the byte order of parameters with data types with more than one byte in the DPV1 telegram.
...
**stDpv1Parameter**: Array of 39 parameters to be added to the DPV1 write telegram (type: [ST\_Dpv1ParamAddrEx](ms-xhelp:///?Id=beckhoff-9a8b-431a-966f-b96159493f14)).

**stDpv1ValueHeaderEx**: Array of 39 parameter values to be added to the DPV1 write telegram (type: [ST\_Dpv1ValueHeaderEx](ms-xhelp:///?Id=beckhoff-9b58-428b-b8ab-b5208c6219f5)).
