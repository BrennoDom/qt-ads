...
4. F\_CreateDpv1ReadReqPkg

# F\_CreateDpv1ReadReqPkg

![4485813](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314181259__Web.png)

The “F\_CreateDpv1ReadReqPkg” function creates a DPV1 telegram for an [FB\_Dpv1Read](ms-xhelp:///?Id=beckhoff-825f-4a42-a12e-044680d75ccf) of one or more parameters of a drive or the controller unit of a Sinamics Profidrive (Profidrive Specification 3.1). Since Profidrives use the Motorola format and IPCs the Intel format, the function automatically swaps the byte order of parameters with data types with more than one byte in the DPV1 telegram.
