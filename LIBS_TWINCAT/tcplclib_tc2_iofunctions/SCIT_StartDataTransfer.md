...
5. SCIT\_StartDataTransfer

# SCIT\_StartDataTransfer

![28842926](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314235659__Web.png)

The "SCIT\_StartDataTransfer" function block serves as an auxiliary block in order to carry out a **Start\_Data\_Transfer** on the Interbus card that is addressed by the NETID and the PORT. A **Start\_Data\_Transfer** places the card into the [RUN](ms-xhelp:///?Id=beckhoff-63cf-4976-9bf4-876fc243051c) state.
