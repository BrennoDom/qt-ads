...
5. SCIT\_ActivateConfiguration

# SCIT\_ActivateConfiguration

![28525238](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314229259__Web.png)

The "SCIT\_ActivateConfiguration" function block serves as an auxiliary block in order to carry out an **Activate\_Configuration** on the Interbus card that is addressed by the NETID and the PORT. An **Activate\_Configuration** sets the card in the [ACTIVE](ms-xhelp:///?Id=beckhoff-63cf-4976-9bf4-876fc243051c) state.
