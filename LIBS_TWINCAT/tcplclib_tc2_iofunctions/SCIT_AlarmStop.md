...
![54575646](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314242059__Web.png)

The "SCIT\_AlarmStop" function block serves as an auxiliary block in order to carry out an **Alarm\_Stop** on the Interbus card that is addressed by the NETID and the PORT. An **Alarm\_Stop** places the card in the [PAR\_READY](ms-xhelp:///?Id=beckhoff-63cf-4976-9bf4-876fc243051c) state and resets all the outputs.
