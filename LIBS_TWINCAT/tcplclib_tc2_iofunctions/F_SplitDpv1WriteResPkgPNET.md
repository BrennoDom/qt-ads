...
4. F\_SplitDpv1WriteResPkgPNET

# F\_SplitDpv1WriteResPkgPNET

![30131813](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314216459__Web.png)

The “F\_SplitDpv1WriteResPkgPNET” function creates a DPV1 telegram for an [FB\_Dpv1WritePNET](ms-xhelp:///?Id=beckhoff-271e-4a70-b74c-c40643f95aca) of one or more parameters of a drive or the controller unit of a Sinamics Profidrive (Profidrive Specification 3.1) that is connected via Profinet. Since Profidrives use the Motorola format and IPCs the Intel format, the function automatically swaps the byte order of parameters with data types with more than one byte in the DPV1 telegram.
