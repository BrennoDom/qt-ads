...
5. SCIT\_DeactivateConfiguration

# SCIT\_DeactivateConfiguration

![55400552](/tcplclib_tc2_iofunctions/1033/Images/png/9007199314232459__Web.png)

The "SCIT\_DeactivateConfiguration" function block serves as an auxiliary block in order to carry out a **Deactivate\_Configuration** on the Interbus card that is addressed by the NETID and the PORT. An **Deactivate\_Configuration** places the card in the [PAR\_READY](ms-xhelp:///?Id=beckhoff-63cf-4976-9bf4-876fc243051c) state and resets all the outputs.
