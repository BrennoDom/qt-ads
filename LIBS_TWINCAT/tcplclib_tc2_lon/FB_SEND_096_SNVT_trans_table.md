...
# FB\_SEND\_096\_SNVT\_trans\_table

![25100141](/tcplclib_tc2_lon/1033/Images/gif/151394571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_trans\_table.

**SNVT number:** 096.

**Description:** Conversion table (number of values, interpolation).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_trans_table;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_trans\_table](ms-xhelp:///?Id=beckhoff-7032-41f1-9f12-c7090b58a687)).
