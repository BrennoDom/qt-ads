...
# FB\_READ\_154\_SNVT\_gfci\_status

![39516413](/tcplclib_tc2_lon/1033/Images/gif/150962571__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_gfci\_status.

**SNVT number:** 154.

**Description:** Residual current circuit breaker status (residual current circuit breaker status text).
...
```
eValue   : E_LON_gfci_status_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_gfci\_status\_t](ms-xhelp:///?Id=beckhoff-5b0e-45fc-9559-0ba2fd6c37c3)).
