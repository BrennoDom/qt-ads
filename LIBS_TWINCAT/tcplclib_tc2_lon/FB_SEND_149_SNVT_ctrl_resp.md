...
# FB\_SEND\_149\_SNVT\_ctrl\_resp

![2199097](/tcplclib_tc2_lon/1033/Images/gif/151554571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_ctrl\_resp.

**SNVT number:** 149.

**Description:** Control response (status, transmitter, controller ID). Response to a control request.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_ctrl_resp;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_ctrl\_resp](ms-xhelp:///?Id=beckhoff-ce77-4589-8875-386f69181903)).
