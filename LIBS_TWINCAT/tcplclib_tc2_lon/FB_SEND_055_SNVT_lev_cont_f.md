...
# FB\_SEND\_055\_SNVT\_lev\_cont\_f

![53848109](/tcplclib_tc2_lon/1033/Images/gif/151266571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_lev\_cont\_f.

**SNVT number:** 055.

**Description:** Continuous change in value (% from maximum level).
