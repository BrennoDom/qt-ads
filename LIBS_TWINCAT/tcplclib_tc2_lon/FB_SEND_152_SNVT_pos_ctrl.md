...
# FB\_SEND\_152\_SNVT\_pos\_ctrl

![59638115](/tcplclib_tc2_lon/1033/Images/gif/151564171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_pos\_ctrl.

**SNVT number:** 152.

**Description:** Position setting for cameras in networks (receiver, controller ID, controller priority, function, action, value).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_pos_ctrl;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_pos\_ctrl](ms-xhelp:///?Id=beckhoff-cb21-4e4a-b25a-93b9eb0e48c1)).
