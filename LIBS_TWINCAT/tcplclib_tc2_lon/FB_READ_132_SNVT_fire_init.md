...
# FB\_READ\_132\_SNVT\_fire\_init

![27848947](/tcplclib_tc2_lon/1033/Images/gif/150901771__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_fire\_init.

**SNVT number:** 132.

**Description:** Fire detector type (fire detector type names).
...
```
eValue   : E_LON_fire_initiator_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_fire\_initiator\_t](ms-xhelp:///?Id=beckhoff-5259-4885-905d-77fad4376c16)).
