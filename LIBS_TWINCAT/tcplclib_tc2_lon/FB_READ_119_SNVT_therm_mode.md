...
# FB\_READ\_119\_SNVT\_therm\_mode

![52483186](/tcplclib_tc2_lon/1033/Images/gif/150860171__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_therm\_mode.

**SNVT number:** 119.

**Description:** Thermostat mode (enumeration (enable, modulation)).
...
```
eValue   : E_LON_therm_mode_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_therm\_mode\_t](ms-xhelp:///?Id=beckhoff-282c-40ba-8f2b-4f93ab8770cb)).
