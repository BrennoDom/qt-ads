...
# FB\_SEND\_084\_SNVT\_time\_stamp

![583706](/tcplclib_tc2_lon/1033/Images/gif/151356171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_time\_stamp.

**SNVT number:** 084.

**Description:** Time stamp (year, month, day, hour, minute, second).
...
**stValue:** Structure of the data to be sent (see TIMESTRUCT). The structure variables wDayOfWeek and wMilliseconds are not valid here. These values are not transferred.
