...
# FB\_READ\_133\_SNVT\_fire\_indcte

![49313939](/tcplclib_tc2_lon/1033/Images/gif/150904971__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_fire\_indcte.

**SNVT number:** 133.

**Description:** Fire alarm display (fire alarm display names).
...
```
eValue   : E_LON_fire_indicator_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_fire\_indicator\_t](ms-xhelp:///?Id=beckhoff-5aed-471e-a9be-7da72a3a56ee)).
