...
# FB\_SEND\_128\_SNVT\_tod\_event

![11009764](/tcplclib_tc2_lon/1033/Images/gif/151496971__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_tod\_event.

**SNVT number:** 128.

**Description:** Presence time (busy status, next busy time).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_tod_event;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_tod\_event](ms-xhelp:///?Id=beckhoff-3101-4a65-bab9-f985ace34cb7)).
