...
# FB\_SEND\_166\_SNVT\_nv\_type

![15456653](/tcplclib_tc2_lon/1033/Images/gif/151608971__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_nv\_type.

**SNVT number:** 166.

**Description:** Network variable type. Type description for network variables.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_nv_type;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_nv\_type](ms-xhelp:///?Id=beckhoff-4f68-43ff-a10c-13ebbd6041b7)).
