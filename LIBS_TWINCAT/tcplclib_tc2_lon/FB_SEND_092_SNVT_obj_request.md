...
# FB\_SEND\_092\_SNVT\_obj\_request

![19857248](/tcplclib_tc2_lon/1033/Images/gif/151381771__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_obj\_request.

**SNVT number:** 092.

**Description:** Function selection (ID, request).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_obj_request;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_obj\_request](ms-xhelp:///?Id=beckhoff-1435-4e91-a9ec-8f9bfff1e6af)).
