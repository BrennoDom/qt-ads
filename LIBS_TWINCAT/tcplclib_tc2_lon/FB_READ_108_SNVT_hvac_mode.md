...
# FB\_READ\_108\_SNVT\_hvac\_mode

![55845053](/tcplclib_tc2_lon/1033/Images/gif/150824971__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_hvac\_mode.

**SNVT number:** 108.

**Description:** HVAC operating mode (operating modes).
...
**eValue:** Enum to be received (see [E\_LON\_hvac\_t](ms-xhelp:///?Id=beckhoff-a720-44d6-95f5-9acdc34712fc)).
