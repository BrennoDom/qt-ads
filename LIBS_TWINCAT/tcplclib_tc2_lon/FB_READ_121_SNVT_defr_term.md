...
# FB\_READ\_121\_SNVT\_defr\_term

![23279683](/tcplclib_tc2_lon/1033/Images/gif/150866571__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_defr\_term.

**SNVT number:** 121.

**Description:** Completion of the defrost cycle (enumeration).
...
```
eValue   : E_LON_defrost_term_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_defrost\_term\_t](ms-xhelp:///?Id=beckhoff-37cd-4de7-8bd8-d6c62b374bf3)).
