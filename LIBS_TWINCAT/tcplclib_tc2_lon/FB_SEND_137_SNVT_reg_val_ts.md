...
# FB\_SEND\_137\_SNVT\_reg\_val\_ts

![10578662](/tcplclib_tc2_lon/1033/Images/gif/151525771__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_reg\_val\_ts.

**SNVT number:** 137.

**Description:** Register value (raw value, bit code, number of decimal places, status, state, timestamp).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_reg_val_ts;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_reg\_val\_ts](ms-xhelp:///?Id=beckhoff-49df-4223-bfb9-b6b9e1258c27)).
