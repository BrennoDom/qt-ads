...
# FB\_SEND\_019\_SNVT\_length\_micr

![52733512](/tcplclib_tc2_lon/1033/Images/gif/151157771__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_length\_micr.

**SNVT number:** 019.

**Description:** Length (micrometer).
