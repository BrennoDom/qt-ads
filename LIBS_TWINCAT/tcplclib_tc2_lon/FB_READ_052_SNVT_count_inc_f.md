...
# FB\_READ\_052\_SNVT\_count\_inc\_f

![14008765](/tcplclib_tc2_lon/1033/Images/gif/150648971__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_count\_inc\_f.

**SNVT number:** 052.

**Description:** Increment counter (items(delta)).
