...
# FB\_READ\_162\_SNVT\_dev\_c\_mode

![13554483](/tcplclib_tc2_lon/1033/Images/gif/150988171__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_dev\_c\_mode.

**SNVT number:** 162.

**Description:** Device operating mode (device operating mode states).
...
```
eValue   : E_LON_device_c_mode_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_device\_c\_mode\_t](ms-xhelp:///?Id=beckhoff-a4e9-408a-8dd8-2317ca322429)).
