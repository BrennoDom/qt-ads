...
# FB\_SEND\_157\_SNVT\_ex\_control

![33461405](/tcplclib_tc2_lon/1033/Images/gif/151580171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_ex\_control.

**SNVT number:** 157.

**Description:** Exclusive control (status, address). A device has exclusive control over another device.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_ex_control;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_ex\_control](ms-xhelp:///?Id=beckhoff-6458-48b9-9189-ee9f40410258)).
