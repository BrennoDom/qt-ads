...
# FB\_SEND\_195\_SNVT\_log\_request

![16689200](/tcplclib_tc2_lon/1033/Images/gif/151692171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_log\_request.

**SNVT number:** 195.

**Description:** Log status request. Requests the current status of a data log. The status is output via the SNVT\_log\_status output.
...
**tMaxSendTime:** Parameter for [automatic sending](ms-xhelp:///?Id=beckhoff-83d9-4e0f-87b8-3129214c5d3f). The value is sent when this time has elapsed at the latest, even if the minimum change in value (*uiValueLimit*) was not reached (polling). The value 0 disables this function.
