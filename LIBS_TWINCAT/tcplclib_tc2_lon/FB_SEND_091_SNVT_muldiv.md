...
# FB\_SEND\_091\_SNVT\_muldiv

![54402144](/tcplclib_tc2_lon/1033/Images/gif/151378571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_muldiv.

**SNVT number:** 091.

**Description:** Gain factor/attenuation factor (multiplier, divisor).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_muldiv;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_muldiv](ms-xhelp:///?Id=beckhoff-d124-4ab4-aa5b-0ed2868eb935)).
