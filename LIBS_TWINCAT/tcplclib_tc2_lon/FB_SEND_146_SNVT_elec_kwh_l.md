...
# FB\_SEND\_146\_SNVT\_elec\_kwh\_l

![24305815](/tcplclib_tc2_lon/1033/Images/gif/151544971__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_elec\_kwh\_l.

**SNVT number:** 146.

**Description:** Electric energy (kW / hour).
...
**lrValue:** Min: -214748364.8 / Max: 214748364.7.
...
**tMaxSendTime:** Parameter for [automatic sending](ms-xhelp:///?Id=beckhoff-83d9-4e0f-87b8-3129214c5d3f). The value is sent when this time has elapsed at the latest, even if the minimum change in value (l*rValueLimit*) was not reached (polling). The value 0 disables this function.
