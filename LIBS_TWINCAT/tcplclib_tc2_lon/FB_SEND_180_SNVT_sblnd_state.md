...
# FB\_SEND\_180\_SNVT\_sblnd\_state

![26673201](/tcplclib_tc2_lon/1033/Images/gif/151644171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_sblnd\_state.
...
```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_sblnd_state;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_sblnd\_state](ms-xhelp:///?Id=beckhoff-b94e-4e3b-9f91-9e3329ed04f1)).
