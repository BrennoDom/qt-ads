...
# FB\_SEND\_182\_SNVT\_rac\_req

![13045638](/tcplclib_tc2_lon/1033/Images/gif/151650571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_rac\_req.

**SNVT number:** 182.

**Description:** Sound function request. Requests the sound function for a particular source.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_rac_req;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_rac\_req](ms-xhelp:///?Id=beckhoff-9de5-46ef-bc35-571896baccc3)).
