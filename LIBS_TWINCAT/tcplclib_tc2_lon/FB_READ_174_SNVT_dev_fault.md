...
# FB\_READ\_174\_SNVT\_dev\_fault

![53291177](/tcplclib_tc2_lon/1033/Images/gif/151023371__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_dev\_fault.

**SNVT number:** 174.

**Description:** Error state. Error information for a device.
...
**stValue:** Structure of the received data (see [ST\_LON\_SNVT\_dev\_fault](ms-xhelp:///?Id=beckhoff-d209-467c-bf88-ec32a8564983)).
