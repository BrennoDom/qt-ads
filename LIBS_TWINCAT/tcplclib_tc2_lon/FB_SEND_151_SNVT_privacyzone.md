...
# FB\_SEND\_151\_SNVT\_privacyzone

![43909159](/tcplclib_tc2_lon/1033/Images/gif/151560971__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_privacyzone

**SNVT number:** 151

**Description:** Private zone (action area, zone number, camera ID). Certain areas can be excluded from the camera

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_privacyzone;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_privacyzone](ms-xhelp:///?Id=beckhoff-4d06-4346-92eb-ac1d0be71500)).
