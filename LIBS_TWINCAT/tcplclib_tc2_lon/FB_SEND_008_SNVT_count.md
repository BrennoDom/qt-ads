...
# FB\_SEND\_008\_SNVT\_count

![28932175](/tcplclib_tc2_lon/1033/Images/gif/151128971__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_count.

**SNVT number:** 008.

**Description:** Counter (only positive values).
