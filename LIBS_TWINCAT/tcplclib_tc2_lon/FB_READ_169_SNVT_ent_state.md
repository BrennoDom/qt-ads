...
# FB\_READ\_169\_SNVT\_ent\_state

![10038421](/tcplclib_tc2_lon/1033/Images/gif/151007371__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_ent\_state.

**SNVT number:** 169.

**Description:** State of access objects (doors, locks or objects permitting or prohibiting access).
...
```
eValue   : E_LON_ent_cmd_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_ent\_cmd\_t](ms-xhelp:///?Id=beckhoff-1e01-4545-bd11-6cae43f40dbf)).
