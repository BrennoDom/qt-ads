...
# FB\_SEND\_181\_SNVT\_rac\_ctrl

![38732217](/tcplclib_tc2_lon/1033/Images/gif/151647371__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_rac\_ctrl.

**SNVT number:** 181.

**Description:** Sound function control. Activates the sound function for a particular source.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_rac_ctrl;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_rac\_ctrl](ms-xhelp:///?Id=beckhoff-db94-4c32-8eac-8e6a579773ed)).
