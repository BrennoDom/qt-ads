...
# FB\_SEND\_116\_SNVT\_scene\_cfg

![16264673](/tcplclib_tc2_lon/1033/Images/gif/151458571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_scene\_cfg.

**SNVT number:** 116.

**Description:** Scene setting (function , scene number, setting, transition number, transition time, delay time, priority).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_scene_cfg;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_scene\_cfg](ms-xhelp:///?Id=beckhoff-63da-4588-a6a8-814861499483)).
