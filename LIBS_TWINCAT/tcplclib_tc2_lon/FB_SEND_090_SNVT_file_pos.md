...
# FB\_SEND\_090\_SNVT\_file\_pos

![28414304](/tcplclib_tc2_lon/1033/Images/gif/151375371__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_file\_pos.

**SNVT number:** 090.

**Description:** File position (pointer, length).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_file_pos;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_file\_pos](ms-xhelp:///?Id=beckhoff-9a8e-48a3-aed3-447829db1bc3)).
