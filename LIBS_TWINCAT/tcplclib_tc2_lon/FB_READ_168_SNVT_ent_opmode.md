...
# FB\_READ\_168\_SNVT\_ent\_opmode

![38398082](/tcplclib_tc2_lon/1033/Images/gif/151004171__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_ent\_opmode.

**SNVT number:** 168.

**Description:** Operating mode of access objects (doors, locks or objects permitting or prohibiting access).
...
```
eValue   : E_LON_ent_opmode_cmd_t;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**eValue:** Enum to be received (see [E\_LON\_ent\_opmode\_cmd\_t](ms-xhelp:///?Id=beckhoff-1293-4757-9c4e-7b2d4f72cd9a)).
