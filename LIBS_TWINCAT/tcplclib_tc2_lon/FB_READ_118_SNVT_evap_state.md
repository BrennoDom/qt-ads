...
# FB\_READ\_118\_SNVT\_evap\_state

![50570707](/tcplclib_tc2_lon/1033/Images/gif/150856971__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_evap\_state.

**SNVT number:** 118.

**Description:** Evaporator status (enumeration).
...
**eValue:** Enum to be received (see [E\_LON\_evap\_t](ms-xhelp:///?Id=beckhoff-4522-4b95-903d-faccfa3ad6d2)).
