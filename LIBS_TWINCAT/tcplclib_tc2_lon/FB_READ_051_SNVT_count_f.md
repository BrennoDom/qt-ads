...
# FB\_READ\_051\_SNVT\_count\_f

![38839231](/tcplclib_tc2_lon/1033/Images/gif/150645771__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_count\_f.

**SNVT number:** 051.

**Description:** Absolute number (items).
