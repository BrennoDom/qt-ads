...
# FB\_SEND\_050\_SNVT\_angle\_vel\_f

![36508524](/tcplclib_tc2_lon/1033/Images/gif/151250571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_angle\_vel\_f.

**SNVT number:** 050.

**Description:** Angular velocity (radian / second).
...
**rValue:** Min: -3.40E+38 / Max: 3.40E+38.
