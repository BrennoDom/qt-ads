...
# FB\_READ\_084\_SNVT\_time\_stamp

![66750478](/tcplclib_tc2_lon/1033/Images/gif/150748171__en-US__Web.gif)
...
**stValue:** Structure of the received data (see TIMESTRUCT). The structure variables *wDayOfWeek* and *wMilliseconds* are not valid here; these values are always zero.
