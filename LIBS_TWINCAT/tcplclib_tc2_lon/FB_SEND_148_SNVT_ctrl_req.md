...
# FB\_SEND\_148\_SNVT\_ctrl\_req

![22613965](/tcplclib_tc2_lon/1033/Images/gif/151551371__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_ctrl\_req.

**SNVT number:** 148.

**Description:** Control request (receiver ID, sender ID, sender priority). Request for control permission for another controller.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_ctrl_req;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_ctrl\_req](ms-xhelp:///?Id=beckhoff-29a6-4b8d-89da-c006e51e975c)).
