...
# FB\_SEND\_037\_SNVT\_str\_int

![10722842](/tcplclib_tc2_lon/1033/Images/gif/151212171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_str\_int.

**SNVT number:** 037.

**Description:** Wide character string with own code (max. 15 characters) (wide character string).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_str_int;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_str\_int](ms-xhelp:///?Id=beckhoff-9023-4da3-ae65-154c7a590d2d)).
