...
# FB\_SEND\_170\_SNVT\_ent\_status

![60720217](/tcplclib_tc2_lon/1033/Images/gif/151618571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_ent\_status.

**SNVT number:** 170.

**Description:** Status of access objects (doors, locks or objects permitting or prohibiting access).

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_ent_status;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_ent\_status](ms-xhelp:///?Id=beckhoff-3eaa-4a3b-a160-c4ae701bee3f)).
