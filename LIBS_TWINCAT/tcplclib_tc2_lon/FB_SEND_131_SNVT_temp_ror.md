...
# FB\_SEND\_131\_SNVT\_temp\_ror

![40163483](/tcplclib_tc2_lon/1033/Images/gif/151506571__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_temp\_ror.

**SNVT number:** 131.

**Description:** Value of the temperature change/increase (°C/minute).
