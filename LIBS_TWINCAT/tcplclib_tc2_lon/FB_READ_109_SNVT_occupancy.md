...
# FB\_READ\_109\_SNVT\_occupancy

![32843429](/tcplclib_tc2_lon/1033/Images/gif/150828171__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_occupancy.

**SNVT number:** 109.

**Description:** Occupancy signal (states).
...
**eValue:** Enum to be sent (see [E\_LON\_occup\_t](ms-xhelp:///?Id=beckhoff-b931-4462-9cd0-33d215143690)).
