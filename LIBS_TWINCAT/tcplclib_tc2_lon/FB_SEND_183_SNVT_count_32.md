...
# FB\_SEND\_183\_SNVT\_count\_32

![50301879](/tcplclib_tc2_lon/1033/Images/gif/151653771__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_count\_32.

**SNVT number:** 183.

**Description:** Absolute counter. 32 bit counter.
...
**tMaxSendTime:** Parameter for [automatic sending](ms-xhelp:///?Id=beckhoff-83d9-4e0f-87b8-3129214c5d3f). The value is sent when this time has elapsed at the latest, even if the minimum change in value (*udiValueLimit*) was not reached (polling). The value 0 disables this function.
