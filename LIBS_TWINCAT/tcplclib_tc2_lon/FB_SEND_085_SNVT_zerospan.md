...
# FB\_SEND\_085\_SNVT\_zerospan

![5253358](/tcplclib_tc2_lon/1033/Images/gif/151359371__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_zerospan

**SNVT number:** 085

**Description:** Zero point and proportionality factor. Linear transformation parameters: multiply with proportionality factor, then add origin offset.

## VAR\_INPUT

```
wNVIndex     : WORD;  
stValue      : ST_LON_SNVT_zerospan;  
bStart       : BOOL;  
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_zerospan](ms-xhelp:///?Id=beckhoff-628f-478d-bc7c-adaaf225765c)).
