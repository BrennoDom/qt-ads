...
# FB\_SEND\_009\_SNVT\_count\_inc

![59062984](/tcplclib_tc2_lon/1033/Images/gif/151132171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_count\_inc.

**SNVT number:** 009.

**Description:** Counter (negative and positive values).
...
**tMaxSendTime:** Parameter for [automatic sending](ms-xhelp:///?Id=beckhoff-83d9-4e0f-87b8-3129214c5d3f). The value is sent when this time has elapsed at the latest, even if the minimum change in value (*iValueLimit*) was not reached (polling). The value 0 disables this function.
