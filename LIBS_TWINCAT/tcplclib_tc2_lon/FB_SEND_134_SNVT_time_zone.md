...
# FB\_SEND\_134\_SNVT\_time\_zone

![19714506](/tcplclib_tc2_lon/1033/Images/gif/151516171__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_time\_zone.

**SNVT number:** 134.

**Description:** Time zone description (offset, type, summer time start, summer time end).
...
**stValue:** Structure of the data to be sent (see [ST\_LON\_SNVT\_time\_zone](ms-xhelp:///?Id=beckhoff-582d-4ea8-a8c0-fd950134bc8c)).
