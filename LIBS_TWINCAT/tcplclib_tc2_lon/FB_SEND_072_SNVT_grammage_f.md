...
# FB\_SEND\_072\_SNVT\_grammage\_f

![15662289](/tcplclib_tc2_lon/1033/Images/gif/151320971__en-US__Web.gif)

This function block sends the following LON output variable (nvo):

**SNVT Name:** SNVT\_grammage\_f.

**SNVT number:** 072.

**Description:** American dimension for paper weight and density (gram/m2).
