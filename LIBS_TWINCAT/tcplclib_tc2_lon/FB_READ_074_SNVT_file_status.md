...
# FB\_READ\_074\_SNVT\_file\_status

![58405349](/tcplclib_tc2_lon/1033/Images/gif/150719371__en-US__Web.gif)

This function block receives the following LON input variable (nvi):

**SNVT Name:** SNVT\_file\_status.

**SNVT number:** 074.

**Description:** File information (part of the LONWORKS file transfer protocol (LW-FTP)).
...
```
stValue  : ST_LON_SNVT_file_status;  
bNewData : BOOL;  
bError   : BOOL;  
eError   : E_LON_ERROR;
```

**stValue:** Structure of the received data (see [ST\_LON\_SNVT\_file\_status](ms-xhelp:///?Id=beckhoff-5f48-4843-9318-0162711efd50)). If *stValue.eStatus* = eLON\_FS\_LOOKUP\_OK (1), then the structure *stValue.stAddr.stDescriptor* is valid, otherwise *stValue.stAddr.stAddress* is valid.
