...
# FB\_SoEAX5000DeletePositionOffset

FB\_SoEAX5000DeletePositionOffset Execute  BOOLFeedback  E\_PositionOffsetFeedbackMemory  E\_PositionOffsetMemory↔Axis  Reference To AXIS\_REFBOOL  BusyBOOL  ErrorUDINT  ErrorID

With the function block FB\_SoEAX5000DeletePositionOffset, a position offset can be deleted from the memory of the AX5000 or from the digital name plate of the connected motor encoder.
