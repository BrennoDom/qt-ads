...
![66621782](/tcplclib_tc2_utilities/1033/Images/png/9007199290206475__Web.png)

This function block searches a directory for a file or a subdirectory whose name is similar to the specified name. Any entries found can be read individually. See also description of the FB\_EnumFindFileEntry function block. The input parameter *eCmd* is used for navigating through the list of entries. The *eCmd* input determines whether the first or the next input is read, for example.
...
**pFindList**: Address (pointer variable) of an array variable of type[: ST\_FindFileEntry](ms-xhelp:///?Id=beckhoff-b6b8-41e0-b10e-9c982ba31f1e).

**cbFindList**: Byte size of array variable of type: [ST\_FindFileEntry](ms-xhelp:///?Id=beckhoff-b6b8-41e0-b10e-9c982ba31f1e).
