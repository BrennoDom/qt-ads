...
# FB\_LicFileCopyToDongle

![2794612](/tcplclib_tc2_utilities/1033/Images/png/4579229835__Web.png)
...
**sNetIdSrc**: AmsNetId (AMS network identifier) of the TwinCAT computer. If it is to be run on the local computer, an empty string can be entered. (type: T\_AmsNetId)

**sNetIdDest**: AmsNetId (AMS network identifier) of the license dongle (type: T\_AmsNetId)
