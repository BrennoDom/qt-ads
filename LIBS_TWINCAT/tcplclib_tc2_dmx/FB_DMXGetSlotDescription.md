...
# FB\_DMXGetSlotDescription

![64745266](/tcplclib_tc2_dmx/1033/Images/gif/2746296331__Web.gif)
...
**sSlotDescription:** Once the command execution is complete (*bBusy* is FALSE), the slot description (maximum 32 characters) is available at this output.
