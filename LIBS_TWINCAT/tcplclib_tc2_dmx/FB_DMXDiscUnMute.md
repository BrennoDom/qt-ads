...
![45314905](/tcplclib_tc2_dmx/1033/Images/gif/9007199309960843__en-US__Web.gif)

This function block resets the mute flag of a DMX device. The mute flag specifies whether a DMX device reacts to the [FB\_DMXDiscUniqueBranch()](ms-xhelp:///?Id=beckhoff-7c3d-41e7-af6c-f64c5237278d) command (mute flag is not set) or not (mute flag is set).
