...
# FB\_DMXGetIdentifyDevice

![324668](/tcplclib_tc2_dmx/1033/Images/gif/9007199309964043__en-US__Web.gif)
...
**bIdentifyActive:** If the execution of the command has been completed (*bBusy* is FALSE), then the state of identification of the DMX device is displayed at this output.
