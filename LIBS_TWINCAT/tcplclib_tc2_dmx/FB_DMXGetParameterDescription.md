...
# FB\_DMXGetParameterDescription

![7693179](/tcplclib_tc2_dmx/1033/Images/gif/2746055819__en-US__Web.gif)
...
**eParameterId:** Requested manufacturer-specific PID (see [E\_DMXParameterId](ms-xhelp:///?Id=beckhoff-1b50-40f9-ab12-11814105381d)).
...
**stParameterDescription:** Once command execution is complete (*bBusy* is FALSE), the PID information is available at this output (see [ST\_DMXParameterDescription](ms-xhelp:///?Id=beckhoff-0e1b-4d4c-93b1-67fc24007a55)).
