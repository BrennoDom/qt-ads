...
# FB\_DMXGetSensorDefinition

![19167756](/tcplclib_tc2_dmx/1033/Images/gif/2746158987__en-US__Web.gif)
...
**stSensorDefinition:** Once the command execution is complete (*bBusy* is FALSE), the sensor definition is available at this output (see [ST\_DMXSensorDefinition](ms-xhelp:///?Id=beckhoff-f93e-41c4-a4ef-9ac0d4806993)).
