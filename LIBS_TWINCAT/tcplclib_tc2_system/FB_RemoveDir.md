...
![24632334](/tcplclib_tc2_system/1033/Images/png/9007199286004363__Web.png)
...
**sPathName**: Name of the directory to be deleted. When the function block is called, only one directory can be deleted. The last component of sPathName must contain the directory name to be deleted (type: [T\_MaxString](ms-xhelp:///?Id=beckhoff-77e0-4f6f-a54e-eec93d1cd558)).

**ePath**: This input can be used to select a TwinCAT system path for the directory to be deleted from the target device (type: [E\_OpenPath](ms-xhelp:///?Id=beckhoff-3a2e-42d2-836a-1c47c911486b)).
...
See description of [FB\_CreateDir](ms-xhelp:///?Id=beckhoff-44b6-492f-9370-a93609de874f).
