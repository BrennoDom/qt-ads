...
5. FB\_MBUS\_General\_Ext

# FB\_MBUS\_General\_Ext

![31854691](/tcplclib_tc2_mbus/1033/Images/gif/174928651__en-US__Web.gif)
...
The variable *arrTelegram[1..cMBUS\_MaxTelegrams].arrData[1..cMBUS\_MaxData]* supplies a maximum of [cMBUS\_MaxData](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47) data from a maximum of [cMBUS\_MaxTelegrams](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47) telegrams. String values and manufacturer-specific information are not shown correctly.

The number of telegrams to be read can be changed with the constant [cMBUS\_MaxTelegrams](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47).

The number of data per telegram to be read can be changed with the constant [cMBUS\_MaxData](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47).
...
**arrTelegram:** Up to [cMBUS\_MaxTelegrams](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47) telegrams (see [ST\_MBus\_data](ms-xhelp:///?Id=beckhoff-cd6a-4f95-8b10-8e769e5d3c6d)). The meaning of the values is explained in the M-Bus protocol for the device.
