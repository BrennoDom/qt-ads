...
4. [Metrima overview](ms-xhelp:///?Id=beckhoff-b928-4a6c-9837-f13eecbafd48)
5. FB\_MBUS\_SVM\_F22\_Ext

# FB\_MBUS\_SVM\_F22\_Ext

![54545236](/tcplclib_tc2_mbus/1033/Images/gif/175024651__en-US__Web.gif)

This block is used to read heat meters from Metrima:

-F22 (as [FB\_MBUS\_SVM\_F22()](ms-xhelp:///?Id=beckhoff-44a3-48d4-821a-f0fc976a1b24), but with the extended output values *arrAcountAccums* and *arrMonthlyAccums*.)

|  |  |
| --- | --- |
| 21145081 | This block is not suitable for BC/BX. |
...
**stVolume2:** Accumulated volume. Energy calculation (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).
...
**stPulsecounter1:** Pulse counter 1 (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**stPulsecounter2:** Pulse counter 2 (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**arrAccountAccums:** 2 cutoff date values (energy, volume 1, volume 2, pulse counter 1, pulse counter 2, date). Values are only read if bMonthstorages =TRUE (see [ST\_MBus\_F22](ms-xhelp:///?Id=beckhoff-b6ae-4316-939f-c4aed6def194)).

**arrMonthlyAccums:** Maximum 37 monthly values (energy, volume 1, volume 2, pulse counter 1, pulse counter 2, date). Values are only read if bMonthstorages =TRUE. The number of values depends on the variable byMonthstorages (see [ST\_MBus\_F22](ms-xhelp:///?Id=beckhoff-b6ae-4316-939f-c4aed6def194)).
