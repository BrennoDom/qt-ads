...
4. [elvaco overview](ms-xhelp:///?Id=beckhoff-2f64-4c4b-a814-dbf5b1f27964)
5. FB\_MBUS\_ELV\_CMa10\_20

# FB\_MBUS\_ELV\_CMa10\_20

![9467673](/tcplclib_tc2_mbus/1033/Images/gif/174883851__en-US__Web.gif)
...
**strRelHumi:** Current relative humidity (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strRelHumiMin:** Lowest relative humidity since the last min/max reset command (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strRelHumiMax:** Highest relative humidity since the last min/max reset command (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strTemp:** Current temperature (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strTempMin:** Lowest temperature since the last min/max reset command (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strTempMax:** Highest temperature since the last min/max reset command (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strTempAvg1h:** 1-hour mean value for temperature (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**strTempAvg24h:** 24-hour mean value for temperature (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).
