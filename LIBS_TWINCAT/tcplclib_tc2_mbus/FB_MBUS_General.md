...
![60524524](/tcplclib_tc2_mbus/1033/Images/gif/174919051__en-US__Web.gif)

This block is used for reading any M-Bus devices. The variable [arrData](ms-xhelp:///?Id=beckhoff-ff80-44c2-bbc2-7d05abe4abed) supplies a maximum of [cMBUS\_MaxData](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47) values for the first telegram. String values and manufacturer-specific information are not shown correctly.
...
**arrData:** Up to [cMBUS\_MaxData](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47) values of the first telegram. The meaning of the values is explained in the M-Bus protocol for the device.
