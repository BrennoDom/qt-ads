...
5. FB\_MBUS\_General\_Param

# FB\_MBUS\_General\_Param

![2402898](/tcplclib_tc2_mbus/1033/Images/gif/174935051__en-US__Web.gif)

This block is used for reading any M-Bus devices. The variable [arrData](ms-xhelp:///?Id=beckhoff-ff80-44c2-bbc2-7d05abe4abed) supplies [cMBUS\_MaxDataParam](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47) values.
...
**arrConfigData:** Up to cMBUS\_MaxDataParam input parameters for specifying which values are to be displayed in the output array *arrData* (see [Global\_Variables\_MBUS](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47)).
...
**arrData:** Up to cMBUS\_MaxDataParam values (see [Global\_Variables\_MBUS](ms-xhelp:///?Id=beckhoff-26c4-4cec-9d19-cc7830a34f47)). The values can be configured via the input variable *arrConfigData*. The meaning of the values is explained in the M-Bus protocol for the device.
