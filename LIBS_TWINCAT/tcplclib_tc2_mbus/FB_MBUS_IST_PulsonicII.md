...
4. [ista overview](ms-xhelp:///?Id=beckhoff-8c70-4118-9833-9b1eb952d445)
5. FB\_MBUS\_IST\_PulsonicII

# FB\_MBUS\_IST\_PulsonicII

![56353115](/tcplclib_tc2_mbus/1033/Images/gif/174979851__en-US__Web.gif)
...
|  |  |
| --- | --- |
| 37415993 | Maximum number of readings  The devices are supplied from a battery. The number of read operations is therefore limited. An internal counter prevents communication exceeding 96 times per day on average. The user must make sure that excessive queries are prevented. |
...
**stValue:** Current consumption value (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).

**stCurrentValue:** Current flow rate / power (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).
