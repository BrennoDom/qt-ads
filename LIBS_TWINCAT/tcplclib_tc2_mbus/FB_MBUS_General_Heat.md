...
5. FB\_MBUS\_General\_Heat

# FB\_MBUS\_General\_Heat

![18256764](/tcplclib_tc2_mbus/1033/Images/gif/174931851__en-US__Web.gif)

This block is used to read heat meters.

|  |  |
| --- | --- |
| 30093150 | Many heat meters do not send all values. In this case the corresponding structures remain empty. |
