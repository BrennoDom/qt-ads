...
5. FB\_MBUS\_General\_Electricity

# FB\_MBUS\_General\_Electricity

![7849808](/tcplclib_tc2_mbus/1033/Images/gif/174925451__en-US__Web.gif)

This block is used to read electricity meters.

|  |  |
| --- | --- |
| 3539410 | Not all electricity meters automatically send power data. In this case the corresponding structure remains empty. |
