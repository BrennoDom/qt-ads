...
5. FB\_MBUS\_IST\_Istameter

# FB\_MBUS\_IST\_Istameter

![37587916](/tcplclib_tc2_mbus/1033/Images/gif/174973451__en-US__Web.gif)
...
|  |  |
| --- | --- |
| 2746927 | The devices are supplied from a battery. The number of read operations is therefore limited. An internal meter prevents communication exceeding 96 times per day on average. The user must make sure that excessive queries are prevented. |
