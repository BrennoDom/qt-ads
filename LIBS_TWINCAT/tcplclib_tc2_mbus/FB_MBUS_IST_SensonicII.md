...
5. FB\_MBUS\_IST\_SensonicII

# FB\_MBUS\_IST\_SensonicII

![1199620](/tcplclib_tc2_mbus/1033/Images/gif/174983051__en-US__Web.gif)
...
|  |  |
| --- | --- |
| 10796581 | Maximum number of readings  The devices are supplied from a battery. The number of read operations is therefore limited. An internal counter prevents communication exceeding 96 times per day on average. The user must make sure that excessive queries are prevented. |
...
**stColdEnergy:** Meter reading, cooling energy consumption (see [ST\_MBus\_Info](ms-xhelp:///?Id=beckhoff-02ee-4cac-966f-9064b61eceb8)).
