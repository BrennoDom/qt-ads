...
4. FB\_IPCDiag\_WriteParameterByMdpIdx

# FB\_IPCDiag\_WriteParameterByMdpIdx

In individual cases, this function block can be used as an alternative to the simpler [FB\_IPCDiag\_WriteParameter](ms-xhelp:///?Id=beckhoff-adf3-48f9-b5c9-7b7caf01a2c4) in order to write any desired parameters of the IPC diagnostics.
...
**pBuffer:** The memory address of the data buffer that contains the data to be written is specified at this input.
