...
3. FB\_IPCDiag\_ReadParameter

# FB\_IPCDiag\_ReadParameter

The function block allows an IPC diagnostic parameter to be queried. The desired parameter is selected from the enumeration [E\_IPCDiag\_ParameterKey](ms-xhelp:///?Id=beckhoff-a43e-4ae7-94cf-ccf5dddf0869).
