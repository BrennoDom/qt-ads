...
7. FB\_DALIV2QueryContentDTR2

# FB\_DALIV2QueryContentDTR2

![60482217](/tcplclib_tc2_dali/1033/Images/gif/9007199397919883__en-US__Web.gif)

The contents of the DTR2 (Data Transfer Register 2) is read from the control gear.

|  |  |
| --- | --- |
| 7469042 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
