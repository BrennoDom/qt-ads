...
5. FB\_DALIV2StoreDTRAsMinLevel

# FB\_DALIV2StoreDTRAsMinLevel

![22483156](/tcplclib_tc2_dali/1033/Images/gif/9007199397891083__en-US__Web.gif)

This function block writes the value of the DTR into the [MIN LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable (the minimum permitted lamp power). If the value provided is larger than [MAX LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) then the value is simply set to MAX LEVEL. If the value provided is smaller than the [PHYSICAL MIN LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) then MIN LEVEL will be set to PHYSICAL MIN LEVEL.
