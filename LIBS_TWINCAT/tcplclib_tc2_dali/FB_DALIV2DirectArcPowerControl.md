...
6. [Power control](ms-xhelp:///?Id=beckhoff-af1e-4352-bb9c-49f65ad0deb4)
7. FB\_DALIV2DirectArcPowerControl

# FB\_DALIV2DirectArcPowerControl

![12405375](/tcplclib_tc2_dali/1033/Images/gif/9007199397823883__en-US__Web.gif)

If the *nArcPowerLevel* parameter is not within the range between [MAX VALUE](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) and [MIN VALUE](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) the lamp is switched to the corresponding minimum or maximum value. If the lamp is switched off this command will switch it on.  
The speed with which the specified value should be reached is given by the [FADE TIME](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable.
