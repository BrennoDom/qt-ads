...
7. FB\_DALIV2QueryVersionNumber

# FB\_DALIV2QueryVersionNumber

![66479500](/tcplclib_tc2_dali/1033/Images/gif/9007199397993483__en-US__Web.gif)

The [VERSION NUMBER](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable is read from the control gear. The version number corresponds to the version number of the IEC standard in accordance with which the software and hardware of the control gear has been developed and manufactured. The version number can only be read, and is specified by the manufacturer. The major version (*nMajorVersion*) and the minor version (*nMinorVersion*) can each have a value in the range from 0 to 15 (4 bits).
