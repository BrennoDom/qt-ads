...
7. FB\_DALIV2QueryGroups8UpTo15

# FB\_DALIV2QueryGroups8UpTo15

![62687](/tcplclib_tc2_dali/1033/Images/gif/9007199397935883__en-US__Web.gif)

The [GROUP 8-15](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable is read from the control gear and linked to an 8-bit value. Each bit represents one group. Bit 0 group 8 and bit 7 group 15. If the bit is set, the control gear belongs to the corresponding group.
