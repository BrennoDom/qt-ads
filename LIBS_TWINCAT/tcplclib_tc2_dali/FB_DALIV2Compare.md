...
![10956331](/tcplclib_tc2_dali/1033/Images/gif/9007199397999883__en-US__Web.gif)

The control gear compares its [RANDOM ADDRESS](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) with the [SEARCH ADDRESS](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e). If the random address is smaller than or equal to the search address, and if the control gear is not connected, then the output *bAnswer* is set to TRUE.
