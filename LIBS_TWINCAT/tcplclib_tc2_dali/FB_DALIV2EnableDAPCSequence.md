...
7. FB\_DALIV2EnableDAPCSequence

# FB\_DALIV2EnableDAPCSequence

![65311315](/tcplclib_tc2_dali/1033/Images/gif/9007199397830283__en-US__Web.gif)

This command starts a *Direct Arc Power Control* (DAPC) sequence. Following this command, DirectArcPowerControl commands must be sent using the [FB\_DALIV2DirectArcPowerControl()](ms-xhelp:///?Id=beckhoff-210a-4815-9635-3a8c9a9d0777) function block. There must not be any more than 200 ms between the individual commands; otherwise the sequence will be ended.

|  |  |
| --- | --- |
| 50930930 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
