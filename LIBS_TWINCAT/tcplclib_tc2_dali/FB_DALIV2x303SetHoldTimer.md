...
6. FB\_DALIV2x303SetHoldTimer

# FB\_DALIV2x303SetHoldTimer

![33063388](/tcplclib_tc2_dali/1033/Images/gif/4414924683__Web.gif)

Sets the value of the HOLD TIMER.

If the value 0 is transferred, the HOLD TIME is set to 1 s. Incrementing takes place in 10 s steps. The permissible value range is 1 s to 42.3 min.
