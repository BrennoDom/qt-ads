...
7. FB\_DALIV2QueryContentDTR0

# FB\_DALIV2QueryContentDTR0

![64356400](/tcplclib_tc2_dali/1033/Images/gif/4439165323__Web.gif)

The contents of the DTR0 (Data Transfer Register 0) is read from the control gear.

|  |  |
| --- | --- |
| 42336695 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
...
**nContentDTR0:** Content of the DTR0 (Data Transfer Register 0).
