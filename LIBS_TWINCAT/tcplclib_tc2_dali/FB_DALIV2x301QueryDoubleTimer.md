...
5. [Part 301 (button)](ms-xhelp:///?Id=beckhoff-a4a2-4dd5-a25e-78431b79710c)
6. FB\_DALIV2x301QueryDoubleTimer

# FB\_DALIV2x301QueryDoubleTimer

![15167431](/tcplclib_tc2_dali/1033/Images/gif/4414639883__Web.gif)

Queries the value of the DOUBLE TIMER.

The unit is 20 ms. The maximum permissible value is 2000 ms. The value 0 disables the timer. The smallest permitted value can be queried with the function block [FB\_DALIV2x301QueryDoubleTimerMin()](ms-xhelp:///?Id=beckhoff-e4c1-4682-940a-93c6c0d02732).
