...
7. FB\_DALIV2PhysicalSelection

# FB\_DALIV2PhysicalSelection

![15047603](/tcplclib_tc2_dali/1033/Images/gif/9007199398009483__en-US__Web.gif)

Any control gear that receives this command enters the *physical selection* mode. In this mode, the comparison of the [RANDOM ADDRESS](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) with the [SEARCH ADDRESS](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) is blocked.
