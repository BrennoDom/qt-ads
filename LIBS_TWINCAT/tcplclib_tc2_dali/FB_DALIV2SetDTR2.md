...
![60384317](/tcplclib_tc2_dali/1033/Images/gif/9007199398041483__en-US__Web.gif)

This command is only available as a broadcast. Data is written to the DTR2 of all the control gears.

|  |  |
| --- | --- |
| 6587942 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
