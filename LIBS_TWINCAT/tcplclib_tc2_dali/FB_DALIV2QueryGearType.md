...
6. FB\_DALIV2QueryGearType

# FB\_DALIV2QueryGearType

![61151353](/tcplclib_tc2_dali/1033/Images/gif/4413712011__Web.gif)

Queries the value of GEAR TYPE.

|  |  |
| --- | --- |
| 13491266 | This command is one of the application-specific expansion commands for LED modules with DALI interface. They function only if they are preceded by the *Enable Device Type 6* command, which can be sent with the [FB\_DALIV2EnableDeviceType()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1) function block. The command *Enable Device Type 6* is automatically internally prefixed to all application-related expansion commands for DALI LED modules. |
