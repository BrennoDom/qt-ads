...
7. FB\_DALIV2StepDown

# FB\_DALIV2StepDown

![35088084](/tcplclib_tc2_dali/1033/Images/gif/9007199397849483__en-US__Web.gif)

This function block immediately sets the current lamp power value one step lower. The lamps are not switched off by this command. The power is not further reduced if the lamp power has already reached [MIN LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e).
