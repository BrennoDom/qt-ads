...
7. FB\_DALIV2SetMaxLevel

# FB\_DALIV2SetMaxLevel

![9160681](/tcplclib_tc2_dali/1033/Images/gif/4439155723__Web.gif)

This function block writes to variable [MAX LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e). If the value provided is smaller than MIN LEVEL then the value is simply set to MIN LEVEL.
