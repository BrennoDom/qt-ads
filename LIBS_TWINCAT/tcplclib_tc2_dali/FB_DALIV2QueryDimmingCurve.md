...
6. FB\_DALIV2QueryDimmingCurve

# FB\_DALIV2QueryDimmingCurve

![38079613](/tcplclib_tc2_dali/1033/Images/gif/4413177611__Web.gif)

The dimming curve of the control gear is read out.

|  |  |
| --- | --- |
| 7172200 | This command is one of the application-specific expansion commands for LED modules with DALI interface. They function only if they are preceded by the *Enable Device Type 6* command, which can be sent with the [FB\_DALIV2EnableDeviceType()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1) function block. The command *Enable Device Type 6* is automatically internally prefixed to all application-related expansion commands for DALI LED modules. |
...
bError            : BOOL;  
nErrorId          : UDINT;  
eDimmingCurve     : E_DALIV2DimmingCurve;
```
...
**eDimmingCurve**: Dimming curve (linear or logarithmic) (see [E\_DALIV2DimmingCurve](ms-xhelp:///?Id=beckhoff-fd80-47ae-a000-300477d69607)).
