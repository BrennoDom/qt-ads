...
7. FB\_DALIV2SetMinLevel

# FB\_DALIV2SetMinLevel

![15337269](/tcplclib_tc2_dali/1033/Images/gif/4439158923__Web.gif)

This function block writes to variable [MIN LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e). If the value provided is larger than MAX LEVEL then the value is simply set to MAX LEVEL.
