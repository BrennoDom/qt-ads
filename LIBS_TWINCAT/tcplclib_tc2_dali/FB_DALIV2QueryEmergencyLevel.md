...
6. FB\_DALIV2QueryEmergencyLevel

# FB\_DALIV2QueryEmergencyLevel

![55844233](/tcplclib_tc2_dali/1033/Images/gif/9007199398207883__en-US__Web.gif)

The [EMERGENCY LEVEL](ms-xhelp:///?Id=beckhoff-5a16-4048-a4a1-4ec68f5b801b) variable (emergency illuminance) is read from the control gear. 255 is returned if the control gear is unable to determine the value.
