...
7. FB\_DALIV2xSetEventFilter

# FB\_DALIV2xSetEventFilter

![6448715](/tcplclib_tc2_dali/1033/Images/gif/4415247115__Web.gif)

This function block sets the event filter for the respective instance of the control unit instance.

Each bit in *nEventFilter* represents one event. If the bit is set, the associated event is also enabled. The event is disabled if the bit is not set.
