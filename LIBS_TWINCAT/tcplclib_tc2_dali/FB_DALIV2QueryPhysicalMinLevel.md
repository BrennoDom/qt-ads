...
7. FB\_DALIV2QueryPhysicalMinLevel

# FB\_DALIV2QueryPhysicalMinLevel

![59325057](/tcplclib_tc2_dali/1033/Images/gif/9007199397958283__en-US__Web.gif)

The [PHYSICAL MIN LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable (physically smallest possible lamp power) is read from the control gear. This value can only be read, and is specified by the manufacturer.
