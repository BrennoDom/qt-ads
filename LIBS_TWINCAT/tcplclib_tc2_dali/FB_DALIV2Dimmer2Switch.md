...
7. FB\_DALIV2Dimmer2Switch

# FB\_DALIV2Dimmer2Switch

![9911889](/tcplclib_tc2_dali/1033/Images/gif/9007199398105483__en-US__Web.gif)

The functions available in the FB\_DALIDimmer2Switch() function block correspond to those in the [FB\_DALIV2Dimmer1Switch()](ms-xhelp:///?Id=beckhoff-9d5c-44a9-af7d-8d2c52724170) function block. The difference is simply that two switches are connected to the FB\_DALIDimmer2Switch() function block. This allows the user to choose specifically between dimming up or dimming down.
...
**tSwitchOverTime:** Time for switching between the light on/off and dimming functions for the *bSwitchDimmUp* and *bSwitchDimDown* inputs.
