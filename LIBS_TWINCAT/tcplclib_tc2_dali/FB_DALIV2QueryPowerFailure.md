...
7. FB\_DALIV2QueryPowerFailure

# FB\_DALIV2QueryPowerFailure

![64163473](/tcplclib_tc2_dali/1033/Images/gif/9007199397961483__en-US__Web.gif)

Query whether the control gear has received a reset or a lamp power control command since it was switched on or not.
...
**bPowerFailure:** If the output is active, no lamp power control command has yet been sent to the control gear.
