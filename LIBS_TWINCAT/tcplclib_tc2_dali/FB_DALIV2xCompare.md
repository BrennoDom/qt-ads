...
7. FB\_DALIV2xCompare

# FB\_DALIV2xCompare

![3649016](/tcplclib_tc2_dali/1033/Images/gif/4415053067__Web.gif)

The control gear compares its random address with the search address. If the random address is less than or equal to the search address and the control unit is not excluded, then the output *bAnswer* is set to TRUE.
