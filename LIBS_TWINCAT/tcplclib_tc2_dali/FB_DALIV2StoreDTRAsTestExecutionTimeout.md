...
6. FB\_DALIV2StoreDTRAsTestExecutionTimeout

# FB\_DALIV2StoreDTRAsTestExecutionTimeout

![60968157](/tcplclib_tc2_dali/1033/Images/gif/9007199398287883__en-US__Web.gif)

Writes the value of the DTR (data transfer register) into the variable [TEST EXECUTION TIMEOUT](ms-xhelp:///?Id=beckhoff-5a16-4048-a4a1-4ec68f5b801b) (maximum execution time for a test).
