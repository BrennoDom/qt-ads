...
![23562574](/tcplclib_tc2_dali/1033/Images/gif/9007199397855883__en-US__Web.gif)

This function block immediately sets the current lamp power value one step higher. The lamps are not switched on by this command. The power is not further increased if the lamp power has already reached [MAX LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e).
