...
7. FB\_DALIV2SetFadeTime

# FB\_DALIV2SetFadeTime

![23387474](/tcplclib_tc2_dali/1033/Images/gif/4439149323__Web.gif)

The function block writes a value to variable [FADE TIME](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e). The range of possible values extends from 0 to 15.
...
**nFadeTime:** Time required for changing the current lamp power value to required value. The range of possible values extends from 0 to 15.
