...
6. FB\_DALIV2x301SetDoubleTimer

# FB\_DALIV2x301SetDoubleTimer

![14934289](/tcplclib_tc2_dali/1033/Images/gif/4414812683__Web.gif)

Sets the value of the DOUBLE TIMER.

The unit is 20 ms. The maximum permissible value is 2000 ms. The value 0 disables the timer. The minimum allowed value can be queried with [FB\_DALIV2x301QueryDoubleTimerMin()](ms-xhelp:///?Id=beckhoff-e4c1-4682-940a-93c6c0d02732).
