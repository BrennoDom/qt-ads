...
7. FB\_DALIV2xSetEventScheme

# FB\_DALIV2xSetEventScheme

![58038438](/tcplclib_tc2_dali/1033/Images/gif/4415250315__Web.gif)

With this function block the addressing scheme for the events of the respective instance of the control unit can be defined
...
eEventScheme      : E_DALIV2EventScheme := eDALIV2EventSchemeInstance;
```
...
**eEventScheme**: Addressing scheme for the events (see [E\_DALIV2EventScheme](ms-xhelp:///?Id=beckhoff-4817-4046-ac14-bedc616ded4b)).
