...
5. FB\_DALIV2EnableWriteMemory

# FB\_DALIV2EnableWriteMemory

![44508680](/tcplclib_tc2_dali/1033/Images/gif/9007199397865483__en-US__Web.gif)

Enables write access via [FB\_DALIV2WriteMemoryLocation()](ms-xhelp:///?Id=beckhoff-7716-459e-bc99-ef41a27500c2) to the internal memory of the control gear.

|  |  |
| --- | --- |
| 65033806 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
