...
5. FB\_DALIV2StoreDTRAsMaxLevel

# FB\_DALIV2StoreDTRAsMaxLevel

![32324290](/tcplclib_tc2_dali/1033/Images/gif/9007199397887883__en-US__Web.gif)

This function block writes the value of the DTR into the [MAX LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable. If the value provided is smaller than MIN LEVEL then the value is simply set to MIN LEVEL.
