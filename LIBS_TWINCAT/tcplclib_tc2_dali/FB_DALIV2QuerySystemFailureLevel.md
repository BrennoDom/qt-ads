...
7. FB\_DALIV2QuerySystemFailureLevel

# FB\_DALIV2QuerySystemFailureLevel

![37212772](/tcplclib_tc2_dali/1033/Images/gif/9007199397990283__en-US__Web.gif)

The [SYSTEM FAILURE LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable (lamp power on system error) is read from the control gear. If a fault (such as the absence of the supply voltage) is detected on the DALI bus, the control gear switches the lamp to this power value.
