...
6. FB\_DALIV2QueryThermalLoad

# FB\_DALIV2QueryThermalLoad

![37418306](/tcplclib_tc2_dali/1033/Images/gif/9007199398163083__en-US__Web.gif)

The [THERMAL LOAD](ms-xhelp:///?Id=beckhoff-668d-4053-a897-bdc3b3aa4303) variable is read. This contains a percentage figure in the range from 0% to 127.5% in steps of 0.5%.

|  |  |
| --- | --- |
| 1220438 | This command belongs to the application-related expansion commands for DALI discharge lamps. They function only if they are preceded by the *Enable Device Type 2* command, which can be sent with the [FB\_DALIV2EnableDeviceType()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1) function block. The *Enable Device Type 2* command is internally placed automatically before all application-related expansion commands for DALI discharge lamps. |
...
**nThermalLoad:** Content of the variable (see [THERMAL LOAD](ms-xhelp:///?Id=beckhoff-668d-4053-a897-bdc3b3aa4303)).
