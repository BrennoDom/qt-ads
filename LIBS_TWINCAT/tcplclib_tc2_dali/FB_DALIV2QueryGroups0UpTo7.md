...
7. FB\_DALIV2QueryGroups0UpTo7

# FB\_DALIV2QueryGroups0UpTo7

![6965](/tcplclib_tc2_dali/1033/Images/gif/9007199397932683__en-US__Web.gif)

The [GROUP 0-7](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variable is read from the control gear and linked to an 8-bit value. Each bit represents one group. Bit 0 group 0 and bit 7 group 7. If the bit is set, the control gear belongs to the corresponding group.
