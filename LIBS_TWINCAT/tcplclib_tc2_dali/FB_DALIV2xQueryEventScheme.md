...
7. FB\_DALIV2xQueryEventScheme

# FB\_DALIV2xQueryEventScheme

![65119131](/tcplclib_tc2_dali/1033/Images/gif/4415129867__Web.gif)

This function block can be used to query the addressing scheme for the events of the respective control unit instance.
...
bError            : BOOL;  
nErrorId          : UDINT;  
eEventScheme      : E_DALIV2EventScheme;
```
