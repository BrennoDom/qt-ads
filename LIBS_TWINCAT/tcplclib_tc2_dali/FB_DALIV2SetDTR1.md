...
![22286602](/tcplclib_tc2_dali/1033/Images/gif/9007199398038283__en-US__Web.gif)

This command is only available as a broadcast. Data is written to the DTR1 of all the control gears.

|  |  |
| --- | --- |
| 66361692 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
