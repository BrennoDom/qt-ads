...
6. FB\_DALIV2x301QueryShortTimer

# FB\_DALIV2x301QueryShortTimer

![51203652](/tcplclib_tc2_dali/1033/Images/gif/4414662283__Web.gif)

Queries the value of the SHORT TIMER.

The unit is 20 ms. The maximum permissible value is 5100 ms. The smallest permitted value can be queried with the function block [FB\_DALIV2x301QueryShortTimerMin()](ms-xhelp:///?Id=beckhoff-5f45-4c41-a4ed-65ef967a0fd3).
