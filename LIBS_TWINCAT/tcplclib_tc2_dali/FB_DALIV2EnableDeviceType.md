...
7. FB\_DALIV2EnableDeviceType

# FB\_DALIV2EnableDeviceType

![28842926](/tcplclib_tc2_dali/1033/Images/gif/9007199398003083__en-US__Web.gif)

This command must be sent every time prior to an application-specific extension command. As a result, only those control gears that belong to the corresponding [DEVICE TYPE](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) react. The command does not have to be used for device type 0. The following device types are defined according to the IEC 62386 standard:
