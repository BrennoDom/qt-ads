...
6. [Application-related expansion commands](ms-xhelp:///?Id=beckhoff-ac16-4d46-9472-260f8dc1f0f7)
7. FB\_DALIV2StartIdentification

# FB\_DALIV2StartIdentification

![54575646](/tcplclib_tc2_dali/1033/Images/gif/4420140811__Web.gif)

Starts a 10-second identification procedure of the control gear. The behavior is specified by the manufacturer. The lamp usually is usually switched on and off according to a certain pattern.

This command belongs to the application-related expansion commands. They function only if they are preceded by the *Enable Device Type* command, which can be sent with the [FB\_DALIV2EnableDeviceType()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1) function block. The Device Type to be activated can be set at the *nDeviceType* input.
...
**nDeviceType:** Identifier for the device type (see table under [FB\_DALIV2EnableDeviceType ()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1)).
