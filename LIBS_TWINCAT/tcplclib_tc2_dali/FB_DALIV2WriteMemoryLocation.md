...
7. FB\_DALIV2WriteMemoryLocation

# FB\_DALIV2WriteMemoryLocation

![5380904](/tcplclib_tc2_dali/1033/Images/gif/18014398652795275__en-US__Web.gif)

The value *nValue* is written to the memory bank of the control gear. The exact memory bank is specified by *nMemoryBank* and the address within the memory bank by *nOffset*.

|  |  |
| --- | --- |
| 48428136 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
