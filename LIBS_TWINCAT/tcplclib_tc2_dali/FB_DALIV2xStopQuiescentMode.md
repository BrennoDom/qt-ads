...
7. FB\_DALIV2xStopQuiescentMode

# FB\_DALIV2xStopQuiescentMode

![14499957](/tcplclib_tc2_dali/1033/Images/gif/4415263115__Web.gif)

The *quiescent mode* of the control unit is stopped.

In *Quiescent mode* the control unit does not send commands or events. *Quiescent mode* is started with [FB\_DALIV2xStartQuiescentMode()](ms-xhelp:///?Id=beckhoff-5e0b-4b4a-8bf3-c0e30cd9d5d6).
