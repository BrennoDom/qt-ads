...
6. [Queries](ms-xhelp:///?Id=beckhoff-0b64-46d9-a43f-9321f04234a2)
7. FB\_DALIV2QueryControlGearPresent

# FB\_DALIV2QueryControlGearPresent

![112514](/tcplclib_tc2_dali/1033/Images/gif/4439056907__Web.gif)

The function block provides information as to whether a specific control gear is ready for operation.

Using this command, it can easily be determined whether or not any control gears at all are connected to a DALI line. To do this, the function block with the parameter eAddrType = eDALIV2AddrTypeBroadcast is called. If the output *bBallast* is FALSE and output *nError* is 0, there is no control gear connected to the DALI line. If the output *nError* is 0 and the output *bBallast* is TRUE, there is exactly one control gear connected to the DALI line. If several control gears are connected, *nError* will return 5 (several control gears have replied). In this case it is irrelevant whether or not the control gears have short addresses.
