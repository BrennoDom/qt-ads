...
![54956439](/tcplclib_tc2_dali/1033/Images/gif/4439063307__Web.gif)

This command is only available as a broadcast. Data is written to the DTR0 of all the control gears.

|  |  |
| --- | --- |
| 24845910 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
