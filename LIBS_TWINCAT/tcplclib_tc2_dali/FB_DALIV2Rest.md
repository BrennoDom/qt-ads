...
![44915976](/tcplclib_tc2_dali/1033/Images/gif/9007199398255883__en-US__Web.gif)

This function block switches the lamp off if emergency mode is active. Otherwise the system switches to normal operation if mains voltage is available again, or if the [FB\_DALIV2ReLightResetInhibit()](ms-xhelp:///?Id=beckhoff-8065-4e46-a154-2acf3e16e5d4) function block was called.

|  |  |
| --- | --- |
| 1590600 | This command belongs to the application-related expansion commands for DALI emergency lighting. They function only if they are preceded by the *Enable Device Type 1* command, which can be sent with the [FB\_DALIV2EnableDeviceType()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1) function block. The *Enable Device Type 1* command is internally placed automatically before all application-related expansion commands for DALI emergency lighting. |
