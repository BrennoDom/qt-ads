...
7. FB\_DALIV2QueryDeviceType

# FB\_DALIV2QueryDeviceType

![1012626](/tcplclib_tc2_dali/1033/Images/gif/9007199397923083__en-US__Web.gif)

Reading takes place from the control gear of the device type ([DEVICE TYPE](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e)). The following device types are defined according to the IEC 62386 standard:
