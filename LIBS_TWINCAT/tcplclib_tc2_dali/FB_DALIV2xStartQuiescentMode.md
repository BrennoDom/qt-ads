...
7. FB\_DALIV2xStartQuiescentMode

# FB\_DALIV2xStartQuiescentMode

![31437268](/tcplclib_tc2_dali/1033/Images/gif/4415259915__Web.gif)

The Quiescent mode of the control unit is started.

The mode is limited to 15 min +/- 1.5 min after the last reception.

The function block F[FB\_DALIV2xStopQuiescentMode](ms-xhelp:///?Id=beckhoff-d20d-4ba2-a2d0-a01083aa8859) can be used to stop the Quiescent mode prematurely.
...
**eDataFrameType**: Output format of the DALI command (*eDALIV2DataFrameType24Bit* or *eDALIV2DataFrameTypeOsram*) (see [E\_DataFrameType](ms-xhelp:///?Id=beckhoff-fd87-4eb1-ba5f-fa6ea24f5b9d)).
