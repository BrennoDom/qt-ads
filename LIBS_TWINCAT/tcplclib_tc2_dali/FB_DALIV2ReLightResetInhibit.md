...
6. FB\_DALIV2ReLightResetInhibit

# FB\_DALIV2ReLightResetInhibit

![34122637](/tcplclib_tc2_dali/1033/Images/gif/9007199398243083__en-US__Web.gif)

The control gear is switched back to emergency mode (in the absence of mains voltage). This deactivates the function of the [FB\_DALIV2Inhibit()](ms-xhelp:///?Id=beckhoff-084d-4430-8cce-0a1d23828c85) function block.

|  |  |
| --- | --- |
| 38668280 | This command belongs to the application-related expansion commands for DALI emergency lighting. They function only if they are preceded by the *Enable Device Type 1* command, which can be sent with the [FB\_DALIV2EnableDeviceType()](ms-xhelp:///?Id=beckhoff-e277-46a4-85ba-43a8cbcb1cb1) function block. The *Enable Device Type 1* command is internally placed automatically before all application-related expansion commands for DALI emergency lighting. |
