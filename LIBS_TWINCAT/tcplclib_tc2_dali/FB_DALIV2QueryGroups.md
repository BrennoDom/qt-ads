...
7. FB\_DALIV2QueryGroups

# FB\_DALIV2QueryGroups

![14913854](/tcplclib_tc2_dali/1033/Images/gif/9007199397929483__en-US__Web.gif)

The [GROUP 0-7](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) and [GROUP 8-15](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) variables are read from the control gear and combined into a 16-bit value. Each bit represents one group. Bit 0 group 0 and bit 15 group 15. If the bit is set, the control gear belongs to the corresponding group.
