...
7. FB\_DALIV2QueryContentDTR1

# FB\_DALIV2QueryContentDTR1

![45485936](/tcplclib_tc2_dali/1033/Images/gif/9007199397916683__en-US__Web.gif)

The contents of the DTR1 (Data Transfer Register 1) is read from the control gear.

|  |  |
| --- | --- |
| 6720246 | This command can only be executed by DALI devices that comply with the IEC 62386 standard. |
