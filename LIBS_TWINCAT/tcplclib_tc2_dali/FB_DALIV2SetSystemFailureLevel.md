...
7. FB\_DALIV2SetSystemFailureLevel

# FB\_DALIV2SetSystemFailureLevel

![31636323](/tcplclib_tc2_dali/1033/Images/gif/4439152523__Web.gif)

The variable [SYSTEM FAILURE LEVEL](ms-xhelp:///?Id=beckhoff-1d79-413e-9ba3-da1d3f8e708e) (lamp power value at system error) is written to the control gear. If a fault (such as the absence of the supply voltage) is detected on the DALI bus, the control gear switches the lamp to this power value.
