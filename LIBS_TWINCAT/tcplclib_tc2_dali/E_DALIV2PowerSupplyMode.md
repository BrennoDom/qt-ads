...
5. E\_DALIV2PowerSupplyMode

# E\_DALIV2PowerSupplyMode

```
TYPE E_ DALIV2PowerSupplyMode:  
(  
  eDALIV2PowerSypplyModeOn    := 0,  
  eDALIV2PowerSypplyModeOff   := 1,  
  eDALIV2PowerSypplyModeAuto  := 2  
);  
END_TYPE
```
