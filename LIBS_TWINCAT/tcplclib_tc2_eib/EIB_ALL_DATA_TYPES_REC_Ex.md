...
# EIB\_ALL\_DATA\_TYPES\_REC\_Ex

![11036355](/tcplclib_tc2_eib/1033/Images/gif/187872139__en-US__Web.gif)
...
**EIB\_Data\_Len:** Contains the user data length of the incoming EIB telegram. / data < 8 bit specified length 1, / data >=) 8 bit specified length +1 / example: If 1 bit of data is received, the length in EIB\_Data\_Len is 1. If 2 bytes of data are received, the length in EIB\_Data\_Len is 3.
