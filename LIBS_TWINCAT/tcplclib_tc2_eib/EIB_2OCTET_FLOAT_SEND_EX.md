...
# EIB\_2OCTET\_FLOAT\_SEND\_EX

![55844233](/tcplclib_tc2_eib/1033/Images/gif/9007199442635531__Web.gif)

This function block sends a 2-byte float EIB value to the set group address. An IEC61131-3 REAL value is available as input value. The data can be sent in Manual, Polling or OnChange mode (*iMode*).
...
**Group\_Address:** Group address from which the data is sent ([EIB\_GROUP\_ADDR](ms-xhelp:///?Id=beckhoff-b660-4bbb-871b-bcd96d7eaa4e)). This group address must be entered in the filters!
