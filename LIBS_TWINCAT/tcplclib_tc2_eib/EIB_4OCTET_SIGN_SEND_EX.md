...
# EIB\_4OCTET\_SIGN\_SEND\_EX

![63863782](/tcplclib_tc2_eib/1033/Images/gif/9007199442661131__Web.gif)

This function block sends a 4-byte sign EIB value to the set group address. An IEC61131-3 DINT value is available as input value. The data can be sent in Manual, Polling or OnChange mode (*iMode*).
...
**uiData:** The data value in DINT is automatically converted to an EIB 4OCTET SIGN value.
