...
3. FB\_CX7080\_LED\_ERR

# FB\_CX7080\_LED\_ERR
...
|  |  |
| --- | --- |
| 45559064 | User-specific function of the LEDs  Due to the user-specific usability of the LEDs, Beckhoff Support cannot know the meaning of a flashing code and cannot support the customer.    * Document the function of the LEDs for your customers, |
