...
3. FB\_EcMasterFrameStatisticClearTxRxErr

# FB\_EcMasterFrameStatisticClearTxRxErr

![34816825](/tcplclib_tc2_ethercat/1033/Images/png/57255819__Web.png)
...
**sNetId**: String containing the AMS network ID of the CPU (PC). (type: T\_AMSNetId)

**nEcMasterDevID:** Device ID of the EtherCAT master.
