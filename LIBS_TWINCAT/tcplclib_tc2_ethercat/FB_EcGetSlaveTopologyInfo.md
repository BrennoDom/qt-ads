...
3. FB\_EcGetSlaveTopologyInfo

# FB\_EcGetSlaveTopologyInfo

![12470207](/tcplclib_tc2_ethercat/1033/Images/png/2239765131__Web.png)

The function block `FB_EcGetSlaveTopolgyInfo` can be used to determine topology information.
...
**pAddrBuf**: Address of an array of structures of type [ST\_TopologyDataEx](ms-xhelp:///?Id=beckhoff-566f-4658-bae8-c1d255b42c81), which contains the topology data.
