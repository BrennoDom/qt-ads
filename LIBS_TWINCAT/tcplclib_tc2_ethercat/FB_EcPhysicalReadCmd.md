...
3. FB\_EcPhysicalReadCmd

# FB\_EcPhysicalReadCmd

![23361726](/tcplclib_tc2_ethercat/1033/Images/png/57156619__Web.png)
...
| eAdressingType\_BroadCAST | All slaves are addressed by this command. adp can be set to 0. |
...
| eType | Command |
| --- | --- |
| eAdressingType\_Fixed | Configured Address Physical Read ( FPRD) |
| eAdressingType\_AutoInc | Auto Increment Physical Read ( APRD) |
| eAdressingType\_BroadCAST | Broadcast Read ( BRD) |
