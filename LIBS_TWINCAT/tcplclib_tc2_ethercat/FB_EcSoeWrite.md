...
![39473694](/tcplclib_tc2_ethercat/1033/Images/png/57236619__Web.png)
...
**nSlaveAddr:** Fixed address of the EtherCAT slave to which the SoE write command is to be sent.

**nIdn:** Identification number of the parameter to be written.

**nElement:** Element number of the parameter to be written. The following values are permitted:
...
**bCommand:** This parameter must be set if internal command execution is to be used.
