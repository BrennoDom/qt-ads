# FB_DALI_Steinel_ControlProDualUS
...
6. FB\_DALI\_Steinel\_ControlProDualUS

# FB\_DALI\_Steinel\_ControlProDualUS

![50714607](/tcplclib_tc3_dali/1033/Images/png/18014406249283339__Web.png)

The function block represents the ControlPro Dual US DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 53778287 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 14242537 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 61073976 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
