...
7. FB\_DALI102RemoveFromGroup

# FB\_DALI102RemoveFromGroup

![37253141](/tcplclib_tc3_dali/1033/Images/gif/9007205111428491__Web.gif)

The function block removes the DALI control gear from the group *nGroup*.

Internally, the group membership is stored in the variable [gearGroups](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7).

Each bit of *gearGroups* represents a group. Bit 0 corresponds to group 0 etc., up to bit 15 in group 15. If a bit is set, the DALI control gear belongs to the corresponding group.

|  |  |
| --- | --- |
| 66842817 | The function block sends the DALI command REMOVE FROM GROUP twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 64714441 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
