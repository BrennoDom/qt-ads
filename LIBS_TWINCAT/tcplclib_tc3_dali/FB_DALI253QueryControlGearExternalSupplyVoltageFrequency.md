# FB_DALI253QueryControlGearExternalSupplyVoltageFrequency
...
6. FB\_DALI253QueryControlGearExternalSupplyVoltageFrequency

# FB\_DALI253QueryControlGearExternalSupplyVoltageFrequency

![7733362](/tcplclib_tc3_dali/1033/Images/gif/8371372683__Web.gif)

The function block reads the frequency of the external supply voltage from the DALI control gear.
...
|  |  |
| --- | --- |
| 2491394 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
fControlGearExternalSupplyVoltageFrequency  : BYTE;
```
...
**fControlGearExternalSupplyVoltageFrequency:** Frequency of the external supply voltage [Hz] (0…253).
