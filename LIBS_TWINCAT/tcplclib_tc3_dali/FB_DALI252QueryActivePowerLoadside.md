# FB_DALI252QueryActivePowerLoadside
...
5. [Part 252 (energy reporting)](ms-xhelp:///?Id=beckhoff-10f7-4d6f-8772-d4fd52542992)
6. FB\_DALI252QueryActivePowerLoadside

# FB\_DALI252QueryActivePowerLoadside

![25807001](/tcplclib_tc3_dali/1033/Images/gif/8370670731__Web.gif)

The function block reads the load-side active power from the DALI control gear.

It is calculated as follows:

![30936422](/tcplclib_tc3_dali/1033/Images/png/9007207691603211__Web.png)
...
|  |  |
| --- | --- |
| 9992350 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                          : BOOL;  
nActivePowerLoadside           : UDINT;  
nScaleFactorForLoadsidePower   : SINT;
```
...
**nActivePowerLoadside:** Load-side active power [W] (0…4294967293).

**nScaleFactorForLoadsidePower:** Scaling factor for the load-side active power (-6...6).
