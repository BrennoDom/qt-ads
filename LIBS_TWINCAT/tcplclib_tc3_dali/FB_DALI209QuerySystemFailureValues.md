# FB_DALI209QuerySystemFailureValues
...
7. FB\_DALI209QuerySystemFailureValues

# FB\_DALI209QuerySystemFailureValues

![42137138](/tcplclib_tc3_dali/1033/Images/gif/9043492875__Web.gif)

The function block reads the variable [systemFailureLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) and the corresponding color/color temperature settings from the DALI control gear.

Initially, only the color temperature is readable.

|  |  |
| --- | --- |
| 43689923 | In addition to the DALI command QUERY SYSTEM FAILURE LEVEL, the function block sends the DALI commands QUERY COLOUR VALUE and ENABLE DEVICE TYPE 8, as is necessary for application-related extension commands (see [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |

|  |  |
| --- | --- |
| 57664987 | The function block changes the DTR0 of all connected DALI control gears. |
...
|  |  |
| --- | --- |
| 49222835 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nSystemFailureLevel:** Output value in the case of a system failure (0…255).
