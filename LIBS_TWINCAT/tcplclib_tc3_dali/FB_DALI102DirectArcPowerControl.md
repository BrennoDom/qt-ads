...
6. [Control commands](ms-xhelp:///?Id=beckhoff-2fcd-4b3a-9c1a-696b65584553)
7. FB\_DALI102DirectArcPowerControl

# FB\_DALI102DirectArcPowerControl

![63321005](/tcplclib_tc3_dali/1033/Images/gif/9007205111213963__Web.gif)

The function block switches the DALI control gear to the preset value *nArcPowerLevel*.

If *nArcPowerLevel* is outside the specified variable [maxLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) or [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) of the DALI control gear, it is set to the corresponding lowest or highest value. The DALI control gear is switched on by the command if it was previously off.

If *nArcPowerLevel* = 0, the DALI control gear is switched off. If *nArcPowerLevel* = 255, the DALI control gear retains its current value.

The speed at which the specified value is to be reached is specified by the variable [fadeRate](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7).
...
|  |  |
| --- | --- |
| 33018140 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |

**nArcPowerLevel:** Control value for the control gear (0...255).
