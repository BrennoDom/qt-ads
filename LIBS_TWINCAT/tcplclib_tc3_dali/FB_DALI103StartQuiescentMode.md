...
7. FB\_DALI103StartQuiescentMode

# FB\_DALI103StartQuiescentMode

![40730901](/tcplclib_tc3_dali/1033/Images/gif/9007205112171403__Web.gif)

The function block enables the [Quiescent mode](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) for approx. 15 minutes.

In Quiescent mode, no commands and events are sent from the DALI control device.

Quiescent mode can be terminated prematurely with the function block [FB\_DALI103StopQuiescentMode](ms-xhelp:///?Id=beckhoff-dbf7-4637-9440-598a33d6135b).

|  |  |
| --- | --- |
| 31033795 | The function block sends the DALI command START QUIESCENT MODE twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 10868702 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 30709455 | The command priorities are supported by the KL6821 from the firmware version BD. |
