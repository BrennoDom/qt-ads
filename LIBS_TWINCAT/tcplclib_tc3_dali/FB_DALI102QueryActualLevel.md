...
7. FB\_DALI102QueryActualLevel

# FB\_DALI102QueryActualLevel

![46769243](/tcplclib_tc3_dali/1033/Images/gif/9007205110900363__Web.gif)

The function block reads the current output value of the DALI control gear (see [acutalLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)).

The current output value is 0 or lies within the value range from [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) to [maxLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7).

*bError* is set to TRUE if the DALI control gear returns the value 255 (MASK). In this case the DALI control gear is in the start-up phase or there is a technical defect.
...
|  |  |
| --- | --- |
| 18270010 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nActualLevel:** Current output value (0, *minLevel*…*maxLevel*).
