...
7. FB\_DALI102SetFadeRate

# FB\_DALI102SetFadeRate

![49774232](/tcplclib_tc3_dali/1033/Images/gif/18014404366160651__Web.gif)

The function block sets the [fadeRate](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) to the value *eFadeRate*.

The *fadeRate* determines the rate of change, in steps per second, of the output value.

The *fadeRate* is used in the function blocks [FB\_DALI102Down](ms-xhelp:///?Id=beckhoff-5d14-41b9-93d5-d58881aafe78) and [FB\_DALI102Up](ms-xhelp:///?Id=beckhoff-a291-416f-9eaa-1d61385fc2de).

|  |  |
| --- | --- |
| 45314905 | The function block changes the DTR0 of all connected DALI control gears. |

|  |  |
| --- | --- |
| 5180964 | The function block sends the DALI command SET FADE RATE twice, as required by the DALI standard for certain commands. |
...
eFadeRate         : E_DALIFadeRate := E_DALIFadeRate.N045StepsPerSec;
```
...
|  |  |
| --- | --- |
| 46628683 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
