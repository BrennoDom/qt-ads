...
7. FB\_DALI102QueryMinLevel

# FB\_DALI102QueryMinLevel

![55364084](/tcplclib_tc3_dali/1033/Images/gif/9007205101983499__Web.gif)

The function block reads the variable [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) from the DALI control gear.
...
|  |  |
| --- | --- |
| 28514710 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
