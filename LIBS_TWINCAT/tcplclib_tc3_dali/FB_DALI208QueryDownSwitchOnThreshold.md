# FB_DALI208QueryDownSwitchOnThreshold
...
7. FB\_DALI208QueryDownSwitchOnThreshold

# FB\_DALI208QueryDownSwitchOnThreshold

![27683123](/tcplclib_tc3_dali/1033/Images/gif/10380137739__Web.gif)

The function block reads the variable [downSwitchOnThreshold](ms-xhelp:///?Id=beckhoff-c35d-4ca0-9bd6-597c2a99a83f) from the DALI control gear.

The output of the DALI control gear is set as soon as the falling virtual output value reaches or falls below the threshold value *downSwitchOnThreshold*.

|  |  |
| --- | --- |
| 47821519 | Prior to the DALI command QUERY DOWN SWITCH-ON, the function block sends the DALI command ENABLE DEVICE TYPE 7, as is necessary for application extended commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 27740487 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nDownSwitchOnThreshold:** Threshold value (0…255) for switching on the output with a falling virtual output value.
