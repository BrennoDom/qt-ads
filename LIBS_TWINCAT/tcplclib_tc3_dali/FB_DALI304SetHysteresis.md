...
6. FB\_DALI304SetHysteresis

# FB\_DALI304SetHysteresis

![41254304](/tcplclib_tc3_dali/1033/Images/gif/9007205111715467__Web.gif)

The function block stores the value *nHysteresis* in the variable [hysteresis](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb) of the DALI control device.

The value is stated in %. The permissible value range is between 0% and 25%.

|  |  |
| --- | --- |
| 35744420 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 53264332 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nHysteresis:** Input value of the variable *hysteresis* in %.
