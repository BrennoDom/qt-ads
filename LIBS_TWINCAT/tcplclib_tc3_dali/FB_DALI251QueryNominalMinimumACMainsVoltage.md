# FB_DALI251QueryNominalMinimumACMainsVoltage
...
6. FB\_DALI251QueryNominalMinimumACMainsVoltage

# FB\_DALI251QueryNominalMinimumACMainsVoltage

![66660559](/tcplclib_tc3_dali/1033/Images/gif/8368147211__Web.gif)

The function block reads the minimum nominal mains input voltage of the DALI control gear.
...
|  |  |
| --- | --- |
| 63074124 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                          : BOOL;  
nNominalMinimumACMainsVoltage  : UINT;
```
...
**nNominalMinimumACMainsVoltage:** Minimum nominal input voltage [V] (90…480).
