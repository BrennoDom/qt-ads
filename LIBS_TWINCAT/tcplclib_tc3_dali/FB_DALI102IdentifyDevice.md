...
7. FB\_DALI102IdentifyDevice

# FB\_DALI102IdentifyDevice

![56389407](/tcplclib_tc3_dali/1033/Images/gif/9007205111636235__Web.gif)

The function block starts the identification routine for the DALI control gear.

It takes approx. 10 seconds and ends automatically. The exact scope of the identification routine depends on the manufacturer of the control gear.

|  |  |
| --- | --- |
| 37742617 | The function block sends the DALI command IDENTIFY DEVICE twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 4139237 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
