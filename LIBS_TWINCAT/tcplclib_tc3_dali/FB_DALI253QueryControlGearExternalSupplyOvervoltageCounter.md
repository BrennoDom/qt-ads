# FB_DALI253QueryControlGearExternalSupplyOvervoltageCounter
...
6. FB\_DALI253QueryControlGearExternalSupplyOvervoltageCounter

# FB\_DALI253QueryControlGearExternalSupplyOvervoltageCounter

![54578237](/tcplclib_tc3_dali/1033/Images/gif/8370682507__Web.gif)

The function block reads the counter for the detected overvoltage events of the external supply voltage of the DALI control gear.
...
|  |  |
| --- | --- |
| 21442089 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                         : BOOL;  
nControlGearExternalSupplyOvervoltageCounter  : BYTE;
```
...
**nControlGearExternalSupplyOvervoltageCounter:** Number of detected overvoltage events of the external supply voltage (0...253).
