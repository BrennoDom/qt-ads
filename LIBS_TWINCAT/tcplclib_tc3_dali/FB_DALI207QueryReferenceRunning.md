# FB_DALI207QueryReferenceRunning
...
7. FB\_DALI207QueryReferenceRunning

# FB\_DALI207QueryReferenceRunning

![42069424](/tcplclib_tc3_dali/1033/Images/gif/6438041099__Web.gif)

The function block queries whether a reference measurement of the system power is activated.

|  |  |
| --- | --- |
| 43080504 | Prior to the DALI command QUERY REFERENCE RUNNING, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application-related expansion commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 52180221 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bReferenceRunning:** Indicates whether the reference measurement of the system performance is performed.
