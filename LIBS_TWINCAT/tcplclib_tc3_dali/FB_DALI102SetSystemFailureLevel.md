# FB_DALI102SetSystemFailureLevel
...
7. FB\_DALI102SetSystemFailureLevel

# FB\_DALI102SetSystemFailureLevel

![31297682](/tcplclib_tc3_dali/1033/Images/gif/9007205111219851__Web.gif)

The function block stores the value *nSystemFailureLevel* in the variable [systemFailureLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) of the DALI control gear.

|  |  |
| --- | --- |
| 13243689 | The function block changes the DTR0 of all connected DALI control gears. |

|  |  |
| --- | --- |
| 52084342 | The function block sends the DALI command SET SYSTEM FAILURE LEVEL twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 66105898 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
