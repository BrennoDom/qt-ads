# FB_DALI253QueryControlGearPowerFactor
...
6. FB\_DALI253QueryControlGearPowerFactor

# FB\_DALI253QueryControlGearPowerFactor

![3010817](/tcplclib_tc3_dali/1033/Images/gif/8371406091__Web.gif)

The function block outputs the power factor of the DALI control gear.
...
|  |  |
| --- | --- |
| 27097356 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**fControlGearPowerFactor:** Power factor (0.0…1.0).
