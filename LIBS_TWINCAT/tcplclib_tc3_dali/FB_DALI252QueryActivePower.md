...
6. FB\_DALI252QueryActivePower

# FB\_DALI252QueryActivePower

![6847548](/tcplclib_tc3_dali/1033/Images/gif/8370667787__Web.gif)

The function block reads the active power from the DALI control gear.

It is calculated as follows:

![61627937](/tcplclib_tc3_dali/1033/Images/png/9007207691138571__Web.png)
...
|  |  |
| --- | --- |
| 17780525 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                          : BOOL;  
nActivePower                   : UDINT;  
nScaleFactorForActivePower     : SINT;
```
...
**nActivePower:** Active power [W] (0…4294967293).

**nScaleFactorForActivePower:** Scaling factor for the active power (-6...6).
