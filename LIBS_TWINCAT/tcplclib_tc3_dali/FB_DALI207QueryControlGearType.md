# FB_DALI207QueryControlGearType
...
7. FB\_DALI207QueryControlGearType

# FB\_DALI207QueryControlGearType

![14879189](/tcplclib_tc3_dali/1033/Images/gif/18014404947407627__Web.gif)

The function block reads the variable [controlGearType](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0) from the DALI control gear.

|  |  |
| --- | --- |
| 66803845 | Prior to the DALI command QUERY CONTROL GEAR TYPE, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application-related expansion commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 64363694 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nControlGearType:** Outputs the value of the variable *controlGearType* (0…255).
