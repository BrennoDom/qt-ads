...
5. [Lunatone](ms-xhelp:///?Id=beckhoff-1489-483a-a839-4e713e491a29)
6. FB\_DALI\_Lunatone\_CS

# FB\_DALI\_Lunatone\_CS

![43682709](/tcplclib_tc3_dali/1033/Images/png/10738270091__Web.png)

The function block represents the CS DALI-2 sensor from Lunatone.
...
|  |  |
| --- | --- |
| 57600065 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 48638545 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 35093725 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
...
| nHysteresisMinBrightness | BYTE | Get, Set | 20 | As the percentage hysteresis can also lead to large fluctuations at low brightness, a minimum hysteresis can be specified via this property. The minimum hysteresis is an absolute value with a value range from 0 to 255. |
