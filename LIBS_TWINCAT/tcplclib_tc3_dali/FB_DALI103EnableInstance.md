...
7. FB\_DALI103EnableInstance

# FB\_DALI103EnableInstance

![16146366](/tcplclib_tc3_dali/1033/Images/gif/9007205112217611__Web.gif)

The function block activates the selected instance of the DALI control device (see [instanceActive](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)).

The function block [FB\_DALI103DisableInstance](ms-xhelp:///?Id=beckhoff-ce00-42a0-92ca-e2f655a4e298) can be used to disable the instance.

|  |  |
| --- | --- |
| 11099566 | The function block sends the DALI command ENABLE INSTANCE twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 32787233 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 26649649 | The command priorities are supported by the KL6821 from the firmware version BD. |
