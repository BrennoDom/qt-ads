# FB_DALI253QueryControlGearExternalSupplyUndervoltageCounter
...
6. FB\_DALI253QueryControlGearExternalSupplyUndervoltageCounter

# FB\_DALI253QueryControlGearExternalSupplyUndervoltageCounter

![62026502](/tcplclib_tc3_dali/1033/Images/gif/8371366795__Web.gif)

The function block reads the counter for the detected undervoltage events of the external supply voltage of the DALI control gear.
...
|  |  |
| --- | --- |
| 21367612 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                          : BOOL;  
nControlGearExternalSupplyUndervoltageCounter  : BYTE;
```
...
**nControlGearExternalSupplyUndervoltageCounter:** Number of detected undervoltage events of the external supply voltage (0...253).
