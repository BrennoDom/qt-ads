# FB_DALI251QueryPowerAtMinimumDimLevel
...
6. FB\_DALI251QueryPowerAtMinimumDimLevel

# FB\_DALI251QueryPowerAtMinimumDimLevel

![30796205](/tcplclib_tc3_dali/1033/Images/gif/8370658955__Web.gif)

The function block reads the power consumption at the minimum dimming level of the DALI control gear.
...
|  |  |
| --- | --- |
| 8730397 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nPowerAtMinimumDimLevel:** Power consumption [W] at the minimum dimming value (0…65534).
