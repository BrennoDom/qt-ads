# FB_DALI103QueryInputDeviceError
...
7. FB\_DALI103QueryInputDeviceError

# FB\_DALI103QueryInputDeviceError

![41510976](/tcplclib_tc3_dali/1033/Images/gif/9007205112135051__Web.gif)

The function block reads more detailed error information of the input devices from the DALI control device (see [inputDeviceError](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)).

The meaning depends on the manufacturer of the DALI control device.

|  |  |
| --- | --- |
| 38054464 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 6945858 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nInputDeviceError:** Output of the error information of the input devices of the DALI control device (manufacturer-dependent).
