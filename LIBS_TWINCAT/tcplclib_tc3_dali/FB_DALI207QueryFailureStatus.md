...
7. FB\_DALI207QueryFailureStatus

# FB\_DALI207QueryFailureStatus

![41227749](/tcplclib_tc3_dali/1033/Images/gif/6437916811__Web.gif)

The function block reads the failure status from the DALI control gear (see [failureStatus](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0)).

|  |  |
| --- | --- |
| 35505424 | Prior to the DALI command QUERY FAILURE STATUS, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application-related expansion commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 51113363 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nFailureStatus:** Returns the failure status (see [failureStatus](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0)).
