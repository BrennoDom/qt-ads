...
5. [Part 304 (light sensors)](ms-xhelp:///?Id=beckhoff-442b-48af-bacb-07950cddaecd)
6. FB\_DALI304SetDeadtimeTimer

# FB\_DALI304SetDeadtimeTimer

![63575268](/tcplclib_tc3_dali/1033/Images/gif/9007205111718411__Web.gif)

The function block stores the value of *nDeadtime* in the variable [tDeadtime](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb) of the DALI control device.
...
|  |  |
| --- | --- |
| 35306501 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 49323054 | The command priorities are supported by the KL6821 from the firmware version BD. |
