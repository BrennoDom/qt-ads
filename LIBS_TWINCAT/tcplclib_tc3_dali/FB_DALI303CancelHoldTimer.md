...
6. FB\_DALI303CancelHoldTimer

# FB\_DALI303CancelHoldTimer

![56283646](/tcplclib_tc3_dali/1033/Images/gif/9007205111951627__Web.gif)

The function block ends the Hold Timer prematurely if the latter was implemented in the DALI control device.

|  |  |
| --- | --- |
| 36790769 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 62681466 | The command priorities are supported by the KL6821 from the firmware version BD. |
