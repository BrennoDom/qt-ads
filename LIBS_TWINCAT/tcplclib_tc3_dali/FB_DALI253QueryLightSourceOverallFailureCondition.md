# FB_DALI253QueryLightSourceOverallFailureCondition
...
6. FB\_DALI253QueryLightSourceOverallFailureCondition

# FB\_DALI253QueryLightSourceOverallFailureCondition

![12469873](/tcplclib_tc3_dali/1033/Images/gif/8371521163__Web.gif)

The function block indicates the status of [lampFailure](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) on the DALI control gear.
...
|  |  |
| --- | --- |
| 45119994 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
bLightSourceOverallFailureCondition         : BOOL;
```
...
**nLightSourceOverallFailureCondition:** The output is set as soon as a light source error has been detected in the DALI control gear.
