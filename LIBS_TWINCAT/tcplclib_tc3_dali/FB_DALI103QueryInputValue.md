...
7. FB\_DALI103QueryInputValue

# FB\_DALI103QueryInputValue

![62512728](/tcplclib_tc3_dali/1033/Images/gif/9007205112119307__Web.gif)

The function block queries the input value (see [inputValue](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)) of the selected instance of the DALI control device.

The parameter *nResolution* specifies how high the resolution (in bits) of the input value is. The function block [FB\_DALI103QueryResolution](ms-xhelp:///?Id=beckhoff-dc1a-4ac7-8842-31c4c4213b35) can be used to read the resolution.

All bytes of the input value are read and subsequently decoded.

Make sure that the parameter *nResolution* corresponds to the device's actual resolution, as otherwise decoding errors may occur.
...
Part 302 (input devices, absolute input devices) - [introduction](ms-xhelp:///?Id=beckhoff-071c-4f95-9a92-c586d5868580)

Part 303 (occupancy sensors) - [introduction](ms-xhelp:///?Id=beckhoff-5860-45ad-91f4-6edf1ff97245)

Part 304 (brightness sensors) - [introduction](ms-xhelp:///?Id=beckhoff-9545-4680-9025-766fb391cf97)

The DALI commands QUERY INPUT VALUE and QUERY INPUT VALUE LATCH are called internally.

|  |  |
| --- | --- |
| 25743641 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 30366184 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nResolution:** Resolution of the input value in bits (1...64).
...
**nInputValue:** The input value of the selected instance of the DALI control device.
