# FB_DALI253QueryLightSourceOpenCircuit
...
6. FB\_DALI253QueryLightSourceOpenCircuit

# FB\_DALI253QueryLightSourceOpenCircuit

![25276401](/tcplclib_tc3_dali/1033/Images/gif/8371515275__Web.gif)

The function block indicates whether there is an open circuit to the light source.
...
|  |  |
| --- | --- |
| 26161025 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bLightSourceOpenCircuit:** The output is set as soon as an open circuit to the light source is detected.
