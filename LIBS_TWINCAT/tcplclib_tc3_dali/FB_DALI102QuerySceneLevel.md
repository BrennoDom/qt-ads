...
7. FB\_DALI102QuerySceneLevel

# FB\_DALI102QuerySceneLevel

![33599791](/tcplclib_tc3_dali/1033/Images/gif/9007205101971723__Web.gif)

The function block reads the output value from the DALI control gear for the specified scene *nScene*.
...
|  |  |
| --- | --- |
| 33962670 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
