...
6. FB\_DALI\_Steinel\_IRMicro

# FB\_DALI\_Steinel\_IRMicro

![39171493](/tcplclib_tc3_dali/1033/Images/gif/18014406249301003__Web.gif)

The function block represents the IR Micro DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 16999120 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 18774354 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 34751460 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
