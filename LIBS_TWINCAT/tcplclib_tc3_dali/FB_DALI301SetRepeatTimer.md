...
6. FB\_DALI301SetRepeatTimer

# FB\_DALI301SetRepeatTimer

![32971110](/tcplclib_tc3_dali/1033/Images/gif/9007205112009227__Web.gif)

The function block stores the value of *nRepeat* in the variable [tRepeat](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b) of the DALI control device.

The value is written in steps of 20 ms. The permissible value range is 100 ms to 2000 ms, i.e. from 5 to 100.

|  |  |
| --- | --- |
| 28304539 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 53414263 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nRepeat:** Value of the variable *tRepeat* [20 ms]. The input value is between 2 and 100, as a multiple of the step size of 20 ms.
