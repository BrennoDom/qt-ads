# FB_DALI251QueryNominalMaximumACMainsVoltage
...
6. FB\_DALI251QueryNominalMaximumACMainsVoltage

# FB\_DALI251QueryNominalMaximumACMainsVoltage

![27335113](/tcplclib_tc3_dali/1033/Images/gif/8368144267__Web.gif)

The function block reads the maximum nominal mains input voltage of the DALI control gear.
...
|  |  |
| --- | --- |
| 44689431 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                          : BOOL;  
nNominalMaximumACMainsVoltage  : UINT;
```
...
**nNominalMaximumACMainsVoltage:** Maximum nominal input voltage [V] (90…480).
