# FB_DALI208QueryUpSwitchOffThreshold
...
7. FB\_DALI208QueryUpSwitchOffThreshold

# FB\_DALI208QueryUpSwitchOffThreshold

![55128053](/tcplclib_tc3_dali/1033/Images/gif/10380402571__Web.gif)

This function block reads the variable [upSwitchOffThreshold](ms-xhelp:///?Id=beckhoff-c35d-4ca0-9bd6-597c2a99a83f) from the DALI control gear.
...
The threshold value is disabled if a value of 255 (MASK) is returned.

|  |  |
| --- | --- |
| 26390432 | Prior to the DALI command QUERY UP SWITCH-OFF, the function block sends the DALI command ENABLE DEVICE TYPE 7, as is necessary for application extended commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 36187300 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nSwitchOffThreshold:** Threshold value (1…255) for switching off with a rising virtual output value.
