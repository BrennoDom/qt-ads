# FB_DALI253QueryRatedMedianUsefulLifeOfLuminaire
...
6. FB\_DALI253QueryRatedMedianUsefulLifeOfLuminaire

# FB\_DALI253QueryRatedMedianUsefulLifeOfLuminaire

![66066743](/tcplclib_tc3_dali/1033/Images/gif/8371633291__Web.gif)

The function block indicates the estimated average lifetime of the complete luminaire, including all individual components.

The function block [FB\_DALI253SetRatedMedianUsefulLifeOfLuminaire](ms-xhelp:///?Id=beckhoff-04a6-4ad7-965e-060275ab4c9e) writes the value to the DALI control gear.
...
|  |  |
| --- | --- |
| 57729775 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nRatedMedianUsefulLifeOfLuminaire           : BYTE;
```
...
**nRatedMedianUsefulLifeOfLuminaire:** Estimated average service life [1000 h]. The value lies within the range 0...253 as a multiple of the step size of 1000 h.
