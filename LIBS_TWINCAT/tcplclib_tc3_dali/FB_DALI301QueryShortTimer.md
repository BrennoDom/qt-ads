...
6. FB\_DALI301QueryShortTimer

# FB\_DALI301QueryShortTimer

![54340147](/tcplclib_tc3_dali/1033/Images/gif/9007205111979147__Web.gif)

The function block reads the variable [tShort](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b).

The value is read in steps of 20 ms. The maximum permissible value is 5100 ms, or 255. The smallest permitted value can be queried with the function block [FB\_DALI301QueryShortTimerMin](ms-xhelp:///?Id=beckhoff-c1cc-4d2b-b7c2-bcb79e858e09).

|  |  |
| --- | --- |
| 19299281 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 39475801 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nShort:** Value of the variable *tShort* [20 ms]. The maximum output value is 255, as a multiple of the step size of 20 ms.
