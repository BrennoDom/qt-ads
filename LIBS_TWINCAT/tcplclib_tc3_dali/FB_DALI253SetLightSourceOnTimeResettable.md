# FB_DALI253SetLightSourceOnTimeResettable
...
6. FB\_DALI253SetLightSourceOnTimeResettable

# FB\_DALI253SetLightSourceOnTimeResettable

![23670787](/tcplclib_tc3_dali/1033/Images/gif/8371642123__Web.gif)

The function block sets the resettable operating hour counter of the light source to any desired value. If the light source is switched on, the resettable operating hour counter is incremented by one every second.

The resettable operating hour counter can be read using the function block [FB\_DALI253QueryLightSourceOnTimeResettable](ms-xhelp:///?Id=beckhoff-c494-4f32-a9c2-831d5cbb212d).
...
|  |  |
| --- | --- |
| 11710498 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |

**nLightSourceOnTimeResettable:** New value of the resettable operating hour counter [s] (0…4294967293).
