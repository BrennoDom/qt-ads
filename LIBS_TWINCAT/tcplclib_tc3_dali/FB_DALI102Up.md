...
![24604028](/tcplclib_tc3_dali/1033/Images/gif/9007205110903307__Web.gif)

The output value of the DALI control gear is increased over the specified period of 200 ms.

The variable [fadeRate](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)determines the number of steps by which the output value is changed within the 200 ms.

If the current output value is already at the [maxLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) value, the output value remains unchanged.

This command does not switch on the DALI control gear.
...
|  |  |
| --- | --- |
| 20109663 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
