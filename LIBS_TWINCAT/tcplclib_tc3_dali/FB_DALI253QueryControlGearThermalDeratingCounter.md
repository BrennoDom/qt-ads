# FB_DALI253QueryControlGearThermalDeratingCounter
...
6. FB\_DALI253QueryControlGearThermalDeratingCounter

# FB\_DALI253QueryControlGearThermalDeratingCounter

![12086140](/tcplclib_tc3_dali/1033/Images/gif/8371430667__Web.gif)

The function block reads the counter that counts the number of times the temperature limit value inside the DALI control gear is exceeded.
...
|  |  |
| --- | --- |
| 41666396 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nControlGearThermalDeratingCounter          : BYTE;
```
...
**nControlGearThermalDeratingCounter:** Number of times the internal temperature was exceeded (0…253).
