# FB_DALI253QueryLightSourceOnTime
...
6. FB\_DALI253QueryLightSourceOnTime

# FB\_DALI253QueryLightSourceOnTime

![10539156](/tcplclib_tc3_dali/1033/Images/gif/8371496587__Web.gif)

The function block reads the non-resettable operating hour counter of the light source. If the light source is switched on, the non-resettable operating hour counter is incremented by one every second.

The non-resettable operating hour counter cannot be reset or changed.
...
|  |  |
| --- | --- |
| 27743545 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nLightSourceOnTime:** Current value of the non-resettable operating hour counter [s] (0…4294967293).
