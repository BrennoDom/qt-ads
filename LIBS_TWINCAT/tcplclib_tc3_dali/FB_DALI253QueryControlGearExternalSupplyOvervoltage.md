# FB_DALI253QueryControlGearExternalSupplyOvervoltage
...
6. FB\_DALI253QueryControlGearExternalSupplyOvervoltage

# FB\_DALI253QueryControlGearExternalSupplyOvervoltage

![47898561](/tcplclib_tc3_dali/1033/Images/gif/8370679563__Web.gif)

The function block indicates whether an overvoltage has been detected in the external supply voltage of the DALI control gear.
...
|  |  |
| --- | --- |
| 28433869 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                  : BOOL;  
bControlGearExternalSupplyOvervoltage  : BOOL;
```
...
**bControlGearExternalSupplyOvervoltage:** The output is set as soon as an overvoltage has been detected in the external supply voltage of the DALI control gear.
