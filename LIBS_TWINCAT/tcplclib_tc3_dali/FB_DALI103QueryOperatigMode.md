...
7. FB\_DALI103QueryOperatigMode

# FB\_DALI103QueryOperatigMode

![3013405](/tcplclib_tc3_dali/1033/Images/gif/9007205112088843__Web.gif)

The function block reads the variable [operatingMode](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) from the DALI control device.

The meaning of this variable is defined by the manufacturer of the DALI control device.

|  |  |
| --- | --- |
| 27120652 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 42759282 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nOperatingMode:** Output of the variable [operatingMode](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6).
