...
6. FB\_DALI303SetDeadtimeTimer

# FB\_DALI303SetDeadtimeTimer

![28166553](/tcplclib_tc3_dali/1033/Images/gif/9007205111892619__Web.gif)

The function block stores the value of *nDeadtime* in the variable [tDeadtime](ms-xhelp:///?Id=beckhoff-fa49-4c91-9b22-8d7a079a1aca) of the DALI control device.
...
|  |  |
| --- | --- |
| 52172387 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 66898301 | The command priorities are supported by the KL6821 from the firmware version BD. |
