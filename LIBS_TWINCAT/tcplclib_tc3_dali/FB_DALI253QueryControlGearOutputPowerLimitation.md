# FB_DALI253QueryControlGearOutputPowerLimitation
...
6. FB\_DALI253QueryControlGearOutputPowerLimitation

# FB\_DALI253QueryControlGearOutputPowerLimitation

![11736974](/tcplclib_tc3_dali/1033/Images/gif/8371381515__Web.gif)

The function block indicates whether the limit value of the output power of the DALI control gear was exceeded.
...
|  |  |
| --- | --- |
| 38523909 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                  : BOOL;  
bControlGearOutputPowerLimitation      : BOOL;
```
...
**bControlGearOutputPowerLimitation:** The output is set as soon as the output power of the DALI control gear is higher than the set limit value.
