# FB_DALI253QueryLightSourceOverallFailureConditionCounter
...
6. FB\_DALI253QueryLightSourceOverallFailureConditionCounter

# FB\_DALI253QueryLightSourceOverallFailureConditionCounter

![3426769](/tcplclib_tc3_dali/1033/Images/gif/8371524107__Web.gif)

The function block reads the counter of the light source error events.
...
|  |  |
| --- | --- |
| 30840926 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nLightSourceOverallFailureConditionCounter  : BYTE;
```
...
**nLightSourceOverallFailureConditionCounter:** Number of errors detected (0...253).
