# FB_DALI103DisablePowerCycleNotification
...
7. FB\_DALI103DisablePowerCycleNotification

# FB\_DALI103DisablePowerCycleNotification

![48268995](/tcplclib_tc3_dali/1033/Images/gif/9007205112236299__Web.gif)

The function block locks the event *Power Cycle Notification*.

The event can be released with the function block [FB\_DALI103EnablePowerCycleNotification](ms-xhelp:///?Id=beckhoff-f02c-4510-b8c7-6f50101afba7).

|  |  |
| --- | --- |
| 31767774 | The function block sends the DALI command DISABLE POWER CYCLE NOTIFICATION twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 17474517 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 23052927 | The command priorities are supported by the KL6821 from the firmware version BD. |
