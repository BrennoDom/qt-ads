...
7. FB\_DALI102RecallMaxLevel

# FB\_DALI102RecallMaxLevel

![25040094](/tcplclib_tc3_dali/1033/Images/gif/9007205111109643__Web.gif)

The output value of the DALI control gear is set to [maxLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7).
...
|  |  |
| --- | --- |
| 24034261 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
