# FB_DALI253QueryLightSourceOnTimeResettable
...
6. FB\_DALI253QueryLightSourceOnTimeResettable

# FB\_DALI253QueryLightSourceOnTimeResettable

![48365314](/tcplclib_tc3_dali/1033/Images/gif/8371499531__Web.gif)

The function block reads the resettable operating hour counter of the light source. If the light source is switched on, the resettable operating hour counter is incremented by one every second. The resettable operating hour counter can be changed using the function block [FB\_DALI253SetLightSourceOnTimeResettable](ms-xhelp:///?Id=beckhoff-85fc-4a0f-9824-416f8a0027ea).
...
|  |  |
| --- | --- |
| 32634650 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nLightSourceOnTimeResettable                : UDINT;
```
...
**nLightSourceOnTimeResettable:** Current value of the resettable operating hour counter of the light source [s] (0…4294967293).
