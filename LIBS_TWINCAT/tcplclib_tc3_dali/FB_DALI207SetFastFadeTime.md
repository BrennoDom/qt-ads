...
7. FB\_DALI207SetFastFadeTime

# FB\_DALI207SetFastFadeTime

![24201902](/tcplclib_tc3_dali/1033/Images/gif/6438109963__Web.gif)

The function block saves the value *eFastFadeTime* in the variable f[astFadeTime](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0) of the DALI control gear.
...
|  |  |
| --- | --- |
| 16490530 | Prior to the DALI command SET FAST FADE TIME, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application extended commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |

|  |  |
| --- | --- |
| 14197042 | The function block sends the DALI command SET FAST FADE TIME twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 60664521 | The function block changes the DTR0 of all connected DALI control gears. |
...
eFastFadeTime     : E_DALIFastFadeTime := E_DALIFastFadeTime.Disabled;
```
...
|  |  |
| --- | --- |
| 9109783 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |

**eFastFadeTime:** Fast fade time for the change in the output value (see [E\_DALIFastFadeTime](ms-xhelp:///?Id=beckhoff-9b1b-48d2-8db6-48bf6d5765e1)).
