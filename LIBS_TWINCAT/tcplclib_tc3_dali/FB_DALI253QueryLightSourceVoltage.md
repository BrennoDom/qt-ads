# FB_DALI253QueryLightSourceVoltage
...
6. FB\_DALI253QueryLightSourceVoltage

# FB\_DALI253QueryLightSourceVoltage

![18214233](/tcplclib_tc3_dali/1033/Images/gif/8371630347__Web.gif)

The function block reads the output voltage at the DALI control gear.
...
|  |  |
| --- | --- |
| 29710370 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**fLightSourceVoltage:** Output voltage [V] (0.0…6553.3).
