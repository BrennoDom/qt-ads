...
7. FB\_DALI102AddToGroup

# FB\_DALI102AddToGroup

![5968939](/tcplclib_tc3_dali/1033/Images/gif/9007205111638795__Web.gif)

The function block adds the DALI control gear to the *nGroup* group.
...
|  |  |
| --- | --- |
| 53720453 | The function block sends the DALI command ADD TO GROUP twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 13722030 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
