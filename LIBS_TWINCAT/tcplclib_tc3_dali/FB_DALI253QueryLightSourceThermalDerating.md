# FB_DALI253QueryLightSourceThermalDerating
...
6. FB\_DALI253QueryLightSourceThermalDerating

# FB\_DALI253QueryLightSourceThermalDerating

![50964406](/tcplclib_tc3_dali/1033/Images/gif/8371618571__Web.gif)

The function block indicates whether the light source temperature is higher than the specified limit value.
...
|  |  |
| --- | --- |
| 56026474 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
bLightSourceThermalDerating                 : BOOL;
```
...
**bLightSourceThermalDerating:** The output is set as soon as the temperature measured at the light source is higher than the specified limit value.
