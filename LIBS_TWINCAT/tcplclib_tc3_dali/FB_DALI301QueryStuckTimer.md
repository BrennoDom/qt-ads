...
6. FB\_DALI301QueryStuckTimer

# FB\_DALI301QueryStuckTimer

![27627990](/tcplclib_tc3_dali/1033/Images/gif/9007205111973259__Web.gif)

The function block reads the variable [tStuck](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b).

The value is read in steps of 1 s. The permissible value range is 5 s to 255 s.

|  |  |
| --- | --- |
| 47325326 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 23274750 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nStuck:** Value of the variable *tStuck* [s].
