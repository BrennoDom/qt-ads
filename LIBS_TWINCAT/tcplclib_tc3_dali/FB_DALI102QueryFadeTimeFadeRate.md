# FB_DALI102QueryFadeTimeFadeRate
...
7. FB\_DALI102QueryFadeTimeFadeRate

# FB\_DALI102QueryFadeTimeFadeRate

![41397042](/tcplclib_tc3_dali/1033/Images/gif/18014404356774667__Web.gif)

The function block reads the variables [fadeTime](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) and [fadeRate](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) from the DALI control gear.

The *fadeTime* is used in the function blocks [FB\_DALI102DirectArcPowerControl](ms-xhelp:///?Id=beckhoff-0c46-458d-aa43-e38363cdead0) and [FB\_DALI102GoToScene](ms-xhelp:///?Id=beckhoff-a569-4c24-b493-8153725be7b8), while *fadeRate* is used with [FB\_DALI102Up](ms-xhelp:///?Id=beckhoff-a291-416f-9eaa-1d61385fc2de) and [FB\_DALI102Down](ms-xhelp:///?Id=beckhoff-5d14-41b9-93d5-d58881aafe78).
...
|  |  |
| --- | --- |
| 37029065 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**eFadeTime:** Fade time for the change of the output value (see [E\_DALIFadeTime](ms-xhelp:///?Id=beckhoff-dc14-4a77-afee-af76d66da9e6)).

**eFadeRate:** Fade rate for the change of the output value (see [E\_DALIFadeRate](ms-xhelp:///?Id=beckhoff-105a-4ff0-8b03-643eb3dc2c5a)).
