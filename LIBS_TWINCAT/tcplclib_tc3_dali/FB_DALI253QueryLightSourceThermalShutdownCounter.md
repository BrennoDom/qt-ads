# FB_DALI253QueryLightSourceThermalShutdownCounter
...
6. FB\_DALI253QueryLightSourceThermalShutdownCounter

# FB\_DALI253QueryLightSourceThermalShutdownCounter

![41650091](/tcplclib_tc3_dali/1033/Images/gif/8371627403__Web.gif)

The function block reads the counter that counts the number of thermal shutdowns of the light source.
...
|  |  |
| --- | --- |
| 39306505 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nLightSourceThermalShutdownCounter          : BYTE;
```
...
**nLightSourceThermalShutdownCounter:** Number of thermal shutdowns (0…253).
