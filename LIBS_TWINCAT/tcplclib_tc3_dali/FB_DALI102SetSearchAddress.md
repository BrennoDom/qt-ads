...
7. FB\_DALI102SetSearchAddress

# FB\_DALI102SetSearchAddress

![65880360](/tcplclib_tc3_dali/1033/Images/gif/9007205101916683__Web.gif)

The function block stores the value *nSearchAddress* in the [searchAddress](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) variable for all selected DALI control gears.
...
|  |  |
| --- | --- |
| 56052334 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
