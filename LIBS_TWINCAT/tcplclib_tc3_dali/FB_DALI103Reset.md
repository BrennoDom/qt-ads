...
![1907972](/tcplclib_tc3_dali/1033/Images/gif/9007205112183179__Web.gif)

The function block resets all device and instance variables of the DALI control device to their default values (see [resetState](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)).

DALI control devices can take up to 300 ms to execute the DALI command. Only then are further DALI commands executed by the respective control device.

|  |  |
| --- | --- |
| 17171756 | The function block sends the DALI command RESET twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 20328083 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 48735027 | The command priorities are supported by the KL6821 from the firmware version BD. |
