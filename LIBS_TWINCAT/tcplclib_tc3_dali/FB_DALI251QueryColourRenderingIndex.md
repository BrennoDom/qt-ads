# FB_DALI251QueryColourRenderingIndex
...
6. FB\_DALI251QueryColourRenderingIndex

# FB\_DALI251QueryColourRenderingIndex

![47313454](/tcplclib_tc3_dali/1033/Images/gif/8367701259__Web.gif)

The function block reads the color rendering index from the DALI control gear.
...
|  |  |
| --- | --- |
| 23167904 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nColourRenderingIndex:** Outputs the color rendering index (0…100).
