# FB_DALI207QueryMinFastFadeTime
...
7. FB\_DALI207QueryMinFastFadeTime

# FB\_DALI207QueryMinFastFadeTime

![14679294](/tcplclib_tc3_dali/1033/Images/gif/6437972875__Web.gif)

The function block reads the variable [minFastFadeTime](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0) from the DALI control gear.

|  |  |
| --- | --- |
| 65004788 | Prior to the DALI command MIN FAST FADE TIME, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application-related expansion commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 48172185 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy              : BOOL;  
eMinFastFadeTime   : E_DALIFastFadeTime;
```
...
**eMinFastFadeTime:** Returns the minimum value of the *fastFadeTime* parameter (see [E\_DALIFastFadeTime](ms-xhelp:///?Id=beckhoff-9b1b-48d2-8db6-48bf6d5765e1)).
