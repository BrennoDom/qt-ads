...
6. FB\_DALI302QuerySwitch

# FB\_DALI302QuerySwitch

![2747002](/tcplclib_tc3_dali/1033/Images/gif/7746862987__Web.gif)

The function block queries whether the instance represents a switch.

|  |  |
| --- | --- |
| 24723024 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 21180630 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bSwitch:** The output is set if the instance represents a switch.
