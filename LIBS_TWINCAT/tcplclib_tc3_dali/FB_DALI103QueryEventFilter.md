...
7. FB\_DALI103QueryEventFilter

# FB\_DALI103QueryEventFilter

![27437792](/tcplclib_tc3_dali/1033/Images/gif/9007205112140939__Web.gif)

The function block reads the event filter (see [eventFilter](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)) for the selected instance of the DALI control device.
...
|  |  |
| --- | --- |
| 45613538 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 7868661 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nEventFilter:** Each bit represents a manufacturer-specific event that has been enabled or disabled.
