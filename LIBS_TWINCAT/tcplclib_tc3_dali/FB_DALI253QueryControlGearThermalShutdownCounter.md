# FB_DALI253QueryControlGearThermalShutdownCounter
...
6. FB\_DALI253QueryControlGearThermalShutdownCounter

# FB\_DALI253QueryControlGearThermalShutdownCounter

![41596476](/tcplclib_tc3_dali/1033/Images/gif/8371436555__Web.gif)

The function block reads the counter of the number of thermal shutdowns of the DALI control gear.
...
|  |  |
| --- | --- |
| 38823967 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nControlGearThermalShutdownCounter          : BYTE;
```
...
**nControlGearThermalShutdownCounter:** Number of thermal shutdowns (0…253).
