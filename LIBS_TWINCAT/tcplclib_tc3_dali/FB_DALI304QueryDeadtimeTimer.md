...
6. FB\_DALI304QueryDeadtimeTimer

# FB\_DALI304QueryDeadtimeTimer

![46687245](/tcplclib_tc3_dali/1033/Images/gif/9007205111870987__Web.gif)

The function block reads the variable [tDeadtime](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb).

The value is read in steps of 50 ms. The permissible value range is 0 s to 12.75 s. It is output in numbers from 0 to 255.

|  |  |
| --- | --- |
| 17532027 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 23570516 | The command priorities are supported by the KL6821 from the firmware version BD. |
