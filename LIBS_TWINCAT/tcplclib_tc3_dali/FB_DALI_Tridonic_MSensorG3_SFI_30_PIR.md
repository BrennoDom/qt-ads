# FB_DALI_Tridonic_MSensorG3_SFI_30_PIR
...
6. FB\_DALI\_Tridonic\_MSensorG3\_SFI\_30\_PIR

# FB\_DALI\_Tridonic\_MSensorG3\_SFI\_30\_PIR

![38847270](/tcplclib_tc3_dali/1033/Images/gif/9007208249363467__Web.gif)

The function block represents the MSensor G3 SFI 30 PIR 5DPI, MSensor G3 SFI 30 PIR 10DPI or MSensor G3 SFI 30 PIR 16DPI DALI sensor from Tridonic.

This outputs an occupancy signal (instance 0), a measured brightness value (instance 1) and six push button signals (instances 2 to 7).
...
The input variables *bQueryOccupancy* and *bQueryBrightness* trigger the immediate readout of the corresponding instance.

|  |  |
| --- | --- |
| 14081115 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 59621178 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 66828554 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |

**nPushButtonNEvent:** The output outputs the events of the push buttons via one bit each for a cycle.
...
| nEventFilterPushButtonInternN | BYTE | Get, Set | 2#1000\_0011 | Setting of the [event filter](ms-xhelp:///?Id=beckhoff-9269-4225-99b2-0eb0584f7ebf) |
