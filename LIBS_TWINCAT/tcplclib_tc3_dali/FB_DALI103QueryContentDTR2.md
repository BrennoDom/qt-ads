...
7. FB\_DALI103QueryContentDTR2

# FB\_DALI103QueryContentDTR2

![55475379](/tcplclib_tc3_dali/1033/Images/gif/9007205112159627__Web.gif)

The function block reads the content of the [DTR2](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) (Data Transfer Register 2) from the DALI control device.

|  |  |
| --- | --- |
| 29516363 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 64320678 | The command priorities are supported by the KL6821 from the firmware version BD. |
