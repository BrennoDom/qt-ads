...
6. FB\_DALI303SetReportTimer

# FB\_DALI303SetReportTimer

![27784979](/tcplclib_tc3_dali/1033/Images/gif/9007205111901451__Web.gif)

The function block stores the value of *nReport* in the variable [tReport](ms-xhelp:///?Id=beckhoff-fa49-4c91-9b22-8d7a079a1aca) of the DALI control device.
...
|  |  |
| --- | --- |
| 48738220 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 35990804 | The command priorities are supported by the KL6821 from the firmware version BD. |
