# FB_DALI253QueryLightSourceOpenCircuitCounter
...
6. FB\_DALI253QueryLightSourceOpenCircuitCounter

# FB\_DALI253QueryLightSourceOpenCircuitCounter

![34122633](/tcplclib_tc3_dali/1033/Images/gif/8371518219__Web.gif)

The function block reads the counter of the number of open circuits to the light source.
...
|  |  |
| --- | --- |
| 38668243 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nLightSourceOpenCircuitCounter              : BYTE;
```
...
**nLightSourceOpenCircuitCounter:** Number of open circuits (0…253).
