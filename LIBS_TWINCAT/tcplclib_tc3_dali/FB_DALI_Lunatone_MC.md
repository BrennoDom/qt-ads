...
6. FB\_DALI\_Lunatone\_MC

# FB\_DALI\_Lunatone\_MC

![47408069](/tcplclib_tc3_dali/1033/Images/png/9007208340822411__Web.png)

The function block represents the MC DALI push-button interface from Lunatone.
...
|  |  |
| --- | --- |
| 24019444 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 14848410 | The function block cannot be used when using the KL6811. |
