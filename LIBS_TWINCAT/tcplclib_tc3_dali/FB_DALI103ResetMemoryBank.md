...
7. FB\_DALI103ResetMemoryBank

# FB\_DALI103ResetMemoryBank

![35962059](/tcplclib_tc3_dali/1033/Images/gif/7939842955__Web.gif)

The values of the selected memory bank of the DALI control device are set to their respective default values by the function block (see [Memory banks](ms-xhelp:///?Id=beckhoff-f157-4446-a05b-f675f276156a)).

During the reset, the DALI control device does not react to other commands.
...
|  |  |
| --- | --- |
| 55223077 | The function block changes the DTR0 and the DTR1 of all connected DALI control devices. |

|  |  |
| --- | --- |
| 27245651 | The function block sends the DALI command RESET MEMORY BANK twice, as foreseen by the DALI standard for certain DALI commands. |

|  |  |
| --- | --- |
| 43884268 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 59414099 | The command priorities are supported by the KL6821 from the firmware version BD. |
