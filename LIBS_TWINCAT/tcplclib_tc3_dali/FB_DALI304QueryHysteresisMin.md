...
6. FB\_DALI304QueryHysteresisMin

# FB\_DALI304QueryHysteresisMin

![27338368](/tcplclib_tc3_dali/1033/Images/gif/9007205111865099__Web.gif)

The function block reads the variable [hysteresisMin](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb).

The permissible value range is between 0 and 255.
...
|  |  |
| --- | --- |
| 44718725 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 66924213 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nHysteresisMin:** Value of the smallest possible hysteresis.
