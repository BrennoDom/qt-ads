# FB_DALI253QueryLightSourceThermalDeratingCounter
...
6. FB\_DALI253QueryLightSourceThermalDeratingCounter

# FB\_DALI253QueryLightSourceThermalDeratingCounter

![34476226](/tcplclib_tc3_dali/1033/Images/gif/8371621515__Web.gif)

The function block reads the counter that counts the number of times the light source temperature exceeded the limit value.
...
|  |  |
| --- | --- |
| 41850582 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nLightSourceThermalDeratingCounter          : BYTE;
```
...
**nLightSourceThermalDeratingCounter:** Number of times the light source temperature was exceeded (0…253).
