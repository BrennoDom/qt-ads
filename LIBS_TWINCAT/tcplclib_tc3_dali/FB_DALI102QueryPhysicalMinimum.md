# FB_DALI102QueryPhysicalMinimum
...
7. FB\_DALI102QueryPhysicalMinimum

# FB\_DALI102QueryPhysicalMinimum

![55305800](/tcplclib_tc3_dali/1033/Images/gif/9007205101980555__Web.gif)

The function block reads the variable [physicalMinimum](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) from the DALI control gear.

The value is read-only and is fixed by the manufacturer.
...
|  |  |
| --- | --- |
| 27990155 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nPhysicalMinimum:** Physically smallest possible output value (1...254).
