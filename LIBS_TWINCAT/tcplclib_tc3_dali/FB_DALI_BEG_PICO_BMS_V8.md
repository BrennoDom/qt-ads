...
6. FB\_DALI\_BEG\_PICO\_BMS\_V8

# FB\_DALI\_BEG\_PICO\_BMS\_V8

![39731869](/tcplclib_tc3_dali/1033/Images/png/9007209010960139__Web.png)

The function block represents the PICO-BMS DALI-2 DALI sensor from B.E.G..
...
|  |  |
| --- | --- |
| 22042507 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 64164835 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 40612608 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
