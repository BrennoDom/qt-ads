...
7. FB\_DALI102RecallMinLevel

# FB\_DALI102RecallMinLevel

![14981763](/tcplclib_tc3_dali/1033/Images/gif/9007205111106699__Web.gif)

The output value of the DALI control gear is set to [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) value.
...
|  |  |
| --- | --- |
| 618145 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
