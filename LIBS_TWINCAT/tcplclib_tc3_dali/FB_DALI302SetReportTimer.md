...
6. FB\_DALI302SetReportTimer

# FB\_DALI302SetReportTimer

![50770908](/tcplclib_tc3_dali/1033/Images/gif/7757672075__Web.gif)

The function block stores the value of *nReport* in the variable [tReport](ms-xhelp:///?Id=beckhoff-8cb2-4476-8117-2b8f842ee86e) of the DALI control device.

The value is written in steps of 1 s. The permissible value range is 0 s to 4 min 15 s. It is entered in numbers from 0 to 255.

|  |  |
| --- | --- |
| 54284994 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 18802902 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nReport:** Value of the variable *tReport* [1 s]. The input value is between 0 and 255, as a multiple of the step size of 1 s.
