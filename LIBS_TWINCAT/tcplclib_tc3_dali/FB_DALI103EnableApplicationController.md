# FB_DALI103EnableApplicationController
...
7. FB\_DALI103EnableApplicationController

# FB\_DALI103EnableApplicationController

![6149759](/tcplclib_tc3_dali/1033/Images/gif/9007205112220555__Web.gif)

The function block activates the application controller (see [applicationActive](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)).

The application controller can be disabled with the function block [FB\_DALI103DisableApplicationController](ms-xhelp:///?Id=beckhoff-ec1b-4eb6-b019-6fad0aa23ab5).

|  |  |
| --- | --- |
| 55347837 | The function block sends the DALI command ENABLE APPLICATION CONTROLLER twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 28368490 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 53989823 | The command priorities are supported by the KL6821 from the firmware version BD. |
