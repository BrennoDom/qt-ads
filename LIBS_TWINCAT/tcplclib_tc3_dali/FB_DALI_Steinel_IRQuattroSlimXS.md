# FB_DALI_Steinel_IRQuattroSlimXS
...
6. FB\_DALI\_Steinel\_IRQuattroSlimXS

# FB\_DALI\_Steinel\_IRQuattroSlimXS

![51251115](/tcplclib_tc3_dali/1033/Images/gif/18014406250881291__Web.gif)

The function block represents the IR Quattro Slim XS DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 58606859 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 57699690 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 49535170 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
