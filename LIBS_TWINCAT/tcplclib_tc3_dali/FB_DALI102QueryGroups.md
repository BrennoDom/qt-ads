...
7. FB\_DALI102QueryGroups

# FB\_DALI102QueryGroups

![64826129](/tcplclib_tc3_dali/1033/Images/gif/9007205102030731__Web.gif)

The function block reads the variable [gearGroups](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) from the DALI control gear.

Each bit represents one group. Bit 0 (group 0) to bit 15 (group 15). If the bit is set, the DALI control gear belongs to the corresponding group.

The DALI commands QUERY GROUPS 0-7 and QUERY GROUPS 8-15 are called internally.
...
|  |  |
| --- | --- |
| 46564252 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
