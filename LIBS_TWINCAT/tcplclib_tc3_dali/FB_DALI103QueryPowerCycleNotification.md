# FB_DALI103QueryPowerCycleNotification
...
7. FB\_DALI103QueryPowerCycleNotification

# FB\_DALI103QueryPowerCycleNotification

![49289224](/tcplclib_tc3_dali/1033/Images/gif/9007205112085899__Web.gif)

The function block outputs whether the *Power Cycle Notification* event of a DALI control device is enabled.

The function block [FB\_DALI103EnablePowerCycleNotification](ms-xhelp:///?Id=beckhoff-f02c-4510-b8c7-6f50101afba7) can be used to enable the event.

The function block [FB\_DALI103DisablePowerCycleNotification](ms-xhelp:///?Id=beckhoff-b15a-4591-8bdb-618009d02697) can be used to disable the event.

|  |  |
| --- | --- |
| 40949840 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 33004241 | The command priorities are supported by the KL6821 from the firmware version BD. |
