# FB_DALI253QueryRatedMedianUsefulLightSourceStarts
...
6. FB\_DALI253QueryRatedMedianUsefulLightSourceStarts

# FB\_DALI253QueryRatedMedianUsefulLightSourceStarts

![49805933](/tcplclib_tc3_dali/1033/Images/gif/8371636235__Web.gif)

The function block indicates the average number of possible starts of the complete luminaire, including all individual components.

The function block [FB\_DALI253SetRatedMedianUsefulLightSourceStarts](ms-xhelp:///?Id=beckhoff-ad40-426c-af42-624a873f9530) writes the value to the DALI control gear.
...
|  |  |
| --- | --- |
| 45600217 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nRatedMedianUsefulLightSourceStarts         : UINT;
```
...
**nRatedMedianUsefulLightSourceStarts:** Number of average possible starts [100]. The value lies within the range 0...65533 as a multiple of the step size of 100.
