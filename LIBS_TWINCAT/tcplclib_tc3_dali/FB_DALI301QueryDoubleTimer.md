...
6. FB\_DALI301QueryDoubleTimer

# FB\_DALI301QueryDoubleTimer

![63592346](/tcplclib_tc3_dali/1033/Images/gif/9007205112000779__Web.gif)

The function block reads the variable [tDouble](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b).

The value is read in steps of 20 ms. The maximum permissible value is 2000 ms or 100. The value 0 disables the timer. The smallest permitted value can be queried with the function block [FB\_DALI301QueryDoubleTimerMin](ms-xhelp:///?Id=beckhoff-2444-413e-bb41-63bab45ab3a5).

|  |  |
| --- | --- |
| 35460209 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 50706425 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bBusy:** The output is set as soon as execution of the DALI commands has started. It remains active until all DALI commands have been processed.

**nDouble:** Value of the variable *tDouble* [20 ms]. The maximum output value is 100, as a multiple of the step size of 20 ms.
