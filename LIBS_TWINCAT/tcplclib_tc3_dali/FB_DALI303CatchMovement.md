...
6. FB\_DALI303CatchMovement

# FB\_DALI303CatchMovement

![27262282](/tcplclib_tc3_dali/1033/Images/gif/9007205111948683__Web.gif)

*Catching* is activated for the DALI control devices by this function block. If the DALI control device detects motion, an event is sent once and the *Catching* is reset.  
The [Event Filter](ms-xhelp:///?Id=beckhoff-fa49-4c91-9b22-8d7a079a1aca) should be set so that the *Movement* event is disabled. This ensures that the event is only sent once as soon as *Catching* is active and movement is detected.

|  |  |
| --- | --- |
| 44033946 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 60761195 | The command priorities are supported by the KL6821 from the firmware version BD. |
