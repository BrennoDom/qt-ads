# FB_DALI253QueryLightSourceTemperature
...
6. FB\_DALI253QueryLightSourceTemperature

# FB\_DALI253QueryLightSourceTemperature

![8914235](/tcplclib_tc3_dali/1033/Images/gif/8371602827__Web.gif)

The function block indicates the temperature of the light source.
...
|  |  |
| --- | --- |
| 13119252 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nLightSourceTemperature:** Temperature of the light source [°C] (-60…193).
