# FB_DALI253QueryControlGearTemperature
...
6. FB\_DALI253QueryControlGearTemperature

# FB\_DALI253QueryControlGearTemperature

![23967101](/tcplclib_tc3_dali/1033/Images/gif/8371411979__Web.gif)

The function block outputs the internal temperature of the DALI control gear.
...
|  |  |
| --- | --- |
| 14377323 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nControlGearTemperature:** Internal temperature [°C] (-60…193).
