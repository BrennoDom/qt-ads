# FB_DALI253QueryLightSourceCurrent
...
6. FB\_DALI253QueryLightSourceCurrent

# FB\_DALI253QueryLightSourceCurrent

![49840382](/tcplclib_tc3_dali/1033/Images/gif/8371493643__Web.gif)

The function block reads the current consumption of the light source.
...
|  |  |
| --- | --- |
| 45910260 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**fLightSourceCurrent:** Current consumption [A] (0.0…65.533).
