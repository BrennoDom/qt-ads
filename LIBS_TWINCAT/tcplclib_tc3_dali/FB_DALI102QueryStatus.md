...
7. FB\_DALI102QueryStatus

# FB\_DALI102QueryStatus

![37228582](/tcplclib_tc3_dali/1033/Images/gif/9007205101968779__Web.gif)

The function block reads the status of the DALI control gear.

The status contains the eight most important status messages of a DALI control gear. The meaning of the bits is defined as follows:

| Bit | Description |
| --- | --- |
| 0 | Status of the DALI control gear (see [controlGearFailure](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
| 1 | Lamp failure (see [lampFailure](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
| 2 | Lamp power ON (see [lampOn](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
| 3 | Limit value error (see [limitError](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
| 4 | Dimming is active (see [fadeRunning](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
| 5 | Reset state (see [resetState](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
| 6 | Short address missing (variable [shortAddress](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) is 255 (MASK)) |
| 7 | The power supply was enabled (see [powerCycleSeen](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7)) |
...
|  |  |
| --- | --- |
| 66621782 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
