# FB_DALI103EnablePowerCycleNotification
...
7. FB\_DALI103EnablePowerCycleNotification

# FB\_DALI103EnablePowerCycleNotification

![38520254](/tcplclib_tc3_dali/1033/Images/gif/9007205112214667__Web.gif)

The function block releases the event *Power Cycle Notification*.

The function block [FB\_DALI103DisablePowerCycleNotification](ms-xhelp:///?Id=beckhoff-b15a-4591-8bdb-618009d02697) can be used to lock the event.

|  |  |
| --- | --- |
| 11137969 | The function block sends the DALI command ENABLE POWER CYCLE NOTIFICATION twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 33132859 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 29760277 | The command priorities are supported by the KL6821 from the firmware version BD. |
