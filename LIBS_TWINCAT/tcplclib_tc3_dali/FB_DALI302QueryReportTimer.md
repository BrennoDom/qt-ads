...
6. FB\_DALI302QueryReportTimer

# FB\_DALI302QueryReportTimer

![52475719](/tcplclib_tc3_dali/1033/Images/gif/7746860043__Web.gif)

The function block reads the variable [tReport](ms-xhelp:///?Id=beckhoff-8cb2-4476-8117-2b8f842ee86e).

The value is read in steps of 1 s. The permissible value range is 0 s to 4 min 15 s. It is output in numbers from 0 to 255.

|  |  |
| --- | --- |
| 2519427 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 22674843 | The command priorities are supported by the KL6821 from the firmware version BD. |
