# FB_DALI_Steinel_ControlProSingleUS
...
6. FB\_DALI\_Steinel\_ControlProSingleUS

# FB\_DALI\_Steinel\_ControlProSingleUS

![61102986](/tcplclib_tc3_dali/1033/Images/gif/18014406249289227__Web.gif)

The function block represents the DALI ControlPro Single US DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 13055966 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 50394838 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 50900362 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
