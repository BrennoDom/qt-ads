# FB_DALI208QueryUpSwitchOnThreshold
...
7. FB\_DALI208QueryUpSwitchOnThreshold

# FB\_DALI208QueryUpSwitchOnThreshold

![57250251](/tcplclib_tc3_dali/1033/Images/gif/10380408459__Web.gif)

This function block reads the variable [upSwitchOnThreshold](ms-xhelp:///?Id=beckhoff-c35d-4ca0-9bd6-597c2a99a83f) from the DALI control gear.
...
|  |  |
| --- | --- |
| 45490212 | Prior to the DALI command QUERY UP SWITCH-ON, the function block sends the DALI command ENABLE DEVICE TYPE 7, as is necessary for application extended commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 6758730 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nSwitchOnThreshold:** Threshold value (1…255) for switching on with a rising virtual output value.
