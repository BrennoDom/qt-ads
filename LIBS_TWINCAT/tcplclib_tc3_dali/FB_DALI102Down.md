...
![28727808](/tcplclib_tc3_dali/1033/Images/gif/9007205111198219__Web.gif)

The output value of the DALI control gear is reduced over the specified period of 200 ms.
...
If the current output value is already at the [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) value, the output value remains unchanged.

This command does not switch off the DALI control gear.
...
|  |  |
| --- | --- |
| 57223682 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
