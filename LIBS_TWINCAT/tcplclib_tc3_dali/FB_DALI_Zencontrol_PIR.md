...
6. FB\_DALI\_Zencontrol\_PIR

# FB\_DALI\_Zencontrol\_PIR

![34736162](/tcplclib_tc3_dali/1033/Images/png/10743624459__Web.png)

The function block represents the PIR DALI-2 sensor from Zencontrol.
...
|  |  |
| --- | --- |
| 44190002 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 62165703 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 22620416 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
