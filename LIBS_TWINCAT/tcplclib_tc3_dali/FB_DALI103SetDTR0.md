...
7. FB\_DALI103SetDTR0

# FB\_DALI103SetDTR0

![18068697](/tcplclib_tc3_dali/1033/Images/gif/9007205112042635__Web.gif)

The function block writes to the [DTR0](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) (Data Transfer Register 0) of all DALI control devices.

|  |  |
| --- | --- |
| 28400552 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 54278376 | The command priorities are supported by the KL6821 from the firmware version BD. |
