...
6. FB\_DALI252QueryApparentPower

# FB\_DALI252QueryApparentPower

![61559149](/tcplclib_tc3_dali/1033/Images/gif/8370676619__Web.gif)

The function block reads the apparent power from the DALI control gear.

It is calculated as follows:

![17161430](/tcplclib_tc3_dali/1033/Images/png/9007207691610891__Web.png)
...
|  |  |
| --- | --- |
| 20235143 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                          : BOOL;  
nApparenPower                  : UDINT;  
nScaleFactorForApparentPower   : SINT;
```
...
**nApparentPower:** Apparent power [VA] (0…4294967293).

**nScaleFactorForApparentPower:** Scaling factor for the apparent power (-6...6).
