...
7. FB\_DALI103IdentifyDevice

# FB\_DALI103IdentifyDevice

![66515904](/tcplclib_tc3_dali/1033/Images/gif/9007205112211723__Web.gif)

The function block starts the identification routine for a DALI control device.

The routine takes approx. 10 s and ends automatically. The exact timing of the identification routine depends on the manufacturer of the control device.

|  |  |
| --- | --- |
| 61772230 | The function block sends the DALI command IDENTIFY DEVICE twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 19079158 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 37494699 | The command priorities are supported by the KL6821 from the firmware version BD. |
