...
6. FB\_DALI304QueryHysteresis

# FB\_DALI304QueryHysteresis

![10808059](/tcplclib_tc3_dali/1033/Images/gif/9007205111868043__Web.gif)

The function block reads the variable [hysteresis](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb).

The value is stated in %. The permissible value range is between 0% and 25%.

|  |  |
| --- | --- |
| 30163672 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 3037596 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nHysteresis:** Value of the variable *hysteresis* in %.
