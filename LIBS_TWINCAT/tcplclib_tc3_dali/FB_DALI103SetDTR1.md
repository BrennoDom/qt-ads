...
7. FB\_DALI103SetDTR1

# FB\_DALI103SetDTR1

![18743339](/tcplclib_tc3_dali/1033/Images/gif/9007205112039691__Web.gif)

The function block writes to [DTR1](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) (Data Transfer Register 1) of all DALI control devices.

|  |  |
| --- | --- |
| 34472331 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 41815528 | The command priorities are supported by the KL6821 from the firmware version BD. |
