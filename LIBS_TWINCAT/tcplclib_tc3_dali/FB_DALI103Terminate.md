...
7. FB\_DALI103Terminate

# FB\_DALI103Terminate

![1408093](/tcplclib_tc3_dali/1033/Images/gif/9007205112018059__Web.gif)

The function block terminates addressing in all DALI control devices. The selection of the devices to be addressed by the function block [FB\_DALI103Initialise](ms-xhelp:///?Id=beckhoff-ee71-48f0-a3d9-b1176d6782a5) is also canceled.
...
|  |  |
| --- | --- |
| 12672845 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 46946741 | The command priorities are supported by the KL6821 from the firmware version BD. |
