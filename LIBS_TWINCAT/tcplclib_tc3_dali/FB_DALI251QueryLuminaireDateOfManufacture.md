# FB_DALI251QueryLuminaireDateOfManufacture
...
6. FB\_DALI251QueryLuminaireDateOfManufacture

# FB\_DALI251QueryLuminaireDateOfManufacture

![27427975](/tcplclib_tc3_dali/1033/Images/gif/8367710091__Web.gif)

The function block reads the year and week of production from the DALI control gear.
...
|  |  |
| --- | --- |
| 45525183 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nYear:** Year of production (2000…2099).

**nWeek:** Week of production (1…53).
