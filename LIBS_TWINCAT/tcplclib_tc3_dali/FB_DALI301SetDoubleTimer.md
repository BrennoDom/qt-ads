...
6. FB\_DALI301SetDoubleTimer

# FB\_DALI301SetDoubleTimer

![8146160](/tcplclib_tc3_dali/1033/Images/gif/9007205112012171__Web.gif)

The function block stores the value of *nDouble* in the variable [tDouble](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b) of the DALI control device.

The value is written in steps of 20 ms. The maximum permissible value is 2000 ms, or 100. The value 0 disables the timer. The smallest permitted value can be queried with the function block [FB\_DALI301QueryDoubleTimerMin](ms-xhelp:///?Id=beckhoff-2444-413e-bb41-63bab45ab3a5).

|  |  |
| --- | --- |
| 6206582 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 55859239 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nDouble:** Value of the variable *tDouble* [20 ms]. The maximum input value is 100, as a multiple of the step size of 20 ms.
