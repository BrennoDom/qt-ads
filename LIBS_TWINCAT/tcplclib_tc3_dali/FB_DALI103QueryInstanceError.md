...
7. FB\_DALI103QueryInstanceError

# FB\_DALI103QueryInstanceError

![53428882](/tcplclib_tc3_dali/1033/Images/gif/9007205112113419__Web.gif)

The function block reads more detailed error information for the selected instance from the DALI control device (see [instanceError](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)).

The meaning of the values depends on the selected instance type.

|  |  |
| --- | --- |
| 11097898 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 32772220 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nInstanceError:** Error information for the selected instance.
