...
7. FB\_DALI103QueryEventPriority

# FB\_DALI103QueryEventPriority

![3709091](/tcplclib_tc3_dali/1033/Images/gif/9007206002265355__Web.gif)

This function block reads the event priority (see [eventPriority](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)) for the selected instance of the DALI control device.
...
|  |  |
| --- | --- |
| 33381819 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 32000920 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                : BOOL;  
eEventPriority       : E_DALIEventPriority;
```
...
**eEventPriority:** Returns the priority (low, middle low, middle, middle high) with which the *Input Notification Events* are sent from the instance of the DALI control device.
