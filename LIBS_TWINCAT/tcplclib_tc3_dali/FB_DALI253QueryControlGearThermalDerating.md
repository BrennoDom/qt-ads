# FB_DALI253QueryControlGearThermalDerating
...
6. FB\_DALI253QueryControlGearThermalDerating

# FB\_DALI253QueryControlGearThermalDerating

![62287048](/tcplclib_tc3_dali/1033/Images/gif/8371427723__Web.gif)

The function block indicates whether the internal temperature is higher than the specified limit value in the DALI control gear.
...
|  |  |
| --- | --- |
| 23712525 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
bControlGearThermalDerating                 : BOOL;
```
...
**bControlGearThermalDerating:** The output is set as soon as the internally measured temperature of the DALI control gear is higher than the specified limit value.
