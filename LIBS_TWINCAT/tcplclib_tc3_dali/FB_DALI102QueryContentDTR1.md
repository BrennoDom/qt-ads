...
7. FB\_DALI102QueryContentDTR1

# FB\_DALI102QueryContentDTR1

![31282356](/tcplclib_tc3_dali/1033/Images/gif/9007205102071051__Web.gif)

The function block reads the content of [DTR1](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) (Data Transfer Register 1) from the DALI control gear.
...
|  |  |
| --- | --- |
| 13105749 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nContentDTR1:** Content of the DTR1 (Data Transfer Register 1) (0…255).
