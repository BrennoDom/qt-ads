...
7. FB\_DALI103QueryDeviceStatus

# FB\_DALI103QueryDeviceStatus

![42015198](/tcplclib_tc3_dali/1033/Images/gif/9007205112143883__Web.gif)

The function block reads the status of the DALI control device.

The following status information is provided at output *nDeviceStatus*.

| Bit | Description |
| --- | --- |
| 0 | Status of the DALI control device (see [inputDeviceError](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)) |
| 1 | Quiescent mode (see [quiescentMode](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)) |
| 2 | Short address missing (variable [shortAddress](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) is 255 (MASK)) |
| 3 | Application controller active (see [applicationActive](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)) |
| 4 | Application controller error (see [applicationControllerError](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)) |
| 5 | The power supply was enabled (see [powerCycleSeen](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)) |
| 6 | Reset state (see [resetState](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)) |
| 7 | Unused (default value is 0) |

|  |  |
| --- | --- |
| 42592467 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 47787886 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nDeviceStatus:** Output value of the Device Status, see table above.
