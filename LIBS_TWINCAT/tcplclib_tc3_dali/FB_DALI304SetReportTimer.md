...
6. FB\_DALI304SetReportTimer

# FB\_DALI304SetReportTimer

![31430389](/tcplclib_tc3_dali/1033/Images/gif/9007205111709579__Web.gif)

The function block stores the value of *nReport* in the variable [tReport](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb) of the DALI control device.
...
|  |  |
| --- | --- |
| 14438051 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 62833603 | The command priorities are supported by the KL6821 from the firmware version BD. |
