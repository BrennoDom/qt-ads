# FB_DALI251QueryNominalInputPower
...
6. FB\_DALI251QueryNominalInputPower

# FB\_DALI251QueryNominalInputPower

![36079911](/tcplclib_tc3_dali/1033/Images/gif/8368138379__Web.gif)

The function block reads the nominal input power of the luminaire from the DALI control gear.
...
|  |  |
| --- | --- |
| 56283746 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nNominalInputPower:** Nominal power [W] (0…65534).
