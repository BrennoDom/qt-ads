...
7. FB\_DALI103QueryInstanceType

# FB\_DALI103QueryInstanceType

![1740610](/tcplclib_tc3_dali/1033/Images/gif/18014404366835723__Web.gif)

The function block reads the instance type (see [instanceType](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)) for the selected instance from the DALI control device.

|  |  |
| --- | --- |
| 15665491 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 6771693 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                : BOOL;  
eInstanceType        : E_DALIInstanceType;
```
...
**eInstanceType:** Output of the instance type (see [instanceType](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)).
