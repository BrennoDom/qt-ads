# FB_DALI253QueryControlGearOverallFailureCondition
...
6. FB\_DALI253QueryControlGearOverallFailureCondition

# FB\_DALI253QueryControlGearOverallFailureCondition

![32424647](/tcplclib_tc3_dali/1033/Images/gif/8371400203__Web.gif)

The function block outputs the status of [controlGearFailure](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) at the DALI control gear.
...
|  |  |
| --- | --- |
| 23386368 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                  : BOOL;  
bControlGearOverallFailureCondition    : BOOL;
```
...
**bControlGearOverallFailureCondition:** The output is set as soon as an error has been detected in the DALI control gear.
