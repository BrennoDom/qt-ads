...
7. FB\_DALI103SetOperatingMode

# FB\_DALI103SetOperatingMode

![38378011](/tcplclib_tc3_dali/1033/Images/gif/9007205111970315__Web.gif)

The function block sets the operating mode of the DALI control device (see [operatingMode](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)).

|  |  |
| --- | --- |
| 9857780 | The function block changes the DTR0 of all connected DALI control devices. |

|  |  |
| --- | --- |
| 21611161 | The function block sends the DALI command SET OPERATING MODE twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 60282721 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 5673583 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nOperatingMode:** Operating mode entry.
