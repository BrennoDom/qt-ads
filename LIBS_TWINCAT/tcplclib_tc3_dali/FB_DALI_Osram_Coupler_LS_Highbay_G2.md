# FB_DALI_Osram_Coupler_LS_Highbay_G2
...
5. [Osram](ms-xhelp:///?Id=beckhoff-29cb-4eda-adbd-6a699698c409)
6. FB\_DALI\_Osram\_Coupler\_LS\_Highbay\_G2

# FB\_DALI\_Osram\_Coupler\_LS\_Highbay\_G2

![24927872](/tcplclib_tc3_dali/1033/Images/gif/9007209615793675__Web.gif)

The function block represents the DALI COUPLER LS HIGHBAY G2 DALI sensor from Osram.

This outputs the measured brightness value (instance 1) and an occupancy signal (instance 0).
...
|  |  |
| --- | --- |
| 23024263 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 5891777 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 53026001 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
