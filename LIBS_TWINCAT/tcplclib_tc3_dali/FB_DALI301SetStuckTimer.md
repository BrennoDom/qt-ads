...
6. FB\_DALI301SetStuckTimer

# FB\_DALI301SetStuckTimer

![8495130](/tcplclib_tc3_dali/1033/Images/gif/9007205112003339__Web.gif)

The function block stores the value of *nStuck* in the variable [tStuck](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b) of the DALI control device.

The value is read in steps of 1 s. The permissible value range is 5 s to 255 s.

|  |  |
| --- | --- |
| 9347313 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 17016957 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nStuck:** Value of the variable *tStuck* [s] (5…255 s).
