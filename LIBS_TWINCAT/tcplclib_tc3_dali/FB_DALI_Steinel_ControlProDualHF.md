# FB_DALI_Steinel_ControlProDualHF
...
6. FB\_DALI\_Steinel\_ControlProDualHF

# FB\_DALI\_Steinel\_ControlProDualHF

![73053](/tcplclib_tc3_dali/1033/Images/png/18014406248688651__Web.png)

The function block represents the ControlPro Dual HF DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 657479 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 5917317 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 53255854 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
