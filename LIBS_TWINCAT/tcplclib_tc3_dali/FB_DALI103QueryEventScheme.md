...
7. FB\_DALI103QueryEventScheme

# FB\_DALI103QueryEventScheme

![19572825](/tcplclib_tc3_dali/1033/Images/gif/9007205112137995__Web.gif)

The function block reads the event scheme (see [eventScheme](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)) for the events of the selected DALI control device instance.

|  |  |
| --- | --- |
| 41937705 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 41895032 | The command priorities are supported by the KL6821 from the firmware version BD. |
