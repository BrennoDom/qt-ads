...
6. FB\_DALI301QueryShortTimerMin

# FB\_DALI301QueryShortTimerMin

![19737894](/tcplclib_tc3_dali/1033/Images/gif/9007205111976203__Web.gif)

The function block reads the variable [tShortMin](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b).

The value is read in steps of 20 ms.

|  |  |
| --- | --- |
| 43423319 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 55265559 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nShortMin:** Value of the variable *tShortMin* [20 ms].
