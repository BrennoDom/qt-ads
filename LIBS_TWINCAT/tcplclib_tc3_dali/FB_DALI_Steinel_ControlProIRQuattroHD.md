# FB_DALI_Steinel_ControlProIRQuattroHD
...
6. FB\_DALI\_Steinel\_ControlProIRQuattroHD

# FB\_DALI\_Steinel\_ControlProIRQuattroHD

![12794876](/tcplclib_tc3_dali/1033/Images/png/18014406249286283__Web.png)

The function block represents the ControlPro IR Quattro HD DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 48045022 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 29752015 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 66441544 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
