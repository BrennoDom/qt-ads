# FB_DALI252QueryActiveEnergyLoadside
...
6. FB\_DALI252QueryActiveEnergyLoadside

# FB\_DALI252QueryActiveEnergyLoadside

![36279478](/tcplclib_tc3_dali/1033/Images/gif/8370664843__Web.gif)

The function block reads the load-side active energy from the DALI control gear.

It is calculated as follows:

![58079852](/tcplclib_tc3_dali/1033/Images/png/9007207691133963__Web.png)
...
|  |  |
| --- | --- |
| 52956621 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
nScaleFactorForLoadsideEnergy  : SINT;
```
...
**nActiveEnergyLoadside:** Load-side active energy [Wh] (0…281474976710653).

**nScaleFactorForLoadsideEnergy:** Scaling factor for the load-side active energy (-6...6).
