...
7. FB\_DALI102SetPowerOnLevel

# FB\_DALI102SetPowerOnLevel

![7693179](/tcplclib_tc3_dali/1033/Images/gif/9007205111228683__Web.gif)

The function block stores the value *nPowerOnLevel* in the variable [powerOnLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) of the DALI control gear.

|  |  |
| --- | --- |
| 2129750 | The function block changes the DTR0 of all connected DALI control gears. |

|  |  |
| --- | --- |
| 19167756 | The function block sends the DALI command SET POWER ON LEVEL twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 38292076 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
