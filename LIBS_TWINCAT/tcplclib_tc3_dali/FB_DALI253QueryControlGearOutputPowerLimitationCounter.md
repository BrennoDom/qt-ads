# FB_DALI253QueryControlGearOutputPowerLimitationCounter
...
6. FB\_DALI253QueryControlGearOutputPowerLimitationCounter

# FB\_DALI253QueryControlGearOutputPowerLimitationCounter

![11170862](/tcplclib_tc3_dali/1033/Images/gif/8371384459__Web.gif)

The function block reads the counter of the number of exceedances of the output power limit value at the DALI control gear.
...
|  |  |
| --- | --- |
| 33428900 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                     : BOOL;  
nControlGearOutputPowerLimitationCounter  : BYTE;
```
...
**nControlGearOutputPowerLimitationCounter:** Number of times the output power was exceeded (0…253).
