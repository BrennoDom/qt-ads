# FB_DALI253QueryControlGearThermalShutdown
...
6. FB\_DALI253QueryControlGearThermalShutdown

# FB\_DALI253QueryControlGearThermalShutdown

![39453247](/tcplclib_tc3_dali/1033/Images/gif/8371433611__Web.gif)

The function block indicates whether there is a thermal shutdown of the DALI control gear.
...
|  |  |
| --- | --- |
| 19534911 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
bControlGearThermalShutdown                 : BOOL;
```
...
**bControlGearThermalShutdown:** The output is set as soon as the condition for a thermal shutdown of the DALI control gear is satisfied.
