...
7. FB\_DALI103SetDTR2

# FB\_DALI103SetDTR2

![10645546](/tcplclib_tc3_dali/1033/Images/gif/9007205112036747__Web.gif)

The function block writes to [DTR2](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) (Data Transfer Register 2) of all DALI control devices.

|  |  |
| --- | --- |
| 28701056 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 56982912 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nDTR2:** Value to be written to the DTR2 (Data Transfer Register 2) (0…255).
