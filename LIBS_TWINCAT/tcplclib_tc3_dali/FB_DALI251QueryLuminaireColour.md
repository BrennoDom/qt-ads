# FB_DALI251QueryLuminaireColour
...
6. FB\_DALI251QueryLuminaireColour

# FB\_DALI251QueryLuminaireColour

![45077859](/tcplclib_tc3_dali/1033/Images/gif/8367707147__Web.gif)

The function block reads the luminaire color from the DALI control gear.
...
|  |  |
| --- | --- |
| 3047552 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**sLuminaireColour:** Outputs the luminaire color.
