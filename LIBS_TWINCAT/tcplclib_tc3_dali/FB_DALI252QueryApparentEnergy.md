...
6. FB\_DALI252QueryApparentEnergy

# FB\_DALI252QueryApparentEnergy

![22822288](/tcplclib_tc3_dali/1033/Images/gif/8370673675__Web.gif)

The function block reads the apparent energy from the DALI control gear.

It is calculated as follows:

![4074007](/tcplclib_tc3_dali/1033/Images/png/9007207691607051__Web.png)
...
|  |  |
| --- | --- |
| 36666067 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                          : BOOL;  
nApparentEnergy                : ULINT;  
nScaleFactorForApparentEnergy  : SINT;
```
...
**nApparentEnergy:** Apparent energy [VAh] (0…281474976710653).

**nScaleFactorForApparentEnergy:** Scaling factor for the apparent energy (-6...6).
