...
6. FB\_DALI304QueryReportTimer

# FB\_DALI304QueryReportTimer

![65447007](/tcplclib_tc3_dali/1033/Images/gif/9007205111721355__Web.gif)

The function block reads the variable [tReport](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb).

The value is read in steps of 1 s. The permissible value range is 0 s to 4 min 15 s. It is output in numbers from 0 to 255.

|  |  |
| --- | --- |
| 52152158 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 66716242 | The command priorities are supported by the KL6821 from the firmware version BD. |
