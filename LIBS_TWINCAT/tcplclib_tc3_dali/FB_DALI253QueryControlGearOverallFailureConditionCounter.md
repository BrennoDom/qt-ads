# FB_DALI253QueryControlGearOverallFailureConditionCounter
...
6. FB\_DALI253QueryControlGearOverallFailureConditionCounter

# FB\_DALI253QueryControlGearOverallFailureConditionCounter

![9150720](/tcplclib_tc3_dali/1033/Images/gif/8371403147__Web.gif)

The function block reads the counter of the error events that have occurred in the DALI control gear.
...
|  |  |
| --- | --- |
| 15247616 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nControlGearOverallFailureConditionCounter  : BYTE;
```
...
**nControlGearOverallFailureConditionCounter:** Number of errors detected (0...253).
