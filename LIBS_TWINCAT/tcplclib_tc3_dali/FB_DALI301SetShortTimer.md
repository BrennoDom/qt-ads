...
6. FB\_DALI301SetShortTimer

# FB\_DALI301SetShortTimer

![10966323](/tcplclib_tc3_dali/1033/Images/gif/9007205112006283__Web.gif)

The function block stores the value of *nShort* in the variable [tShort](ms-xhelp:///?Id=beckhoff-9595-416c-b047-7ae6bd54300b) of the DALI control device.

The value is written in steps of 20 ms. The maximum permissible value is 5100 ms, or 255. The smallest permitted value can be queried with the function block [FB\_DALI301QueryShortTimerMin](ms-xhelp:///?Id=beckhoff-c1cc-4d2b-b7c2-bcb79e858e09).

|  |  |
| --- | --- |
| 31588048 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 15856984 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nShort:** Value of the variable *tShort* [20 ms]. The maximum input value is 255, as a multiple of the step size of 20 ms.
