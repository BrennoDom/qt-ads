# FB_DALI253QueryLightSourceThermalShutdown
...
6. FB\_DALI253QueryLightSourceThermalShutdown

# FB\_DALI253QueryLightSourceThermalShutdown

![41110918](/tcplclib_tc3_dali/1033/Images/gif/8371624459__Web.gif)

The function block indicates whether there is a thermal shutdown on the DALI control gear due to the light source.
...
|  |  |
| --- | --- |
| 34453949 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
bLightSourceThermalShutdown                 : BOOL;
```
...
**bLightSourceThermalShutdown:** The output is set as soon as the condition for a thermal shutdown of the light source is satisfied.
