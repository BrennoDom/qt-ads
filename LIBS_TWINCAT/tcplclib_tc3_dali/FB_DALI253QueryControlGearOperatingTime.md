# FB_DALI253QueryControlGearOperatingTime
...
6. FB\_DALI253QueryControlGearOperatingTime

# FB\_DALI253QueryControlGearOperatingTime

![22422552](/tcplclib_tc3_dali/1033/Images/gif/8371375627__Web.gif)

The function block reads the operating time of the DALI control gear.
...
|  |  |
| --- | --- |
| 476380 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                  : BOOL;  
nControlGearOperatingTime              : UDINT;
```
...
**nControlGearOperatingTime:** Operating time [s] (0…4294967293).
