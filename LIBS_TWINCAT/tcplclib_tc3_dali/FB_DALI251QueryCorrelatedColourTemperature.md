# FB_DALI251QueryCorrelatedColourTemperature
...
5. [Part 251 (memory bank 1 extension)](ms-xhelp:///?Id=beckhoff-0e0e-4506-aa25-108888e286e2)
6. FB\_DALI251QueryCorrelatedColourTemperature

# FB\_DALI251QueryCorrelatedColourTemperature

![7184552](/tcplclib_tc3_dali/1033/Images/gif/8367704203__Web.gif)

The function block reads the correlated color temperature from the DALI control gear.
...
|  |  |
| --- | --- |
| 64660974 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                         : BOOL;  
nCorrelatedColourTemperature  : UINT;
```
...
**nCorrelatedColourTemperature:** Outputs the correlated color temperature [K] (0…17000). If the value 16#FFFE is returned, then Part 209 is not implemented in the DALI control gear.
