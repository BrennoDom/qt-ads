...
7. FB\_DALI102QueryDeviceTypes

# FB\_DALI102QueryDeviceTypes

![49062032](/tcplclib_tc3_dali/1033/Images/gif/18014404356777611__Web.gif)
...
|  |  |
| --- | --- |
| 38905106 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**aDeviceTypes:** List of supported device types (see [E\_DALIDeviceType](ms-xhelp:///?Id=beckhoff-1044-42a7-9d1e-50f3758e68ec) ).
