# FB_DALI103QueryInstanceEnabled
...
7. FB\_DALI103QueryInstanceEnabled

# FB\_DALI103QueryInstanceEnabled

![4860205](/tcplclib_tc3_dali/1033/Images/gif/9007205112116363__Web.gif)

The function block queries whether the specified instance of the DALI control device is active (see [instanceActive](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)).
...
|  |  |
| --- | --- |
| 43741849 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 58132325 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bInstanceEnabled:** Is TRUE if the instance is active.
