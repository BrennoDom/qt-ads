# FB_DALI_Tridonic_MSensorG3_SRC_30_PIR
...
6. FB\_DALI\_Tridonic\_MSensorG3\_SRC\_30\_PIR

# FB\_DALI\_Tridonic\_MSensorG3\_SRC\_30\_PIR

![64586077](/tcplclib_tc3_dali/1033/Images/gif/9007208249366411__Web.gif)

The function block represents the MSensor G3 SRC 30 PIR 5DPI DALI sensor from Tridonic.
...
|  |  |
| --- | --- |
| 44403789 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 64089786 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 39937165 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
