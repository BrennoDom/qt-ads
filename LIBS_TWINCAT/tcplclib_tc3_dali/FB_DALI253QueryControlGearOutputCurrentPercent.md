# FB_DALI253QueryControlGearOutputCurrentPercent
...
6. FB\_DALI253QueryControlGearOutputCurrentPercent

# FB\_DALI253QueryControlGearOutputCurrentPercent

![4287423](/tcplclib_tc3_dali/1033/Images/gif/8371378571__Web.gif)

The function block reads the output current as a percentage of the nominal current from the DALI control gear.
...
|  |  |
| --- | --- |
| 38586810 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                  : BOOL;  
nControlGearOutputCurrentPercent       : BYTE;
```
...
**nControlGearOutputCurrentPercent:** Percentage output current [%] (0…100).
