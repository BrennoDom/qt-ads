...
6. FB\_DALI304SetHysteresisMin

# FB\_DALI304SetHysteresisMin

![9616944](/tcplclib_tc3_dali/1033/Images/gif/9007205111712523__Web.gif)

The function block stores the value *nHysteresisMin* in the variable [hysteresisMin](ms-xhelp:///?Id=beckhoff-4f3d-4c54-9dd6-56c589a843bb) of the DALI control device.
...
|  |  |
| --- | --- |
| 19443632 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 40774967 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nHysteresisMin:** Value of the smallest possible hysteresis *hysteresisMin*.
