# FB_DALI253QueryControlGearExternalSupplyUndervoltage
...
6. FB\_DALI253QueryControlGearExternalSupplyUndervoltage

# FB\_DALI253QueryControlGearExternalSupplyUndervoltage

![58761073](/tcplclib_tc3_dali/1033/Images/gif/8371363851__Web.gif)

The function block indicates whether an undervoltage has been detected in the external supply voltage of the DALI control gear.
...
|  |  |
| --- | --- |
| 59087616 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                   : BOOL;  
bControlGearExternalSupplyUndervoltage  : BOOL;
```
...
**bControlGearExternalSupplyUndervoltage:** The output is set as soon as an undervoltage has been detected in the external supply voltage of the DALI control gear.
