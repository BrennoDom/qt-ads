...
7. FB\_DALI102QueryContentDTR2

# FB\_DALI102QueryContentDTR2

![50842877](/tcplclib_tc3_dali/1033/Images/gif/9007205102068107__Web.gif)

The function block reads the content of [DTR2](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) (Data Transfer Register 2) from the DALI control gear.
...
|  |  |
| --- | --- |
| 54932709 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nContentDTR2:** Content of the DTR2 (Data Transfer Register 2) (0…255).
