...
![60779388](/tcplclib_tc3_dali/1033/Images/gif/9007205111422603__Web.gif)

The function block resets all variables of the DALI control gear to their default values.

Control gears can take up to 300 ms to execute the DALI command. Only then are further DALI commands executed by the respective DALI control gear.

|  |  |
| --- | --- |
| 10143581 | The function block sends the DALI command RESET twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 24183370 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
