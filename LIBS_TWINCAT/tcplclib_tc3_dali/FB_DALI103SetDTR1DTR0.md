...
7. FB\_DALI103SetDTR1DTR0

# FB\_DALI103SetDTR1DTR0

![40795435](/tcplclib_tc3_dali/1033/Images/gif/6523008523__Web.gif)

The function block writes the DTR0 (Data Transfer Register 0) and the DTR1 (Data Transfer Register 1) of all DALI control devices.

|  |  |
| --- | --- |
| 31614597 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 16095919 | The command priorities are supported by the KL6821 from the firmware version BD. |

**nDTR0:** Value to be written to the DTR0 (Data Transfer Register 0) (0…255).
