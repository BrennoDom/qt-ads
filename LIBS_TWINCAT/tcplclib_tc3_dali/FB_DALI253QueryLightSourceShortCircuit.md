# FB_DALI253QueryLightSourceShortCircuit
...
6. FB\_DALI253QueryLightSourceShortCircuit

# FB\_DALI253QueryLightSourceShortCircuit

![9132882](/tcplclib_tc3_dali/1033/Images/gif/8371527051__Web.gif)

The function block indicates whether there is a short-circuit at the light source.
...
|  |  |
| --- | --- |
| 15087078 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
bLightSourceShortCircuit                    : UDINT;
```
...
**bLightSourceShortCircuit:** The output is set as soon as a short circuit is detected at the light source.
