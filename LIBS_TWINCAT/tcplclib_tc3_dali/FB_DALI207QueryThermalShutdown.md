# FB_DALI207QueryThermalShutdown
...
7. FB\_DALI207QueryThermalShutdown

# FB\_DALI207QueryThermalShutdown

![32117087](/tcplclib_tc3_dali/1033/Images/gif/9007205692842123__Web.gif)

The function block queries whether a thermal shutdown has taken place.

|  |  |
| --- | --- |
| 20618333 | Prior to the DALI command QUERY THERMAL SHUTDOWN, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application-related expansion commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 51347269 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bThermalShutdown:** Indicates whether a thermal shutdown has taken place.
