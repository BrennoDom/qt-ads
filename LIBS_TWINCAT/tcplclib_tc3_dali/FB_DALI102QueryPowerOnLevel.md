...
7. FB\_DALI102QueryPowerOnLevel

# FB\_DALI102QueryPowerOnLevel

![50584809](/tcplclib_tc3_dali/1033/Images/gif/9007205101977611__Web.gif)

The function block reads the variable [powerOnLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) from the DALI control gear.
...
|  |  |
| --- | --- |
| 52610097 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
