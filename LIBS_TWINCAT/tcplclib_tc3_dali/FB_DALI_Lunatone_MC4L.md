...
6. FB\_DALI\_Lunatone\_MC4L

# FB\_DALI\_Lunatone\_MC4L

![66526832](/tcplclib_tc3_dali/1033/Images/png/10738209675__Web.png)

The function block represents the MC4L DALI push-button interface from Lunatone.
...
|  |  |
| --- | --- |
| 61870584 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 19964345 | The function block cannot be used when using the KL6811. |
