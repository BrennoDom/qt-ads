...
7. FB\_DALI102QueryRandomAddress

# FB\_DALI102QueryRandomAddress

![3728830](/tcplclib_tc3_dali/1033/Images/gif/9007205101974667__Web.gif)

The function block reads the variable [randomAddress](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) from the DALI control gear.

The DALI commands QUERY RANDOM ADDRESS (H), QUERY RANDOM ADDRESS (M) and QUERY RANDOM ADDRESS (L) are called internally.
...
|  |  |
| --- | --- |
| 33559471 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nRandomAddress:** Random address (0x00 00 00…0xFF FF FE).
