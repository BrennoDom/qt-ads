...
7. FB\_DALI103QueryRandomAddress

# FB\_DALI103QueryRandomAddress

![28602718](/tcplclib_tc3_dali/1033/Images/gif/9007205112082955__Web.gif)

The function block reads the [randomAddress](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6)variable from the DALI control device.

The DALI commands QUERY RANDOM ADDRESS (H), QUERY RANDOM ADDRESS (M) and QUERY RANDOM ADDRESS (L) are called internally.

|  |  |
| --- | --- |
| 56097870 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 35118788 | The command priorities are supported by the KL6821 from the firmware version BD. |
