...
7. FB\_DALI103QueryResolution

# FB\_DALI103QueryResolution

![47633640](/tcplclib_tc3_dali/1033/Images/gif/9007205112067211__Web.gif)

The function block reads the resolution of the input value for the selected instance from the DALI control device (see [resolution](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)).

|  |  |
| --- | --- |
| 26049579 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 33119622 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nResolution:** Number of bits with which the input value is resolved.
