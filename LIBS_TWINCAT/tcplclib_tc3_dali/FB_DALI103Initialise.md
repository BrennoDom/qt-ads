...
7. FB\_DALI103Initialise

# FB\_DALI103Initialise

![61185139](/tcplclib_tc3_dali/1033/Images/gif/9007205112064267__Web.gif)
...
| --- | --- |
| 0111 1111 | DALI control devices without a short address respond. |
| 00AA AAAA | DALI control devices with the address 00AA AAAA respond. |
| 1111 1111 | All DALI control devices respond. |

|  |  |
| --- | --- |
| 13795340 | The function block sends the DALI command INITIALIZE twice, as required by the DALI standard for certain DALI commands. |

|  |  |
| --- | --- |
| 57049196 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 43680716 | The command priorities are supported by the KL6821 from the firmware version BD. |
