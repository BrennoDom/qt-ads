...
7. FB\_DALI102SetFadeTime

# FB\_DALI102SetFadeTime

![17004965](/tcplclib_tc3_dali/1033/Images/gif/18014404365978507__Web.gif)

The function block sets the [fadeTime](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) to the value *eFadeTime*.

The *fadeTime* defines the time the current output value takes to reach the required value.

The *fadeTime* is used in the function blocks [FB\_DALI102DirectArcPowerControl](ms-xhelp:///?Id=beckhoff-0c46-458d-aa43-e38363cdead0) and [FB\_DALI102GoToScene](ms-xhelp:///?Id=beckhoff-a569-4c24-b493-8153725be7b8).

|  |  |
| --- | --- |
| 18826965 | The function block changes the DTR0 of all connected DALI control gears. |

|  |  |
| --- | --- |
| 35224963 | The function block sends the DALI command SET FADE TIME twice, as required by the DALI standard for certain commands. |
...
eFadeTime         : E_DALIFadeTime := E_DALIFadeTime.Disabled;
```
...
|  |  |
| --- | --- |
| 48589216 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
