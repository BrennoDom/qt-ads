...
6. FB\_DALI303QueryDeadtimeTimer

# FB\_DALI303QueryDeadtimeTimer

![27551015](/tcplclib_tc3_dali/1033/Images/gif/9007205111942795__Web.gif)

The function block reads the variable [tDeadtime](ms-xhelp:///?Id=beckhoff-fa49-4c91-9b22-8d7a079a1aca).

The value is read in steps of 50 ms. The permissible value range is 0 s to 12.75 s. It is output in numbers from 0 to 255.

|  |  |
| --- | --- |
| 46632549 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 17039762 | The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nDeadtime:** Value of the variable *tDeadtime* [50 ms]. The output value is between 0 and 255, as a multiple of the step size of 50 ms.
