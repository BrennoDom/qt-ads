# FB_DALI_Osram_Coupler_PushB_G2
...
6. FB\_DALI\_Osram\_Coupler\_PushB\_G2

# FB\_DALI\_Osram\_Coupler\_PushB\_G2

![34108880](/tcplclib_tc3_dali/1033/Images/gif/9007209615796619__Web.gif)

The function block represents the DALI COUPLER PushB G2 DALI push button interface from Osram.
...
|  |  |
| --- | --- |
| 38544467 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 11355891 | The function block cannot be used when using the KL6811. |
