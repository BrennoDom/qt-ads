# FB_DALI253QueryLightSourceShortCircuitCounter
...
6. FB\_DALI253QueryLightSourceShortCircuitCounter

# FB\_DALI253QueryLightSourceShortCircuitCounter

![1565979](/tcplclib_tc3_dali/1033/Images/gif/8371593995__Web.gif)

The function block reads the counter that counts the number of light source short-circuits.
...
|  |  |
| --- | --- |
| 14093819 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nLightSourceShortCircuitCounter             : BYTE;
```
...
**nLightSourceShortCircuitCounter:** Number of short-circuits that have occurred (0…253).
