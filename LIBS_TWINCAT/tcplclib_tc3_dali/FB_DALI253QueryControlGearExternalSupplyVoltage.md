# FB_DALI253QueryControlGearExternalSupplyVoltage
...
6. FB\_DALI253QueryControlGearExternalSupplyVoltage

# FB\_DALI253QueryControlGearExternalSupplyVoltage

![58090788](/tcplclib_tc3_dali/1033/Images/gif/8371369739__Web.gif)

The function block reads the effective value of the external supply voltage from the DALI control gear.
...
|  |  |
| --- | --- |
| 53055045 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                  : BOOL;  
fControlGearExternalSupplyVoltage      : LREAL;
```
...
**fControlGearExternalSupplyVoltage:** RMS value of the external supply voltage [Vrms] (0.0…6553.3).
