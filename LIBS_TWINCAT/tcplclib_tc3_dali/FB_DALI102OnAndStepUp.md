...
7. FB\_DALI102OnAndStepUp

# FB\_DALI102OnAndStepUp

![2794650](/tcplclib_tc3_dali/1033/Images/gif/9007205111189387__Web.gif)

The output value of the DALI control gear is increased by one step.

If the DALI control gear is off, the command switches it on, and the output value is set to the stored value [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7).

If the output value has already reached the [maxLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) value, it retains its current value.
...
|  |  |
| --- | --- |
| 25151854 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
