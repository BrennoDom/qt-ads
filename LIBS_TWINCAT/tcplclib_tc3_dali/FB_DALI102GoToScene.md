...
7. FB\_DALI102GoToScene

# FB\_DALI102GoToScene

![45251091](/tcplclib_tc3_dali/1033/Images/gif/9007205111195275__Web.gif)

The output of the DALI control gear is set to the value stored in *nScene*.

The variable [fadeTime](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) determines the speed at which the specified value of the scene is to be reached.

If the value of the selected scene in the DALI control gear is 255, the output of the DALI control gear retains its current value.

If the DALI control gear is switched off, this command switches it on.
...
|  |  |
| --- | --- |
| 4606636 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |

**nScene:** Scene to be called in the DALI control gear (0...15).
