# FB_DALI209QueryGearFeaturesStatus
...
7. FB\_DALI209QueryGearFeaturesStatus

# FB\_DALI209QueryGearFeaturesStatus

![22746728](/tcplclib_tc3_dali/1033/Images/gif/6438185995__Web.gif)

The function block reads the variable [gearFeatures/Status](ms-xhelp:///?Id=beckhoff-996e-4deb-b831-825c7f1752f7) from the DALI control gear.

|  |  |
| --- | --- |
| 3393965 | Prior to the DALI command QUERY GEAR FEATURES/STATUS, the function block sends the DALI command ENABLE DEVICE TYPE 8, as is necessary for application extended commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 30545685 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nGearFeatureStatus:** Output of the status information (see [gearFeatures/Status](ms-xhelp:///?Id=beckhoff-996e-4deb-b831-825c7f1752f7)).
