...
6. FB\_DALI\_Osram\_Coupler\_HF\_G2

# FB\_DALI\_Osram\_Coupler\_HF\_G2

![4739572](/tcplclib_tc3_dali/1033/Images/gif/9007209615790731__Web.gif)

The function block represents the DALI COUPLER HF G2 DALI sensor from Osram.
...
|  |  |
| --- | --- |
| 42656148 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 48361012 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 32595925 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
