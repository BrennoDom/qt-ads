...
5. [Niko](ms-xhelp:///?Id=beckhoff-1595-4f00-9669-3821479d7864)
6. FB\_DALI\_Niko\_P46MR

# FB\_DALI\_Niko\_P46MR

![56677584](/tcplclib_tc3_dali/1033/Images/png/10990335883__Web.png)

The function block represents the DALI sensors P46MR for surface mounting, P46MR for SnapFit flush mounting and P46MR for flush-mounting box from Niko.
...
|  |  |
| --- | --- |
| 40336211 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 27481582 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 46007650 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
...
| nSensitivityOccupancy | BYTE | Get, Set | 1 (high) | Setting the sensitivity of the occupancy sensor instance from 0 (max), 1 (high), 2 (low) to 3 (min). |
