# FB_DALI253QueryControlGearStartCounter
...
6. FB\_DALI253QueryControlGearStartCounter

# FB\_DALI253QueryControlGearStartCounter

![42549619](/tcplclib_tc3_dali/1033/Images/gif/8371409035__Web.gif)

The function block outputs the number of starts of the DALI control gear. The value is incremented after switching on the external power supply.
...
|  |  |
| --- | --- |
| 47402253 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                                       : BOOL;  
nControlGearStartCounter                    : UDINT;
```
...
**nControlGearStartCounter:** Number of starts of the DALI control gear (0…16777213).
