...
7. FB\_DALI209QueryColourStatus

# FB\_DALI209QueryColourStatus

![48007674](/tcplclib_tc3_dali/1033/Images/gif/6438177163__Web.gif)

The function block reads the variable [colourStatus](ms-xhelp:///?Id=beckhoff-996e-4deb-b831-825c7f1752f7) from the DALI control gear.

|  |  |
| --- | --- |
| 29415884 | Prior to the DALI command QUERY COLOUR STATUS, the function block sends the DALI command ENABLE DEVICE TYPE 8, as is necessary for application-related extension commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 63416368 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nColourStatus:** Output of the status information (see [colourStatus](ms-xhelp:///?Id=beckhoff-996e-4deb-b831-825c7f1752f7)).
