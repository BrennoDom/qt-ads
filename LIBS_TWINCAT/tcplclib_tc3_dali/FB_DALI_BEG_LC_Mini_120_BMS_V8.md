# FB_DALI_BEG_LC_Mini_120_BMS_V8
...
5. [B.E.G.](ms-xhelp:///?Id=beckhoff-78fd-41f1-83c3-e4ce141459e4)
6. FB\_DALI\_BEG\_LC\_Mini\_120\_BMS\_V8

# FB\_DALI\_BEG\_LC\_Mini\_120\_BMS\_V8

![33203949](/tcplclib_tc3_dali/1033/Images/png/9007209010876043__Web.png)

The function block represents the LC-Mini 120-BMS DALI-2 DALI sensor from B.E.G..

This outputs an occupancy signal (instance 0) and a brightness value (instance 1).
...
Readout can be triggered immediately via the input variables *bQueryOccupancy* and *bQueryBrightness*.
...
|  |  |
| --- | --- |
| 30400092 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 5165373 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 46488363 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
...
| nHysteresisMinBrightness | BYTE | Get, Set | 40 | As the percentage hysteresis can also lead to large fluctuations at low brightness, a minimum hysteresis can be specified via this property. The minimum hysteresis is an absolute value with a value range from 0 to 255. |
