...
6. FB\_DALI\_BEG\_Indoor\_180\_BMS\_V8

# FB\_DALI\_BEG\_Indoor\_180\_BMS\_V8

![1518871](/tcplclib_tc3_dali/1033/Images/png/9007209010873099__Web.png)

The function block represents the Indoor 180-BMS DALI-2 DALI sensor from B.E.G..
...
|  |  |
| --- | --- |
| 13669843 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 55919726 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 33515489 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
