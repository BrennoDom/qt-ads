...
6. FB\_DALI302QueryDeadtimeTimer

# FB\_DALI302QueryDeadtimeTimer

![57330849](/tcplclib_tc3_dali/1033/Images/gif/7746857099__Web.gif)

The function block reads the variable [tDeadtime](ms-xhelp:///?Id=beckhoff-8cb2-4476-8117-2b8f842ee86e).

The value is read in steps of 50 ms. The permissible value range is 0 s to 12.75 s. It is output in numbers from 0 to 255.

|  |  |
| --- | --- |
| 46215595 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 13287175 | The command priorities are supported by the KL6821 from the firmware version BD. |
