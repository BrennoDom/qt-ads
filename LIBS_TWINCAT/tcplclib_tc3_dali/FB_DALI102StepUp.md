...
![60784581](/tcplclib_tc3_dali/1033/Images/gif/9007205111098251__Web.gif)

The output value of the DALI control gear is increased by one step.

If the output value of the DALI control gear is already at the [maxLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) value, the value remains unchanged.

The command does not switch on the DALI control gear.
...
|  |  |
| --- | --- |
| 10190321 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
