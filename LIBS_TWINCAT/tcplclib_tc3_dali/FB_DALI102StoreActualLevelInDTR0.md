# FB_DALI102StoreActualLevelInDTR0
...
7. FB\_DALI102StoreActualLevelInDTR0

# FB\_DALI102StoreActualLevelInDTR0

![58082174](/tcplclib_tc3_dali/1033/Images/gif/9007205111216907__Web.gif)

The function block writes the current output value of the DALI control gear to [DTR0](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7).

|  |  |
| --- | --- |
| 52977523 | The function block sends the DALI command STORE ACTUAL LEVEL IN DTR0 twice, as required by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 7035667 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
