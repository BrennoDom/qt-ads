...
6. FB\_DALI303QueryCatching

# FB\_DALI303QueryCatching

![9979846](/tcplclib_tc3_dali/1033/Images/gif/9007205111945739__Web.gif)

The function block queries whether *Catching* is active.

*Catching* can be activated by [FB\_DALI303CatchMovement](ms-xhelp:///?Id=beckhoff-b871-423b-a474-e23308558e83).

|  |  |
| --- | --- |
| 22709757 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 3061223 | The command priorities are supported by the KL6821 from the firmware version BD. |
