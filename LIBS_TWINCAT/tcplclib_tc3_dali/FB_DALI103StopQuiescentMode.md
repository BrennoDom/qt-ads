...
7. FB\_DALI103StopQuiescentMode

# FB\_DALI103StopQuiescentMode

![7949639](/tcplclib_tc3_dali/1033/Images/gif/9007205112168459__Web.gif)

The function block interrupts the [Quiescent mode](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) prematurely.

Quiescent mode can be started with the function block [FB\_DALI103StartQuiescentMode](ms-xhelp:///?Id=beckhoff-b39b-4ed5-b3dc-c36a9a682dc6).

|  |  |
| --- | --- |
| 4437887 | The function block sends the DALI command STOP QUIESCENT MODE twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 39940984 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 23924539 | The command priorities are supported by the KL6821 from the firmware version BD. |
