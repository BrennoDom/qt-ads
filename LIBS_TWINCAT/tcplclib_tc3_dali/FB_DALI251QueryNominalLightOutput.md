# FB_DALI251QueryNominalLightOutput
...
6. FB\_DALI251QueryNominalLightOutput

# FB\_DALI251QueryNominalLightOutput

![36791668](/tcplclib_tc3_dali/1033/Images/gif/8368141323__Web.gif)

The function block reads the nominal light output of the luminaire from the DALI control gear.
...
|  |  |
| --- | --- |
| 62689558 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nNominalLightOutput:** Nominal illuminance [Lm] (0…16777214).
