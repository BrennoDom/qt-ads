# FB_DALI208QueryDownSwitchOffThreshold
...
7. FB\_DALI208QueryDownSwitchOffThreshold

# FB\_DALI208QueryDownSwitchOffThreshold

![65765997](/tcplclib_tc3_dali/1033/Images/gif/10380134795__Web.gif)

The function block reads the variable [downSwitchOffThreshold](ms-xhelp:///?Id=beckhoff-c35d-4ca0-9bd6-597c2a99a83f) from the DALI control gear.
...
|  |  |
| --- | --- |
| 55023063 | Prior to the DALI command QUERY DOWN SWITCH-OFF, the function block sends the DALI command ENABLE DEVICE TYPE 7, as is necessary for application extended commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 25445523 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
