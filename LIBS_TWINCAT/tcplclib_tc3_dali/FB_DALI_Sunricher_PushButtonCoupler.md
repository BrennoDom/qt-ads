# FB_DALI_Sunricher_PushButtonCoupler
...
5. [Sunricher](ms-xhelp:///?Id=beckhoff-4985-4a18-a77b-8544e538178a)
6. FB\_DALI\_Sunricher\_PushButtonCoupler

# FB\_DALI\_Sunricher\_PushButtonCoupler

![59560431](/tcplclib_tc3_dali/1033/Images/png/10744124299__Web.png)

The function block represents the Push Button Coupler DALI push button interface from Sunricher.
...
The input variables *bQueryInputValueN* trigger the immediate reading of the corresponding instance.
...
|  |  |
| --- | --- |
| 66281838 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 59665636 | The function block cannot be used when using the KL6811. |
