...
6. FB\_DALI\_Zencontrol\_Scenepanel\_Switch

# FB\_DALI\_Zencontrol\_Scenepanel\_Switch

![2257160](/tcplclib_tc3_dali/1033/Images/png/10743626891__Web.png)
...
|  |  |
| --- | --- |
| 20314447 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 48612303 | The function block cannot be used when using the KL6811. |
