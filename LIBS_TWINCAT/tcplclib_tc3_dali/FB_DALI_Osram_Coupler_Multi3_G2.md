# FB_DALI_Osram_Coupler_Multi3_G2
...
6. FB\_DALI\_Osram\_Coupler\_Multi3\_G2

# FB\_DALI\_Osram\_Coupler\_Multi3\_G2

![7471967](/tcplclib_tc3_dali/1033/Images/gif/18014407595566347__Web.gif)

The function block represents the DALI COUPLER MULTI3 G2 DALI sensor from Osram.
...
|  |  |
| --- | --- |
| 138844 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 1249601 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 11246416 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
