...
7. FB\_DALI102StepDownAndOff

# FB\_DALI102StepDownAndOff

![47975183](/tcplclib_tc3_dali/1033/Images/gif/9007205111100811__Web.gif)

The output value of the DALI control gear is reduced by one step.

If the output of the DALI control gear is already at the [minLevel](ms-xhelp:///?Id=beckhoff-e013-4a7e-9d50-4deaaa138af7) value, it is switched off.
...
|  |  |
| --- | --- |
| 29123463 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
