...
7. FB\_DALI209SetScene

# FB\_DALI209SetScene

![65794642](/tcplclib_tc3_dali/1033/Images/gif/9042953355__Web.gif)

The function block can be used to assign a specific lighting value to a scene.

Initially, only the color temperature is adjustable.

|  |  |
| --- | --- |
| 55280873 | Prior to the DALI command SET SCENE, the function block sends the DALI command ENABLE DEVICE TYPE 8, as is necessary for application-related extension commands (see [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)) and SET TEMPORARY COLOUR TEMPERATURE TC. |

|  |  |
| --- | --- |
| 27765811 | The function block changes the DTR0 and the DTR1 of all connected DALI control gears. |
...
|  |  |
| --- | --- |
| 48565715 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
