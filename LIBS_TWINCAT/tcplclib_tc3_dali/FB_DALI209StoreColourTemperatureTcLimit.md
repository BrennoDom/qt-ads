...
7. FB\_DALI209StoreColourTemperatureTcLimit

# FB\_DALI209StoreColourTemperatureTcLimit

![60972066](/tcplclib_tc3_dali/1033/Images/gif/9007205693033227__Web.gif)

The function block saves the values of the variables *colourTemperatureTcCoolest*, *colourTemperatureTcWarmest*, *colourTemperatureTcPhysicalCoolest* or *colourTemperatureTcPhysicalWarmest* in the DALI control gear. The values can be read with function block [FB\_DALI209QueryColourValue](ms-xhelp:///?Id=beckhoff-4ad3-452c-886e-35d8b4c38cbf).

|  |  |
| --- | --- |
| 11877685 | Prior to the DALI command STORE COLOUR TEMPERATURE Tc LIMIT, the function block sends the DALI command ENABLE DEVICE TYPE 8, as is necessary for application-related extension commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |

|  |  |
| --- | --- |
| 39790309 | The function block changes the DTR0, DTR1 and DTR2 of all connected DALI control gears. |

|  |  |
| --- | --- |
| 22568466 | The function block sends the DALI command STORE COLOUR TEMPERATURE Tc LIMIT twice, as foreseen by the DALI standard for certain commands. |
...
|  |  |
| --- | --- |
| 1789605 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |

**eSelectLimitValue:** Specifies the limit value that is to be set (see [E\_DALIColourTemperatureTcLimit](ms-xhelp:///?Id=beckhoff-1f00-4882-a7b7-db18f520ce53)).
