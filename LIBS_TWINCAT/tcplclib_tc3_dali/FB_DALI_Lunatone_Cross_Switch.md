...
6. FB\_DALI\_Lunatone\_Cross\_Switch

# FB\_DALI\_Lunatone\_Cross\_Switch

![45461382](/tcplclib_tc3_dali/1033/Images/png/10738204555__Web.png)

The function block represents the Cross Switch DALI push-button interface from Lunatone.
...
|  |  |
| --- | --- |
| 6499254 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 58493292 | The function block cannot be used when using the KL6811. |
