# FB_DALI_Steinel_IRQuattroMicro
...
6. FB\_DALI\_Steinel\_IRQuattroMicro

# FB\_DALI\_Steinel\_IRQuattroMicro

![44327687](/tcplclib_tc3_dali/1033/Images/gif/18014406249303947__Web.gif)

☺The function block represents the IR Quattro Micro DALI sensor from Steinel.
...
|  |  |
| --- | --- |
| 63404869 | Set the times so that as few events as possible are sent. If too many events are sent, this can have a negative effect on the behavior of the application. |

|  |  |
| --- | --- |
| 33772909 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 35520730 | This measured value must be compared with the measured reference values at the place of operation of the DALI control device. |
