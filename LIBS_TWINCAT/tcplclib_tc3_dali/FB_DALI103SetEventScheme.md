...
7. FB\_DALI103SetEventScheme

# FB\_DALI103SetEventScheme

![5034184](/tcplclib_tc3_dali/1033/Images/gif/9007205112177291__Web.gif)

The function block determines the event scheme (see [eventScheme](ms-xhelp:///?Id=beckhoff-708d-47aa-9cfa-2706c5d5c470)) for the events of the respective DALI control device instance.

|  |  |
| --- | --- |
| 45307656 | The function block changes the DTR0 of all connected DALI control devices. |

|  |  |
| --- | --- |
| 5115727 | The function block sends the DALI command SET EVENT SCHEME twice, as required by the DALI standard for certain commands. |

|  |  |
| --- | --- |
| 46041549 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 11720763 | The command priorities are supported by the KL6821 from the firmware version BD. |

**eEventScheme:** Event scheme for the events (see [E\_DALIEventScheme](ms-xhelp:///?Id=beckhoff-335b-4381-bd96-70abcedc4e61)).
