...
7. FB\_DALI102Terminate

# FB\_DALI102Terminate

![34708966](/tcplclib_tc3_dali/1033/Images/gif/9007205101913739__Web.gif)

The function block terminates addressing for all DALI control gears. The selection of the DALI control gears to be addressed by the [FB\_DALI102Initialise](ms-xhelp:///?Id=beckhoff-1eaa-4d36-bbed-c2807b136b6c) function block is also canceled.
...
|  |  |
| --- | --- |
| 43945239 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
