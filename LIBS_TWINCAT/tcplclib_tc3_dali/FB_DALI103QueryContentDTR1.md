...
7. FB\_DALI103QueryContentDTR1

# FB\_DALI103QueryContentDTR1

![1272826](/tcplclib_tc3_dali/1033/Images/gif/9007205112162571__Web.gif)

The function block reads the content of the [DTR1](ms-xhelp:///?Id=beckhoff-37b2-43d4-abe8-716d667040d6) (Data Transfer Register 1) from the DALI control device.

|  |  |
| --- | --- |
| 11455439 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 35990092 | The command priorities are supported by the KL6821 from the firmware version BD. |
