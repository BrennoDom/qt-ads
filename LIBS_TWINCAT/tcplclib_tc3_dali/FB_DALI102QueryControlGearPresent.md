# FB_DALI102QueryControlGearPresent
...
7. FB\_DALI102QueryControlGearPresent

# FB\_DALI102QueryControlGearPresent

![24632334](/tcplclib_tc3_dali/1033/Images/gif/5847324171__Web.gif)

The function block indicates whether the required DALI control gear can be reached via its short address.
...
|  |  |
| --- | --- |
| 20364417 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**bReady:** The output is set when the queried control gear is available.
