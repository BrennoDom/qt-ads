...
7. FB\_DALI207QueryFeatures

# FB\_DALI207QueryFeatures

![11784733](/tcplclib_tc3_dali/1033/Images/gif/6437922699__Web.gif)

The function block reads the variable [features](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0) from the DALI control gear.

|  |  |
| --- | --- |
| 38953736 | Prior to the DALI command QUERY FEATURES, the function block sends the DALI command ENABLE DEVICE TYPE 6, as is necessary for application-related expansion commands (see also [FB\_DALI102EnableDeviceType](ms-xhelp:///?Id=beckhoff-6f87-4d1b-b5a6-4f03ac5df1fb)). |
...
|  |  |
| --- | --- |
| 15039305 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
**nFeatures:** Returns information on the implemented properties (see [features](ms-xhelp:///?Id=beckhoff-3c7f-4aa8-b05d-20b713e3c6a0)).
