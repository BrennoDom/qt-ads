# FB_DALI251QueryLuminaireIdentification
...
6. FB\_DALI251QueryLuminaireIdentification

# FB\_DALI251QueryLuminaireIdentification

![7073466](/tcplclib_tc3_dali/1033/Images/gif/8367713035__Web.gif)

The function block reads the identification designation of the luminaire from the DALI control gear.
...
|  |  |
| --- | --- |
| 63661202 | *eCommandPriority* has no function with the KL6811. The command priorities are supported by the KL6821 from the firmware version BD. |
...
bBusy                     : BOOL;  
sLuminaireIdentification  : STRING(60);
```
...
**sLuminaireIdentification:** Identification designation.
