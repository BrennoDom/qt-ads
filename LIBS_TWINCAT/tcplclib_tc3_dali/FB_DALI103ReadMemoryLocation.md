...
7. FB\_DALI103ReadMemoryLocation

# FB\_DALI103ReadMemoryLocation

![29641146](/tcplclib_tc3_dali/1033/Images/gif/7226063883__Web.gif)

The value *nValue* is read from the memory bank of the DALI controller. The corresponding memory bank is specified by the input variable *nMemoryBank*, the address within the memory bank by the input variable *nOffset*.

|  |  |
| --- | --- |
| 65443729 | The function block changes the DTR0 and the DTR1 of all connected DALI control devices. |

|  |  |
| --- | --- |
| 52122650 | The function block cannot be used when using the KL6811. |
...
|  |  |
| --- | --- |
| 66450672 | The command priorities are supported by the KL6821 from the firmware version BD. |
