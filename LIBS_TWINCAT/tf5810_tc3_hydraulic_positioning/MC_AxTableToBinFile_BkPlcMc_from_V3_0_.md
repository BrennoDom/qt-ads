...
5. MC\_AxTableToBinFile\_BkPlcMc (from V3.0)

# MC\_AxTableToBinFile\_BkPlcMc (from V3.0)

![5968939](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854771211__Web.gif)
...
|  |  |
| --- | --- |
| 53720453 | The file contents cannot be read or modified with an ASCII editor. |
