...
4. MC\_ReadParameter\_BkPlcMc (from V3.0)

# MC\_ReadParameter\_BkPlcMc (from V3.0)

![19228540](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854664203__Web.gif)

This function block reads the non-boolean parameters of an axis. The function block [MC\_ReadBoolParameter\_BkPlcMc](ms-xhelp:///?Id=beckhoff-9475-49ea-9ed4-a2fbfca6483f) is available for boolean parameters.
...
|  |  |
| --- | --- |
| 38839134 | This function block requires no time for executing its tasks. The output Busy will never assume the value TRUE and only exists for compatibility reasons. |
