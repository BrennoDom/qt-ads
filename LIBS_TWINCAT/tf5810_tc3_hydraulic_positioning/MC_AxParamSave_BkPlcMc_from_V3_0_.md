# MC_AxParamSave_BkPlcMc (from V3.0)
...
4. MC\_AxParamSave\_BkPlcMc (from V3.0)

# MC\_AxParamSave\_BkPlcMc (from V3.0)

![18270010](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854873355__Web.gif)

The function block writes the parameters for an axis into a file. A function block of type [MC\_AxParamLoad\_BkPlcMc](ms-xhelp:///?Id=beckhoff-92c8-44d1-ae87-dd14f51905c7) must be used to read the file.
