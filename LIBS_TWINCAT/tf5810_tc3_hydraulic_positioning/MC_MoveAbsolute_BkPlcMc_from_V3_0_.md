...
4. MC\_MoveAbsolute\_BkPlcMc (from V3.0)

# MC\_MoveAbsolute\_BkPlcMc (from V3.0)

![55331235](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854722571__Web.gif)
...
**Acceleration**: [mm/s2] The required acceleration in actual value units of the axis per square second. If this parameter is 0.0, it is replaced by a default value from the axis parameters.

**Deceleration**: [mm/s2] The required deceleration in actual value units of the axis per square second. If this parameter is 0.0, it is replaced by a default value from the axis parameters.

**Jerk**: [mm/s3] reserved.

**Direction:** Reserved. This input was only amended for compatibility reasons and either should not be assigned, or the constant MC\_Shortest\_Way\_BkPlcMc should be assigned to it. (from V3.0.8)
