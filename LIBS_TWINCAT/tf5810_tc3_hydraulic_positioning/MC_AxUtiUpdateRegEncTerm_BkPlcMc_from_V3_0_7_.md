...
4. MC\_AxUtiUpdateRegEncTerm\_BkPlcMc (from V3.0.7)

# MC\_AxUtiUpdateRegEncTerm\_BkPlcMc (from V3.0.7)

![20364417](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9051082891__Web.gif)

The function block writes a parameter set into the registers of a KL terminal. It uses [MC\_AxUtiReadRegDriveTerm\_BkPlcMc](ms-xhelp:///?Id=beckhoff-ffcf-4474-9c04-758f97fa6a6f) and [MC\_AxUtiWriteRegDriveTerm\_BkPlcMc](ms-xhelp:///?Id=beckhoff-4abb-470a-baef-ba638f5fbde2) function blocks for this purpose.
