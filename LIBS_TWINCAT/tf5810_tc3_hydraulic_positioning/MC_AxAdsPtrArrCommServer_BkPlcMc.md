...
4. MC\_AxAdsPtrArrCommServer\_BkPlcMc

# MC\_AxAdsPtrArrCommServer\_BkPlcMc

![5563313](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854861195__Web.gif)
...
|  |  |
| --- | --- |
| 50069818 | For most applications an MC\_AxAdsCommServer\_BkPlcMc is adequate and preferable. |

([MC\_AxAdsCommServer\_BkPlcMc](ms-xhelp:///?Id=beckhoff-5702-45de-80d2-87ae2f7a2a8a))
...
**pAxItfArr**: Here, the address of a variable of type ARRAY [ncnstFirstAxId..ncnstLastAxId] OF POINTER TO [Axis\_Ref\_BkPlcMc](ms-xhelp:///?Id=beckhoff-002b-4aba-81ea-1693fb03013c) should be transferred.
...
|  |  |
| --- | --- |
| 47975183 | This function block must not be used if the PLC application already is an ADS server. |
...
A [program example](ms-xhelp:///?Id=beckhoff-18b7-49ad-a855-a0509f58bddd) #16 is available.
