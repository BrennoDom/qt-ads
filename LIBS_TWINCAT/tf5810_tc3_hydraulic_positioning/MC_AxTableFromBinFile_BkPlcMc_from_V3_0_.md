# MC_AxTableFromBinFile_BkPlcMc (from V3.0)
...
5. MC\_AxTableFromBinFile\_BkPlcMc (from V3.0)

# MC\_AxTableFromBinFile\_BkPlcMc (from V3.0)

![39958021](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854778507__Web.gif)
...
If no **FileName** is specified, the function block uses the path and the file name, which were specified through the [MC\_AxUtiStandardInit\_BkPlcMc](ms-xhelp:///?Id=beckhoff-b490-4a55-ac43-76ba1d070d46) function block. File type TBL is used here, to distinguish from the parameter file with file type DAT.

|  |  |
| --- | --- |
| 24077873 | The file contents cannot be read or modified with an ASCII editor. |
