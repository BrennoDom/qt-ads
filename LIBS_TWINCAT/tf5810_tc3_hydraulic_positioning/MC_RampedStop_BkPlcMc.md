...
4. MC\_RampedStop\_BkPlcMc

# MC\_RampedStop\_BkPlcMc

![59085005](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9073624331__Web.gif)
...
The Stop operation begins if these checks can be carried out without problems. **RampTime** is used to calculate a deceleration, taking into account the reference speed. With this delay, the target velocity is reduced to 0 with a pure time ramp.
