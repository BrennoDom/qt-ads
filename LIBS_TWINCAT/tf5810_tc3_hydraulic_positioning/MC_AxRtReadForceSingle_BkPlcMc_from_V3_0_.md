# MC_AxRtReadForceSingle_BkPlcMc (from V3.0)
...
5. MC\_AxRtReadForceSingle\_BkPlcMc (from V3.0)

# MC\_AxRtReadForceSingle\_BkPlcMc (from V3.0)

![31664161](/tf5810_tc3_hydraulic_positioning/1033/Images/gif/9007200854759051__Web.gif)
...
|  |  |
| --- | --- |
| 16541999 | If only one input signal is available, a function block of type [MC\_AxRtReadForceDiff\_BkPlcMc](ms-xhelp:///?Id=beckhoff-1946-4575-bcf0-63dbcf7a8ec1) should be used. If the actual pressure is to be determined, a function block of type [MC\_AxRtReadPressureDiff\_BkPlcMc](ms-xhelp:///?Id=beckhoff-56dc-4d1a-b49b-0b7b2af8cf24) should be used. |
...
The function block determines the actual pressure and the actual force of the axis by evaluating the variables **AdcValueA**. The result is entered in [ST\_TcHydAxRtData](ms-xhelp:///?Id=beckhoff-1ffc-4f72-80ec-3f7c8585d12d).fActPressure.
...
* Enter the rated pressure of the pressure sensors divided by **AdcValueA**MAX as **ScaleFactorA**.
