...
4. MC\_WriteBoolParameter

# MC\_WriteBoolParameter

![58376831](/tcplclib_tc2_mc2/1033/Images/png/9007199324961803__Web.png)

Boolean parameters for the axis can be written with the function block MC\_WriteBoolParameter.

|  |  |
| --- | --- |
| 55629438 | In this case "axis" refers to the TwinCAT NC axis and its parameters, and not the drive. |
