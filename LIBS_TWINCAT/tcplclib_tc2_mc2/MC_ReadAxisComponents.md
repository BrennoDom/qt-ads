...
4. MC\_ReadAxisComponents

# MC\_ReadAxisComponents

![7042173](/tcplclib_tc2_mc2/1033/Images/png/9007199324942603__Web.png)

The function block MC\_ReadAxisComponents can be used to read information about the subelements encoder, drive and controller of an axis.

|  |  |
| --- | --- |
| 63379561 | In this case "axis" refers to the TwinCAT NC axis and its parameters, and not the drive. |
