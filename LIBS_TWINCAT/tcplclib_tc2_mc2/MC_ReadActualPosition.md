...
4. MC\_ReadActualPosition

# MC\_ReadActualPosition

![5057967](/tcplclib_tc2_mc2/1033/Images/png/9007199324936203__Web.png)

The actual axis position can be read with the function block `MC_ReadActualPosition`. The actual position value is the position value that is returned from the drive amplifier to the axis.
