...
![26783618](/tcplclib_tc2_mc2/1033/Images/png/9007199324952203__Web.png)

The function block MC\_ReadParameter is used to read an axis parameter.

|  |  |
| --- | --- |
| 39725971 | In this case "axis" refers to the TwinCAT NC axis and its parameters, and not the drive. |
