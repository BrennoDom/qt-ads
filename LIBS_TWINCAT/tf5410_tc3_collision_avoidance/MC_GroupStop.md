...
![6027901](/tf5410_tc3_collision_avoidance/1033/Images/png/1427996555__Web.png)

| TF5410 TwinCAT 3 Motion Collision Avoidance | TF5420 TwinCAT 3 Motion Pick-and-Place | |
| --- | --- | --- |
|  | MC Group with Pick-and-Place | MC Group Coordinated Motion |
| 54251110 | 18497945 | 32263784 |

The function block stops the group and all associated axes with a defined deceleration ramp and locks the axis for motion commands. While the group is in the GroupStopping state, no other function block can move an axis of the group (see [State diagrams](ms-xhelp:///?Id=beckhoff-2851-4318-9268-42575faccf68)).

The group can only be moved again once the signal *Execute* has been set to FALSE after the velocity is 0.

|  |  |
| --- | --- |
| 21938602 | MC\_GroupStop cancels the active coordinate transformation and deletes all jobs in the queue. |
...
## 32196376 21331933 VAR\_IN\_OUT
...
| Name | Type | Description |
| --- | --- | --- |
| Done | BOOL | Becomes TRUE when the group has been stopped and has come to a standstill. The group remains in the GroupStopping state while *Execute* is TRUE, at least until the axes have come to a stop. The group is then in the GroupStandby state (see [State diagrams](ms-xhelp:///?Id=beckhoff-2851-4318-9268-42575faccf68)). |
