...
![27762102](/tcplclib_tc3_mc2_advancedhoming/1033/Images/png/9007202272596747__Web.png)

To complete a homing sequence (not when using exclusively passive homing functions) it is necessary to call a finalizing FB. The function block MC\_HomeDirect completes a successful homing sequence, resets the axis to a defined value and ensures that modified parameters are reset to their original values. The axis leaves the homing state.
...
|  |  |
| --- | --- |
| 34137829 | In this case it is the user's responsibility to ensure that the parameters required for the desired homing sequence are modified and reconstructed. |
...
## 13700797/56198311 Inputs/Outputs
