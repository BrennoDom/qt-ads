...
5. FB\_SoEReadDcBusCurrent

# FB\_SoEReadDcBusCurrent

![19176948](/tcplclib_tc2_ncdrive/1033/Images/gif/2302120075__Web.gif)

With the function block FB\_SoEAX5000ReadDcBusCurrent the DC-Bus current   
...
**fDcBusCurrent**: Returns the DC bus current (e.g. 2,040 equals 2,040 A).
