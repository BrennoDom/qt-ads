...
Global error codes: [0x0000](ms-xhelp:///?Id=beckhoff-1200-4f82-96ed-e40472a74c4c)... (0x9811\_0000 ...)  
Router error codes: [0x0500](ms-xhelp:///?Id=beckhoff-1200-4f82-96ed-e40472a74c4c)... (0x9811\_0500 ...)  
General ADS errors: [0x0700](ms-xhelp:///?Id=beckhoff-1200-4f82-96ed-e40472a74c4c)... (0x9811\_0700 ...)  
RTime error codes: [0x1000](ms-xhelp:///?Id=beckhoff-1200-4f82-96ed-e40472a74c4c)... (0x9811\_1000 ...)
...
| 0x709 | 1801 | 0x9811 0709 | ADSERR\_DEVICE\_INVALIDCONTEXT | Invalid operating system context. This can result from use of ADS blocks in different tasks. It may be possible to resolve this through multitasking synchronization in the PLC. |
...
| 0x72A | 1834 | 0x9811 072A | ADSERR\_DEVICE\_LICENSEFUTUREISSUE | Licensing problem: time in the future. |
...
| --- | --- | --- |
| 0x0000\_0000 | S\_OK | No error. |
| 0x0000\_0001 | S\_FALSE | No error.  Example: successful processing, but with a negative or incomplete result. |
| 0x0000\_0203 | S\_PENDING | No error.  Example: successful processing, but no result is available yet. |
| 0x0000\_0256 | S\_WATCHDOG\_TIMEOUT | No error. Example: successful processing, but a timeout occurred. |
