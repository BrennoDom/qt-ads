...
![30494806](/tf5420_tc3_advanced_pick_and_place/1033/Images/png/5537582859__Web.png)

| TF5410 TwinCAT 3 Motion Collision Avoidance | TF5420 TwinCAT 3 Motion Pick-and-Place | |
| --- | --- | --- |
|  | MC Group with Pick-and-Place | MC Group Coordinated Motion |
| 6017800 | 54160201 | 17679762 |
...
|  |  |
| --- | --- |
| 24900132 | Use case for changing the reference system  The `MC` group can be decoupled by using `MC_SetCoordinateTransform` and changing the reference system. |
