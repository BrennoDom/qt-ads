...
![19612160](/tf5420_tc3_advanced_pick_and_place/1033/Images/png/1427884555__Web.png)

| TF5410 TwinCAT 3 Motion Collision Avoidance | TF5420 TwinCAT 3 Motion Pick-and-Place | |
| --- | --- | --- |
|  | MC Group with Pick-and-Place | MC Group Coordinated Motion |
| 42291718 | 45081147 | 3077144 |

The MC\_GroupHalt function block stops a group with a defined deceleration ramp. Unlike "[MC\_GroupStop](ms-xhelp:///?Id=beckhoff-a918-4761-908a-7e5bf8151565)", the group is not locked for further motion commands. Therefore, the group can be restarted by another command during the deceleration ramp or after stopping.
...
|  |  |
| --- | --- |
| 47922135 | Gilt für die MC\_Group: MC\_GroupHalt cancels the active coordinate transformation and deletes all jobs in the queue. |
...
## 56487722 38627455 VAR\_IN\_OUT
