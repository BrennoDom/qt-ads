...
![324668](/tf5420_tc3_advanced_pick_and_place/1033/Images/png/8823268107__Web.png)

| TF5410 TwinCAT 3 Motion Collision Avoidance | TF5420 TwinCAT 3 Motion Pick-and-Place | |
| --- | --- | --- |
|  | MC Group with Pick-and-Place | MC Group Coordinated Motion |
| 2922015 | 26298136 | 35356632 |

This function block resolves a blocking job that blocks further execution of the path. A blocking job is inserted into the path with [MC\_BlockerPreparation](ms-xhelp:///?Id=beckhoff-13de-483e-af6b-774ec84a1471).
