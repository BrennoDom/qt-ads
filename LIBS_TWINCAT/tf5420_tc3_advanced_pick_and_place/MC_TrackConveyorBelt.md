...
![39825499](/tf5420_tc3_advanced_pick_and_place/1033/Images/png/5537580299__Web.png)

| TF5410 TwinCAT 3 Motion Collision Avoidance | TF5420 TwinCAT 3 Motion Pick-and-Place | |
| --- | --- | --- |
|  | MC Group with Pick-and-Place | MC Group Coordinated Motion |
| 22885177 | 4640007 | 41760071 |
...
|  |  |
| --- | --- |
| 40296320 | Use case for changing the reference system  The `MC` group can be decoupled by using `MC_TrackConveyorBelt` and changing the reference system. The reference system can be changed with `MC_SetCoordinateTransform`. |
...
| CoordTransform | MC\_COORD\_REF | Reference to a coordinate system (see [MC\_COORD\_REF](ms-xhelp:///?Id=beckhoff-76c8-4964-84eb-ea73c2902ba2)). |
...
## 42776493 49444123 VAR\_IN\_OUT
